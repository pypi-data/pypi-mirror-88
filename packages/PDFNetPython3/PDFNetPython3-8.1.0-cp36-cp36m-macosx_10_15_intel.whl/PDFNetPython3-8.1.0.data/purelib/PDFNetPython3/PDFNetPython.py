...
class TimestampingTestResult(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        _PDFNetPython.TimestampingTestResult_swiginit(self, _PDFNetPython.new_TimestampingTestResult(*args))
    m_impl = property(_PDFNetPython.TimestampingTestResult_m_impl_get, _PDFNetPython.TimestampingTestResult_m_impl_set)

# Register TimestampingTestResult in _PDFNetPython:
_PDFNetPython.TimestampingTestResult_swigregister(TimestampingTestResult)
...
class PDFNet(object):
    ...
    @staticmethod
    def Initialize(license_key=None):
