...
class JsonArray(Col):
    ...
    def __init__(self, default_value=None, nullable=True, unique=None, on_update=None):
        super().__init__(col_type=JsonArray.col_type, default_value=default_value, nullable=nullable, unique=unique, on_update=on_update)
    ...
    def get_default_value(self):
        return f'JSON_ARRAY{tuple(self.default_value)}'

class JsonObject(Col):

    col_type = 'JSON'

    def __init__(self, default_value=None, nullable=True, unique=None, on_update=None):
        super().__init__(col_type=JsonObject.col_type, default_value=default_value, nullable=nullable, unique=unique, on_update=on_update)
    ...
    def get_default_value(self):
        return f'JSON_OBJECT{tuple(self.default_value)}'
