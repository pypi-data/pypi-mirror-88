...
$ perf record -e 'sched:*' --call-graph dwarf -k CLOCK_MONOTONIC -e L1-dcache-load-misses -e instructions -e cycles -e page-faults -- python -m perfpy.example1 
Run with --no-online, otherwise it may run slow
$ perf script --no-inline | perfpy --no-running -o example1perf.json
