...
def get_element_coord(x, y, *args,
    ...
    # coordinate, args_slice = [int(i) for i in args[:2]], [j for j in args[2:]]
    # args = coordinate + args_slice
    from time import sleep
    ...
    #     if execute is True:
    #         attr = getattr(pyautogui, attr_name)
    #         attr(*coordinate, *args, **kwargs)
    #     return coordinate
    ...
    #     UI_element.set_focus()
    #     if execute is True:
    #         attr = getattr(UI_element, attr_name)
    #         attr(*args, **kwargs)
    #     return UI_element
    # else:
    #     raise Exception(f'O backend "{backend}" não identificado.')
...
def write_text_coord(x: int, y: int,*,
    ...
    # sleep(float(before))
    # if backend is None:
    #     typewrite(prepare_text_to_pyautogui(text), interval=float(delay))
    #     sleep(float(after))
    #     return x, y 

    # elif backend in ['win32', 'uia']:
    #     UI_element = _get_ui_element(x, y, attr_name='type_keys', backend=backend, wait_attr=wait_attr)
    #     UI_element.set_focus()
    #     UI_element.type_keys(text, with_spaces=True, pause=delay)
    #     sleep(float(after))
    #     return UI_element
...
def click_coord(x: int, y: int,
    ...
    # sleep(float(before))
    # if backend is None:
    #     click(x, y, button=button, interval=delay)
    #     sleep(float(after))
    #     return x, y
    # elif backend in ['win32', 'uia']:
    #     UI_element = _get_ui_element(x, y, attr_name='click_input', backend=backend, wait_attr=wait_attr)
    #     UI_element.set_focus()
    #     UI_element.double_click_input(button=button)
    #     sleep(float(after))
    #     return UI_element
    # else:
    #     raise Exception(f'O backend "{backend}" não identificado.')
...
def double_click_coord(x: int, y: int,
    ...
    # from pyautogui import doubleClick, sleep

    # sleep(float(before))
    # if backend is None:
    #     doubleClick(x, y, button=button, interval=delay)
    #     sleep(float(after))
    #     return x, y
    # elif backend in ['win32', 'uia']:
    #     UI_element = _get_ui_element(x, y, attr_name='double_click_input', backend=backend, wait_attr=wait_attr)
    #     UI_element.set_focus()
    #     UI_element.double_click_input(button=button)
    #     sleep(float(after))
    #     return UI_element
...
def triple_click_coord(x: int, y: int,
    ...
    # from pyautogui import sleep, tripleClick

    # sleep(float(before))
    # if backend is None:
    #     tripleClick(x, y, button=button, interval=delay)
    #     sleep(float(after))
    #     return x, y
    # elif backend in ['win32', 'uia']:
    #     UI_element = _get_ui_element(x, y, attr_name='double_click_input', backend=backend, wait_attr=wait_attr)
    #     UI_element.set_focus()
    #     for _ in range(3):
    #         UI_element.click_input(button=button)
    #         sleep(delay)
    #     sleep(float(after))
    #     return UI_element
    # else:
    #     raise Exception(f'O componente "{backend}" não identificado.')
