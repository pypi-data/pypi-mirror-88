# Generated by Django 2.2.16 on 2020-10-09 09:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('apis_entities', '0002_auto_20201009_0939'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='workamt',
            name='related_amt',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workamt_set', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='workamt',
            name='related_work',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workamt_set', to='apis_entities.Work'),
        ),
        migrations.AddField(
            model_name='workamt',
            name='relation_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workamt_set', to='apis_vocabularies.WorkAmtRelation'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='placeamt',
            name='related_amt',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='placeamt_set', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='placeamt',
            name='related_place',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='placeamt_set', to='apis_entities.Place'),
        ),
        migrations.AddField(
            model_name='placeamt',
            name='relation_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='placeamt_set', to='apis_vocabularies.PlaceAmtRelation'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='personamt',
            name='related_amt',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='personamt_set', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='personamt',
            name='related_person',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='personamt_set', to='apis_entities.Person'),
        ),
        migrations.AddField(
            model_name='personamt',
            name='relation_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='personamt_set', to='apis_vocabularies.PersonAmtRelation'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='institutionamt',
            name='related_amt',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='institutionamt_set', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='institutionamt',
            name='related_institution',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='institutionamt_set', to='apis_entities.Institution'),
        ),
        migrations.AddField(
            model_name='institutionamt',
            name='relation_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='institutionamt_set', to='apis_vocabularies.InstitutionAmtRelation'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='eventamt',
            name='related_amt',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='eventamt_set', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='eventamt',
            name='related_event',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='eventamt_set', to='apis_entities.Event'),
        ),
        migrations.AddField(
            model_name='eventamt',
            name='relation_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='eventamt_set', to='apis_vocabularies.EventAmtRelation'),
        ),
        migrations.AddField(
            model_name='amtamt',
            name='related_amtA',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='related_amtB', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='amtamt',
            name='related_amtB',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='related_amtA', to='apis_entities.Amt'),
        ),
        migrations.AddField(
            model_name='amtamt',
            name='relation_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='amtamt_set', to='apis_vocabularies.AmtAmtRelation'),
        ),
    ]
