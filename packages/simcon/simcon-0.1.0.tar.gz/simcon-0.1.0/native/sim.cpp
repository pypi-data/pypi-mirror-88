...
void Sim::add_to_data_definition(SIMCONNECT_DATA_DEFINITION_ID definition_id, const char* var, const char* units) const {
    check_exc(SimConnect_AddToDataDefinition(hSimConnect, definition_id, var, units));
};
