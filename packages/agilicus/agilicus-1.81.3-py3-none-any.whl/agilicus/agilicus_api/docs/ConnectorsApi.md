...
[**delete_agent_connector**](ConnectorsApi.md#delete_agent_connector) | **DELETE** /v1/agent_connectors/{agent_id} | Delete a agent
[**get_agent_connector**](ConnectorsApi.md#get_agent_connector) | **GET** /v1/agent_connectors/{agent_id} | Get an agent
...
[**replace_agent_connector**](ConnectorsApi.md#replace_agent_connector) | **PUT** /v1/agent_connectors/{agent_id} | Update an agent
...
> delete_agent_connector(agent_id, org_id=org_id)
...
org_id = '1234' # str | Organisation Unique identifier (optional)
    ...
    try:
        # Delete a agent
        api_instance.delete_agent_connector(agent_id, org_id=org_id)
    except ApiException as e:
...
# **get_agent_connector**
> AgentConnector get_agent_connector(agent_id, org_id=org_id)
...
org_id = '1234' # str | Organisation Unique identifier (optional)
    ...
    try:
        # Get an agent
        api_response = api_instance.get_agent_connector(agent_id, org_id=org_id)
        pprint(api_response)
    except ApiException as e:
...
> AgentConnector replace_agent_connector(agent_id, org_id=org_id, agent_connector=agent_connector)
...
agent_connector = agilicus_api.AgentConnector() # AgentConnector |  (optional)
    ...
    try:
        # Update an agent
        api_response = api_instance.replace_agent_connector(agent_id, org_id=org_id, agent_connector=agent_connector)
        pprint(api_response)
    except ApiException as e:
