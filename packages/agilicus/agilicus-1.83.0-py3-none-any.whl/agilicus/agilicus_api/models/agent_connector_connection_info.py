...
class AgentConnectorConnectionInfo(object):
    ...
    openapi_types = {
        ...
        'fileshare_services': 'list[FileShareService]'
    }
    ...
    attribute_map = {
        ...
        'fileshare_services': 'fileshare_services'
    }

    def __init__(self, connection_uri=None, max_number_connections=16, ip_services=None, fileshare_services=None, local_vars_configuration=None):  # noqa: E501
        ...
        if fileshare_services is not None:
            self.fileshare_services = fileshare_services
    ...
    @property
    def fileshare_services(self):
        """Gets the fileshare_services of this AgentConnectorConnectionInfo.  # noqa: E501

        The list of fileshare services associated with this connection  # noqa: E501

        :return: The fileshare_services of this AgentConnectorConnectionInfo.  # noqa: E501
        :rtype: list[FileShareService]
        """
        return self._fileshare_services

    @fileshare_services.setter
    def fileshare_services(self, fileshare_services):
        """Sets the fileshare_services of this AgentConnectorConnectionInfo.

        The list of fileshare services associated with this connection  # noqa: E501

        :param fileshare_services: The fileshare_services of this AgentConnectorConnectionInfo.  # noqa: E501
        :type: list[FileShareService]
        """

        self._fileshare_services = fileshare_services
