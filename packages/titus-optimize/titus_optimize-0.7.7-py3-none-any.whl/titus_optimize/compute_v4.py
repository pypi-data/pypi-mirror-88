...
class PlacementSolver:
    ...
    def optimize(
        ...
        Arguments:
            ...
            - use_per_workload [unused]: actual (or forecasted) CPU use per workload
        ...
        try:
            ...
            prob.solve(solver=self.backend, verbose=verbose, enforce_dpp=False, method=method, **extra_args)
