...
class LotteryValueLog:
    ...
    def __init__(self):
        ...
        self.change_type = 0  # 变动类型(来源类型+对用的子类型  如:101下单购买201掌柜有礼202每日签到301手动增加302手动减少401抽奖增加402抽奖减少)
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'open_id', 'user_nick', 'log_title', 'log_info', 'source_type', 'change_type', 'operate_type', 'current_value', 'history_value', 'main_pay_order_no', 'operator', 'create_date']
