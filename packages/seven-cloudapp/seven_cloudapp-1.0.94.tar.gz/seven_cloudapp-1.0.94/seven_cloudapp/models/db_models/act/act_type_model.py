...
class ActType:
    ...
    def get_field_list(self):
        return ['id', 'type_name', 'act_title', 'act_tag', 'act_img', 'currency_type', 'marketing_id', 'experience_img', 'play_process', 'applicable_behavior', 'market_function', 'skill_case', 'type_desc', 'share_desc', 'rule_desc', 'integral_rule', 'is_release', 'release_date', 'create_date', 'modify_date']
