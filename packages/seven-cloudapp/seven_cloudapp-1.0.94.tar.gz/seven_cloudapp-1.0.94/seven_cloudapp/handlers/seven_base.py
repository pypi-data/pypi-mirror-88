...
@LastEditTime: 2020-12-16 10:48:44
...
class SevenBaseHandler(BaseApiHandler):
    ...
    def get_online_url(self, act_id, app_id):
        ...
        @last_editors: HuangJingCan
        """
        online_url = f"https://m.duanqu.com/?_ariver_appid={app_id}&page={CodingHelper.url_encode('pages/index/index')}&query=" + CodingHelper.url_encode(f"actid={act_id}")
        return online_url
