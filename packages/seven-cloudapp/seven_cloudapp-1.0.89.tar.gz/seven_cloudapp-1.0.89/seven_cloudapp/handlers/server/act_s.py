...
@LastEditTime: 2020-12-11 16:03:15
    ...
    def get_async(self):
        ...
        if app_id:
            ...
            for page in page_list:
                ...
                page["online_url"] = f"https://m.duanqu.com/?_ariver_appid={app_id}&page={CodingHelper.url_encode('pages/index/index')}&query=" + CodingHelper.url_encode(f"actid={page['id']}")
