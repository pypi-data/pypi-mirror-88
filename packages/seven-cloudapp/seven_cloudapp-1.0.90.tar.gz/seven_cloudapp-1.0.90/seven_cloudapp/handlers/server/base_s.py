...
@LastEditTime: 2020-12-14 14:49:09
...
class OnlineLiveUrlHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        data["online_url"] = f"https://m.duanqu.com/?_ariver_appid={app_id}&page={CodingHelper.url_encode('pages/index/index')}&query=" + CodingHelper.url_encode(f"actid={act_id}")
