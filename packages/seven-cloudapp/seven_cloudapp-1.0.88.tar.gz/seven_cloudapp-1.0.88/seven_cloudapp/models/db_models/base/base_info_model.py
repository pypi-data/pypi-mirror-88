...
class BaseInfo:
    ...
    def get_field_list(self):
        return ['id', 'customer_service', 'experience_img', 'client_ver', 'server_ver', 'update_function', 'store_study_url', 'study_url', 'video_url', 'course_url', 'price_gare', 'product_price', 'decoration_poster', 'friend_link', 'course_strategy', 'menu_config', 'is_remind_phone', 'is_force_update', 'create_date', 'modify_date']
