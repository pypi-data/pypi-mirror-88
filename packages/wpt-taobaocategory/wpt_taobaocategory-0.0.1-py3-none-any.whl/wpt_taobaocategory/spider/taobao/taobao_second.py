...
class TaoBaoTwo(object):
    ...
    def parse_response(self, response):
        ...
        if is_first:
            next_page = 2 if len(catefour_list) >= 50 else 0
        else:
            next_page = (int(next_page) + 1) if len(catefour_list) >= 100 else 0
