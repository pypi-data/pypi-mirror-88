...
class CurveBuilder:
    ...
    def curves_from_points(self, curve_type: CurveType, points: List[Vector2]) -> List[Curve]:
        ...
        if curve_type == CurveType.LINE:
            ...
            curves = self.cubicbeziers_from_points(points)
    ...
    def curves_from_temp_next_points(self, next_points: List[Vector2], force_continuity: bool=True):
    ...
    def force_continuity(self, next_point: Vector2):
        curves = self.curves_from_points(self.current_curve_type.value, self.current_points)
