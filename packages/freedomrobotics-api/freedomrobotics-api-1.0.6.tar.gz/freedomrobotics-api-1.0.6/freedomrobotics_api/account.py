...
class Account(Entity):
    ...
    def get_devices(self, attributes=None, zones=None, include_subzones=None):
        ...
        result = api_call("GET", "/accounts/{}/devices".format(self._id), params=params)
    ...
    def get_statistics_csv(self, utc_start=None, utc_end=None, **params):
