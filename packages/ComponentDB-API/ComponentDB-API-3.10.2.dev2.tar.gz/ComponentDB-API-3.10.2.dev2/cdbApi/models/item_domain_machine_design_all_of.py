...
class ItemDomainMachineDesignAllOf(object):
    ...
    def __init__(self, current_hierarchy_item_element=None, alternate_name=None, assigned_item=None, status_property_type_name=None, local_vars_configuration=None):  # noqa: E501
