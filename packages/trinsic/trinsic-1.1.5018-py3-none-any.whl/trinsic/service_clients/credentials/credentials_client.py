...
class CredentialsClient(SDKClient):
    ...
    def upload_image(
        ...
        :type filename: str
        :param content_type: Type of the image content
    ...
    def send_message(
        ...
        :type body: ~credentials.models.BasicMessageParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        # Construct body
        body_content = self._serialize.body(body, 'BasicMessageParameters')
    ...
    def list_messages(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: list or ClientRawResponse if raw=true
        :rtype: list[~credentials.models.BasicMessageRecord] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
    ...
    def get_message(
        ...
        :rtype: ~credentials.models.BasicMessageContract or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
