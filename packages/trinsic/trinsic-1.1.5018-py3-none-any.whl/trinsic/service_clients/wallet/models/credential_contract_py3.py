...
class CredentialContract(Model):
    ...
    def __init__(self, *, credential_id: str=None, state=None, connection_id: str=None, definition_id: str=None, schema_id: str=None, offer_data: str=None, offer_url: str=None, issued_at_utc=None, accepted_at_utc=None, values=None, correlation_id: str=None, **kwargs) -> None:
