...
class ProviderClient(SDKClient):
    ...
    def get_cloud_wallet_count(
        ...
        :return: CloudWalletAnalyticsContract or ClientRawResponse if raw=true
        :rtype: ~provider.models.CloudWalletAnalyticsContract or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        # Construct URL
        url = self.get_cloud_wallet_count.metadata['url']
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CloudWalletAnalyticsContract', response)
        ...
        return deserialized
    get_cloud_wallet_count.metadata = {'url': '/analytics/cloudWallets'}
    ...
    def get_current_usage(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: UsageContract or ClientRawResponse if raw=true
        :rtype: ~provider.models.UsageContract or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        # Construct URL
        url = self.get_current_usage.metadata['url']
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('UsageContract', response)
        ...
        return deserialized
    get_current_usage.metadata = {'url': '/analytics/usage/current'}
    ...
    def search_usage(
        ...
        :rtype: list[~provider.models.UsageContract] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        # Construct URL
        url = self.search_usage.metadata['url']
        ...
        return deserialized
    search_usage.metadata = {'url': '/analytics/usage'}
    ...
    def list_networks(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: list or ClientRawResponse if raw=true
        :rtype: list[~provider.models.NetworkContract] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        ...
        return deserialized
    list_networks.metadata = {'url': '/networks'}
    ...
    def get_regions(
        ...
        """
        # Construct URL
        url = self.get_regions.metadata['url']
        ...
        return deserialized
    get_regions.metadata = {'url': '/regions'}
