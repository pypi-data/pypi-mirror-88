...
class TenantParameters(Model):
    ...
    :param region: The geo-region where storage data will be located.
    :type region: str
    """
    ...
    def __init__(self, *, name: str, tenant_id: str=None, issuer_seed: str=None, image_url: str=None, network_id: str=None, endorser_type=None, region: str=None, **kwargs) -> None:
