...
class WalletClient(SDKClient):
    ...
    def delete_connection(
        ...
        if raw:
            ...
            return client_raw_response
    delete_connection.metadata = {'url': '/api/{walletId}/connections/{connectionId}'}
    ...
    def delete_credential(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    delete_credential.metadata = {'url': '/api/{walletId}/credentials/{credentialId}'}
    ...
    def accept_credential(
        ...
        :param wallet_id: The wallet identifier
        :type wallet_id: str
        :param credential_data: The credential data as URL or base64
    ...
    def delete_verification(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    delete_verification.metadata = {'url': '/api/{walletId}/verifications/{verificationId}'}
    ...
    def submit_verification_from_data_auto_select(
        ...
        :param wallet_id: The wallet identifier
        :type wallet_id: str
        :param verification_data: The verification
    ...
    def get_available_credentials_for_parameters(
            self, wallet_id, verification_data, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.get_available_credentials_for_parameters.metadata['url']
        path_format_arguments = {
            'walletId': self._serialize.url("wallet_id", wallet_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    get_available_credentials_for_parameters.metadata = {'url': '/api/{walletId}/verifications/fromData/availableCredentials'}

    def submit_verification_for_parameters(
            self, wallet_id, body=None, custom_headers=None, raw=False, **operation_config):
        """Submit verification using the provided policy parameters.

        :param wallet_id: The wallet identifier.
        :type wallet_id: str
        :param body: The verification parameters.
        :type body: ~wallet.models.VerificationDataPolicyCredentialParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        """
        # Construct URL
        url = self.submit_verification_for_parameters.metadata['url']
        path_format_arguments = {
            'walletId': self._serialize.url("wallet_id", wallet_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct body
        if body is not None:
            body_content = self._serialize.body(body, 'VerificationDataPolicyCredentialParameters')
        else:
            body_content = None
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    submit_verification_for_parameters.metadata = {'url': '/api/{walletId}/verifications/fromData'}
    ...
    def delete_wallet(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    delete_wallet.metadata = {'url': '/api/wallets/{walletId}'}
