...
[boto3.ComputeOptimizer 1.16.34](https://boto3.amazonaws.com/v1/documentation/api/1.16.34/reference/services/compute-optimizer.html#ComputeOptimizer) service
compatible with
