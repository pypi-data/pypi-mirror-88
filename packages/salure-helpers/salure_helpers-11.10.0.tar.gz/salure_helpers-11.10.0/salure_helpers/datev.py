...
class Datev(object):
    ...
    def export_to_template(self, df: pd.DataFrame, filepath: str, valid_from: str = datetime.today().strftime('%d.%m.%Y'), use_alternative_employee_number: bool = False, filename: str = f"importfile_{datetime.now().strftime('%B')}_{datetime.now().year}.txt"):
        ...
        template_description = f"100;u_lod_psd_mitarbeiter;{'pnr_betriebliche#psd' if use_alternative_employee_number else 'pnr#psd'};duevo_familienname#psd;duevo_vorname#psd;gebname#psd;adresse_strassenname#psd;adresse_strasse_nr#psd;adresse_plz#psd;adresse_ort#psd;\n" \
                               ...
                               f"287;u_lod_psd_sozialversicherung;{'pnr_betriebliche#psd' if use_alternative_employee_number else 'pnr#psd'};kk_nr#psd;av_bgrs#psd;kv_bgrs#psd;pv_bgrs#psd;rv_bgrs#psd;uml_schluessel#psd;\n" \
                               ...
                               f"503;u_lod_psd_taetigkeit;{'pnr_betriebliche#psd' if use_alternative_employee_number else 'pnr#psd'};stammkostenstelle#psd;\n" \
                               ...
                               f"702;u_lod_psd_steuer;{'pnr_betriebliche#psd' if use_alternative_employee_number else 'pnr#psd'};identifikationsnummer#psd;\n" \
