...
of the module using ``python -m sentencecloud`` syntax.
...
* using ``sentencecloud`` module::

    $ cat word.txt | python -m sentencecloud

    $ python -m sentencecloud --text=words.txt --stopwords=stopwords.txt
"""
