define([
    ...
    const funcOptProp = {
        stepCount : 1
        , funcName : "런타임 설정"
        , funcID : "mp_setting"  // TODO: ID 규칙 생성 필요
    }
    ...
    var initOption = function(callback, meta) {
        vpCommon.loadHtml(vpCommon.wrapSelector(vpCommon.formatString("#{0}", vpConst.OPTION_GREEN_ROOM)), "matplotlib/setting.html", optionLoadCallback, callback, meta);
    }
