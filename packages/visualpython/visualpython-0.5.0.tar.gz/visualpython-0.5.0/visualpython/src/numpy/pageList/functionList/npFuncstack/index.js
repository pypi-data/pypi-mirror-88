...
define([
    ...
    , 'nbextensions/visualpython/src/numpy/common/NumpyCodeGenerator/child/functionList/NpDstackHstackVstackCodeGenerator'
    , 'nbextensions/visualpython/src/numpy/common/NumpyPageRender/child/functionList/NpDstackHstackVstackPageRender'
    , 'nbextensions/visualpython/src/numpy/common/NumpyStateGenerator/parent/NumpyStateGenerator'
              ...
              vpNumpyConst, numpyStateApi, numpyRouteMapApi, numpyValidatorApi, numpyConstData       
               ,NumpyCodeGenerator, NumpyPageRender, 
              NumpyStateGenerator  ) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
        , funcName : "np_stack"
        , funcID : "np_stack"  // TODO: ID 규칙 생성 필요
    }
