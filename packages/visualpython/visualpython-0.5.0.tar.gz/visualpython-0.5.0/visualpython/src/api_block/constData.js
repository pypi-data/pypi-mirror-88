define([
    ...
    // const NUM_DEFAULT_POS_X = 60;
    const NUM_DEFAULT_POS_X = 75;
    ...
    const NUM_OPTION_PAGE_WIDTH = 380;
    /** ---------------------------------------- const String ------------------------------------------ */
    const STR_NULL = '';
    const STR_ONE_SPACE = ' ';
    ...
    const VP_CLASS_APIBLOCK_BOARD = 'vp-apiblock-left';
    ...
    const COLOR_CLASS_DEF = 'rgba(47, 133, 90, 0.2)';
    const COLOR_CONTROL = 'rgba(246, 173, 85, 0.2)';
    ...
    const COMPARISON_OPERATOR_IF_ARG4 = ['none', '==' ,'!=', '<', '>', '>=', '<=', 'and', 'or', 'in','not in'];
