    ...
    var InitListForBlockOption = function(thatBlock, optionPageSelector) {
        ...
        listforConditionListState.forEach((listforParam, index) => {
            ...
            $(document).on(STR_CLICK, vpCommon.wrapSelector(`#vpApiblockDeleteButton${index}${uuid}`), function(event) {
                ...
                $(`.vp-block-header-${uuid}`).html(listforConditionCode);
       ...
       /**
            ...
            /**
             * @event_function
             * List for arg10 선택 변경 이벤트 함수
             */
            // $(document).off(STR_CHANGE, `.vp_apiblockBlockoptionListforArg10${index}${uuid}`);
             ...
             */
            // $(document).off(STR_CHANGE, `.vp_apiblockBlockoptionListforArg12${index}${uuid}`);
            ...
            /** List for arg13 변경 */
            // $(document).off(STR_CHANGE_KEYUP_PASTE, `.vp_apiblockBlockoptionListforArg13${index}${uuid}`);
        ...
        $(document).on(STR_CLICK, vpCommon.wrapSelector(VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_LIST_FOR_PLUS + uuid), function() {
            ...
            $(`.vp-block-header-${uuid}`).html(listforfConditionCode);
        ...
        $(document).on(STR_CHANGE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_FOR_TYPE_SELECT +uuid, function(event) {
            ...
            if ( selectedVal == FOR_BLOCK_TYPE.FOR ) {
                ...
                $(`.vp-block-header-${thatBlock.getUUID()}`).html(forParamStr);
                ...
                $(`.vp-block-header-${thatBlock.getUUID()}`).html(listForStr);
        ...
        var renderThisComponent = function() {
            ...
            listforConditionListState.forEach((listforParam, index) => {
                ...
                if (arg3 == FOR_BLOCK_ARG3_TYPE.ZIP 
                    ...
                    || arg3 == FOR_BLOCK_ARG3_TYPE.ENUMERATE) {
                        sbforParamArg3 = MakeOptionSelectBox(VP_ID_APIBLOCK_OPTION_LIST_FOR_ARG_3  + index + uuid
                                                            , VP_CLASS_STYLE_WIDTH_40PERCENT
                                                            , arg3
                                                            , loadedVariableNameList_arg3);
                    sbListForCondition2ArgContainer.appendLine(sbforParamArg3);
                    ...
                    sbforParamArg3 = MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_LIST_FOR_ARG_3 + index + uuid
                                                                        , arg3
                                                                        , loadedVariableNameList_arg3
                                                                        , VP_CLASS_STYLE_WIDTH_40PERCENT
                                                                        , 'Method'
                ...
                // var suggestInputArg10 =  MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_LIST_FOR_ARG_10 + index + uuid
                //                                                         , arg10
                //                                                         , loadedVariableNameList_arg10
                //                                                         , VP_CLASS_STYLE_WIDTH_15PERCENT
                //                                                         , 'Select'
                ...
                //                                                             bindSelectValueEventFunc_for(selectedValue, 
                //                                                                                         index,
                //                                                                                         FOR_BLOCK_SELECT_VALUE_ARG_TYPE.ARG10);
                //                                                             }); 
            ...
            // , STATE_listforReturnVar
            // , STATE_listforPrevExpression
            // var listforConditionListState = thatBlock.getState(STATE_listforReturnVar);
            // var listforConditionListState = thatBlock.getState(STATE_listforPrevExpression);
