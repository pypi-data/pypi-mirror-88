define([
    ...
    var InitForBlockOption = function(thatBlock, optionPageSelector) {
        ...
        $(document).on(STR_CHANGE_KEYUP_PASTE, VP_ID_PREFIX + VP_ID_APIBLOCK_OPTION_FOR_ARG_1 + uuid, function(event) {
            ...
            $(`.vp-block-header-${uuid}`).html(forParamStr);
        ...
        var renderThisComponent = function() {
            ...
            sbforName.appendFormatLine("<div class='{0} {1}'", VP_CLASS_STYLE_FLEX_COLUMN_CENTER, VP_CLASS_STYLE_WIDTH_20PERCENT);
            ...
            sbforParamIn.appendFormatLine("<div class='{0}'", VP_CLASS_STYLE_FLEX_COLUMN_CENTER);
            ...
            if (arg3 == FOR_BLOCK_ARG3_TYPE.ZIP 
                ...
                || arg3 == FOR_BLOCK_ARG3_TYPE.ENUMERATE) {
                    sbforParamArg3 = MakeOptionSelectBox(VP_ID_APIBLOCK_OPTION_FOR_ARG_3 + uuid
                                                        , VP_CLASS_STYLE_WIDTH_40PERCENT
                                                        , arg3
                ...
                sbforParamArg3 = MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_FOR_ARG_3 + uuid
                                                                    , arg3
                                                                    , loadedVariableNameList_arg3
                                                                    , VP_CLASS_STYLE_WIDTH_40PERCENT
                                                                    , 'Method'
                ...
                // var sbforParamArg3InputStr = MakeVpSuggestInputText_apiblock(VP_ID_APIBLOCK_OPTION_FOR_ARG_3_INPUT_STR + uuid
                //                         , arg3InputStr
                ...
                sbforArgContainer.appendLine(sbforParamArg3);
                sbforArgContainer.appendLine(sbforParamArg2);
                // sbforArgContainer.appendLine(sbforParamArg3InputStr);                                    
            }
