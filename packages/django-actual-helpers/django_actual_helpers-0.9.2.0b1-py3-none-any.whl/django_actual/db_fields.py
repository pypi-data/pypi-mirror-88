...
from django_actual.compat import string_types
from django_actual.helper import md5_hash
...
try:
    ...
    ], ["^django_actual\.db_fields\.UniqueSlugField"])
except ImportError:
    pass
...
try:
    ...
    ], ["^django_actual\.db_fields\.RandomHashField"])
except ImportError:
    pass
...
try:
    ...
    ], ["^django_actual\.db_fields\.EncryptedTextField"])
except ImportError:
    pass
...
try:
    ...
    ], ["^django_actual\.db_fields\.EncryptedCharField"])
except ImportError:
    pass
