...
from ibm_watson_machine_learning.utils.autoai.enums import PositiveLabelClass
...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_22__deploy__online_deploy_best_computed_pipeline_from_autoai_on_wml(self):
        self.service.create(
