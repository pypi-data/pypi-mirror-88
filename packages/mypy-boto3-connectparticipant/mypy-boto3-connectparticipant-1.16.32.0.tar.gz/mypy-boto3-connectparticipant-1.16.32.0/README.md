...
[boto3.ConnectParticipant 1.16.32](https://boto3.amazonaws.com/v1/documentation/api/1.16.32/reference/services/connectparticipant.html#ConnectParticipant) service
compatible with
