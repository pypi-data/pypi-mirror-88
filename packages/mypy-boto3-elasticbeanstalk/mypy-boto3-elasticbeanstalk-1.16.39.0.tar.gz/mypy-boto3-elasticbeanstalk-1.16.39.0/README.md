...
[boto3.ElasticBeanstalk 1.16.39](https://boto3.amazonaws.com/v1/documentation/api/1.16.39/reference/services/elasticbeanstalk.html#ElasticBeanstalk) service
compatible with
