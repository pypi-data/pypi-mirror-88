...
[boto3.ElasticBeanstalk 1.16.34](https://boto3.amazonaws.com/v1/documentation/api/1.16.34/reference/services/elasticbeanstalk.html#ElasticBeanstalk) service
compatible with
