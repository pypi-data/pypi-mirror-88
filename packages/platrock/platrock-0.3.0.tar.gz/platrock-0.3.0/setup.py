...
setup(
	...
	install_requires = ["numpy>=1.17.5"+max_numpy_version,"gdal=="+gdal_version, "numpy-quaternion", "yappi","ipython", "jsonpickle==1.3", "matplotlib", "numba", "h5py", "shapely", "descartes", "remi==2020.11.20", "filemagic", "plotly", "scipy","scikit-image","psutil"],
