...
class ModelsAPI():
    ...
    def load_from_repository(self, repo_name:str, category:Categories, model_name:str, experimentID:int=-1, load_level=constants.FULL, print_files=False) -> EasierModel:
