...
[boto3.SagemakerEdgeManager 1.16.34](https://boto3.amazonaws.com/v1/documentation/api/1.16.34/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
