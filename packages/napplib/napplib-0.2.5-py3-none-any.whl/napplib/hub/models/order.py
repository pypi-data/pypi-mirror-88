...
class OrderAddress:
    def __init__(self, billingName = '',
        ...
        self.billingAddressExtra = billingAddressExtra if billingAddressExtra else None
        ...
        self.deliveryReference = Utils.create_values(deliveryReference, 'String')
...
class OrderShippingAddress:
    def __init__(self, deliveryName = '',
        ...
        self.deliveryZipCode = deliveryZipCode if deliveryZipCode else None
        self.deliveryCountry = Utils.create_values(deliveryCountry, 'String')
        self.deliveryReference = deliveryReference if deliveryReference else None
...
class Order:
    def __init__(self,  id='',
        ...
        self.marketplaceId = Utils.create_values(marketplaceId, 'Int64')
        ...
        self.contactTelephoneNumber = Utils.create_values(contactTelephoneNumber, 'String')
        self.orderForeignId = Utils.create_values(orderForeignId, 'String')
