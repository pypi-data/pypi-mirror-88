...
from rockset.field_partition import FieldPartition
...
class Client(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.FieldPartition = FieldPartitionClient(client=self)
...
class CollectionClient(object):
    ...
    def create(self, name, workspace="commons", description=None, **kwargs):
        ...
        field_partitions = [dict(m) for m in kwargs.pop('field_partitions', [])]
...
class FieldPartitionClient(object):
    def __init__(self, client):
        self.client = client

    def partition(self, *args, **kwargs):
        return FieldPartition.partition(*args, **kwargs)
