    ...
    def create(
        ...
        **kwargs
        ...
        Args:
            ...
            field_partitions (FieldPartition): array of FieldPartition objects
                that defines the partitioning config for this collection
        Returns:
        ...
        kwargs['field_partitions'] = field_partitions
