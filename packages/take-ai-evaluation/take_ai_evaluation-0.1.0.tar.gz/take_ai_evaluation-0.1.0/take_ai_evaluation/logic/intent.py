...
class Intent:
    ...
    def __create_one_vs_all_confusion_matrix(self) -> DF:
        ...
        return pd.DataFrame(data=data, columns=['FP', 'TN'], index=['TP', 'FN'])
    ...
    def __calculate_one_vs_all_confusion_matrix(self, all_vs_all_confusion_matrix: DF) -> None:
        ...
        self.fn = all_vs_all_confusion_matrix[self.label].sum() - self.tp
        self.fp = all_vs_all_confusion_matrix.loc[self.label].sum() - self.tp
