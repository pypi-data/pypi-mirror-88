...
from control.timeresp import step_info as stepinfo


from matplotlib.pyplot import figure, plot,grid,legend,close
from cmath import sqrt, phase, pi, tan, exp, sin, cos
import matplotlib.pyplot as plt
from numpy import real, imag, eye, poly,append, matrix, flip, angle
import warnings
