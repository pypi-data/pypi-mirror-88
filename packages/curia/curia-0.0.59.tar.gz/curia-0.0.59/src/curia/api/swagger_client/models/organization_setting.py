...
class OrganizationSetting(object):
    ...
    def __init__(self, id=None, impactability_model=None, risk_model=None, min_claim_date=None, max_claim_date=None, organization_id=None, created_at=None, updated_at=None, version=None):  # noqa: E501
