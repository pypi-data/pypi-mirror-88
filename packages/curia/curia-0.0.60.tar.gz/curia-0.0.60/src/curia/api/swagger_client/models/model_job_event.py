...
class ModelJobEvent(object):
    ...
    def __init__(self, id=None, timestamp=None, type=None, step=None, details=None, order=None, model_job_id=None, project_id=None, created_at=None, updated_at=None, version=None):  # noqa: E501
