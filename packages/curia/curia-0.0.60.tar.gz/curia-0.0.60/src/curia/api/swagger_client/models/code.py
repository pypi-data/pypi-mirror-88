...
class Code(object):
    ...
    def __init__(self, id=None, name=None, type=None, description=None, code_range=None, match_column_name=None, match_column_value=None, hierarchy_level=None, parent_code_id=None, parent_code=None, children_codes=None, created_at=None, updated_at=None, version=None):  # noqa: E501
