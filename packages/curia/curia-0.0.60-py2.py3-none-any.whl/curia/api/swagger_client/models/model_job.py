...
class ModelJob(object):
    ...
    def __init__(self, id=None, type=None, outcome_type=None, config=None, execution_id=None, schema=None, status=None, project_id=None, model_id=None, cohort_id=None, dataset_id=None, project=None, model=None, cohort=None, dataset=None, events=None, endpoints=None, model_job_output_features=None, model_job_statuses=None, feature_sub_categories=None, created_at=None, updated_at=None, version=None):  # noqa: E501
