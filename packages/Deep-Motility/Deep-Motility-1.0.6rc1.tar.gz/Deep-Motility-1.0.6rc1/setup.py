...
version = None
with open('deep_motility/__init__.py', 'r', encoding='utf-8') as f:
...
setup(
    ...
    description='Deep Learning methods for the classification and segmentation of motility images',  # Required
    ...
    url='https://github.com/joheras/Deep-Motility',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Jónathan Heras',  # Optional
    ...
    keywords='deep learning semantic segmentation pytorch motility classification',  # Optional
    ...
    entry_points={  # Optional
        'console_scripts': [
            'deep-motility=deep_motility.cli:main'
        ],
    }
)
