from sheetfu.helpers import rgb_to_hex, hex_to_rgb, date_to_serial_number, datetime_to_serial_number
	...
	def set_value(cell):
		if cell is not None:
			if isinstance(cell, str):
				...
				return {"userEnteredValue": {"numberValue": date_to_serial_number(cell)}}
