...
class Worker:
    ...
    def process_separate(self, pan_file, mul_files,
        ...
        pan_band = ds.Band(pan_file)  # ds.parse_directory(input_dir, [pan_channel], extensions)[0])
        mul_bands = ds.BandCollection(mul_files)  # ds.parse_directory(input_dir, mul_channels, extensions))
