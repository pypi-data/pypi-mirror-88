...
class OpenbisAuthenticator(Authenticator):
                ...
                if ok:
                    for entry in conn.response:
                        for attr in attributes:
                            ldap_attributes[attr] = entry['attributes'].get(attr)
    ...
    def pre_spawn_start(self, user, spawner):
        ...
        spawner.environment['UIDNUMBER']         = auth_state.get('uidNumber')
        spawner.environment['GIDNUMBER']         = auth_state.get('gidNumber')
