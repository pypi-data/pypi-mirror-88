...
from docassemble_pattern.text.en.inflect import (
...
from docassemble_pattern.text.en.inflect_quantify import (
    number, numerals, quantify, reflect
)
# Import mood & modality functions.
from docassemble_pattern.text.en.modality import (
    mood, INDICATIVE, IMPERATIVE, CONDITIONAL, SUBJUNCTIVE,
    modality, uncertain, EPISTEMIC,
    negated
)
# Import all submodules.
from docassemble_pattern.text.en import inflect
from docassemble_pattern.text.en import wordnet
from docassemble_pattern.text.en import wordlist
