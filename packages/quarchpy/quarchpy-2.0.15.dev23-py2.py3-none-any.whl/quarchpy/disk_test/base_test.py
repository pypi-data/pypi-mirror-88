...
class BaseTest(ABC):
    def __init__(self):
        ...
        self.cv_stop_on_id = self.declare_custom_variable(custom_name="Stop on ID", default_value="",
                                                          description="Stop test at first failure point",
                                                          is_string=True)
    ...
    def declare_custom_variable(self, default_value, custom_name, description="", var_purpose=None, accepted_vals=None,
                                numerical_max=None, is_string=False):
        """
        ...
        :param is_string: tells the UI to allow all characters to be entered into textfield
        :return:
        """
    ...
    def test_point(self, unique_id=None, function=None, function_args=None, function_description=None, debug=None,
        ...
        if not str(self.cv_stop_on_id.custom_value) == "":
            if unique_id is not None:
                if self.cv_stop_on_id.custom_value in unique_id:
