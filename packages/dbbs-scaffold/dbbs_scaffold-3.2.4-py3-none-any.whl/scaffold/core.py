...
class Scaffold:
    ...
    def __init__(self, config, from_file=None, report_file=None):
    ...
    def run_simulation(self, simulation_name, quit=False, listen=False):
        """
        ...
        if listen:
            listener = ReportListener(self, self.report_file)
