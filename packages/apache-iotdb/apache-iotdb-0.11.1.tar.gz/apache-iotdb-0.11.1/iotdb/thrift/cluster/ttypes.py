...
class Node(object):
    ...
    def __init__(self, ip=None, metaPort=None, nodeIdentifier=None, dataPort=None,):
        self.ip = ip
...
class SingleSeriesQueryRequest(object):
    ...
    def __init__(self, path=None, timeFilterBytes=None, valueFilterBytes=None, queryId=None, requester=None, header=None, dataTypeOrdinal=None, deviceMeasurements=None,):
        self.path = path
...
class GetAggrResultRequest(object):
    ...
    def __init__(self, path=None, aggregations=None, dataTypeOrdinal=None, timeFilterBytes=None, header=None, queryId=None, requestor=None, deviceMeasurements=None,):
        self.path = path
...
class GroupByRequest(object):
    ...
    def __init__(self, path=None, dataTypeOrdinal=None, timeFilterBytes=None, queryId=None, aggregationTypeOrdinals=None, header=None, requestor=None, deviceMeasurements=None,):
        self.path = path
        self.dataTypeOrdinal = dataTypeOrdinal
        self.timeFilterBytes = timeFilterBytes
        self.queryId = queryId
...
class LastQueryRequest(object):
    ...
    def __init__(self, path=None, dataTypeOrdinal=None, queryId=None, deviceMeasurements=None, header=None, requestor=None,):
        self.path = path
        self.dataTypeOrdinal = dataTypeOrdinal
        self.queryId = queryId
        self.deviceMeasurements = deviceMeasurements
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i83 in range(_size79):
                        ...
                        self.deviceMeasurements.add(_elem84)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.queryId is not None:
            ...
            oprot.writeFieldEnd()
        if self.deviceMeasurements is not None:
            oprot.writeFieldBegin('deviceMeasurements', TType.SET, 4)
            oprot.writeSetBegin(TType.STRING, len(self.deviceMeasurements))
            for iter85 in self.deviceMeasurements:
        ...
        if self.header is not None:
            ...
            oprot.writeFieldEnd()
        if self.requestor is not None:
            oprot.writeFieldBegin('requestor', TType.STRUCT, 6)
            self.requestor.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
LastQueryRequest.thrift_spec = (
    ...
    (4, TType.SET, 'deviceMeasurements', (TType.STRING, 'UTF8', False), None, ),  # 4
    (5, TType.STRUCT, 'header', [Node, None], None, ),  # 5
    (6, TType.STRUCT, 'requestor', [Node, None], None, ),  # 6
)
