...
class BillingAlarm(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param email: The email to which the alarm-triggered notification will be sent.
        ...
        """
        props = BillingAlarmProps(email=email, monthly_threshold=monthly_threshold)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"email": "email", "monthly_threshold": "monthlyThreshold"},
)
class BillingAlarmProps:
    def __init__(self, *, email: builtins.str, monthly_threshold: jsii.Number) -> None:
