...
class Node(metaclass=NodeMeta):
    ...
    def get_default_metadata(self, state):
        ...
        customer = self.config.get_customer()
...
class Skin(Node):
    ...
    An alternative to implementing this is to use the customer apps
...
class Transform(Node):
    ...
    def validate_results(self, what, state):
        ...
        """
        raise Exception("Transform module not overriding this check")
