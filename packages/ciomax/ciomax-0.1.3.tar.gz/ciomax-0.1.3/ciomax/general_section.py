...
class GeneralSection(CollapsibleSection):
    ...
    def __init__(self, dialog):
        ...
        self.instance_type_component = InstanceTypeComboBoxGrp(
            label="Instance Type", checkbox=True, check_label="Preemptible")
        ...
        self.build_project_combo()
        self.build_instance_type_combo()
    ...
    def build_instance_type_combo(self):
        if not coredata.valid():
