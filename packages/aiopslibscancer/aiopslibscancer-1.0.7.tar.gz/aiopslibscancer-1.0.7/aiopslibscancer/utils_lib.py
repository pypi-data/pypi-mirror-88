...
class SampedDataDataManager:
    def __init__(self, blob_manager, host, container_name):
        ...
        self.ARCHIVE_SAMPLED_PATH = "{0}/mldata/sampled_data/archive".format(container_name)
        self.CURRENT_SAMPLED_PATH = "{0}/mldata/sampled_data/current".format(container_name)
...
class AnnotatedDataManager:
    def __init__(self, blob_manager, host, container_name):
        ...
        self.annotated_data_url = "{0}/{1}/mldata/annotated_data/current/{2}".format(self.host,self.container_name, self.annotated_data_file)
        self.ARCHIVE_ANNOTATED_PATH = "{0}/mldata/annotated_data/archive".format(self.container_name)
        self.CURRENT_ANNOTATED_PATH = "{0}/mldata/annotated_data/current".format(self.container_name)
    ...
    def upload_data(self, annotated_data):
        with tempfile.TemporaryDirectory() as dir:
            ...
            blob_container = "{0}/mldata/annotated_data/current".format(self.container_name)
