...
enum : int {
    ...
    SBK_QTOPENGL_QLIST_QOPENGLDEBUGMESSAGE_IDX               = 2, // QList<QOpenGLDebugMessage >
    SBK_QTOPENGL_QLIST_QSIZE_IDX                             = 3, // QList<QSize >
    SBK_QTOPENGL_QLIST_FLOAT_IDX                             = 4, // QList<float >
    SBK_QTOPENGL_QLIST_QOPENGLSHADERPTR_IDX                  = 5, // QList<QOpenGLShader* >
    SBK_QTOPENGL_QPAIR_FLOAT_FLOAT_IDX                       = 6, // QPair<float,float >
    SBK_QTOPENGL_QPAIR_QOPENGLTEXTURE_FILTER_QOPENGLTEXTURE_FILTER_IDX = 7, // QPair<QOpenGLTexture::Filter,QOpenGLTexture::Filter >
    SBK_QTOPENGL_QPAIR_INT_INT_IDX                           = 8, // QPair<int,int >
