...
class QNetworkRequest(Shiboken.Object):
    ...
    EmitAllUploadProgressSignalsAttribute: QNetworkRequest = ... # 0x12
    Http2AllowedAttribute    : QNetworkRequest = ... # 0x13
    Http2WasUsedAttribute    : QNetworkRequest = ... # 0x14
    OriginalContentLengthAttribute: QNetworkRequest = ... # 0x15
    RedirectPolicyAttribute  : QNetworkRequest = ... # 0x16
    Http2DirectAttribute     : QNetworkRequest = ... # 0x17
    ResourceTypeAttribute    : QNetworkRequest = ... # 0x18
    AutoDeleteReplyOnFinishAttribute: QNetworkRequest = ... # 0x19
...
class QSsl(Shiboken.Object):
    ...
    TlsV1_2                  : QSsl = ... # 0x2
    AnyProtocol              : QSsl = ... # 0x3
    Ec                       : QSsl = ... # 0x3
    Dh                       : QSsl = ... # 0x4
    SecureProtocols          : QSsl = ... # 0x4
    SslOptionDisableCompression: QSsl = ... # 0x4
    TlsV1_0OrLater           : QSsl = ... # 0x5
    TlsV1_1OrLater           : QSsl = ... # 0x6
    TlsV1_2OrLater           : QSsl = ... # 0x7
    DtlsV1_0                 : QSsl = ... # 0x8
    SslOptionDisableServerNameIndication: QSsl = ... # 0x8
    DtlsV1_0OrLater          : QSsl = ... # 0x9
    DtlsV1_2                 : QSsl = ... # 0xa
    DtlsV1_2OrLater          : QSsl = ... # 0xb
    TlsV1_3                  : QSsl = ... # 0xc
    TlsV1_3OrLater           : QSsl = ... # 0xd
