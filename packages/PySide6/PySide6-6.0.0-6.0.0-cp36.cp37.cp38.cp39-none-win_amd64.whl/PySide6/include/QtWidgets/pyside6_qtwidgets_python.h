...
enum : int {
    ...
    SBK_QTWIDGETS_QLIST_INT_IDX                              = 5, // QList<int >
    ...
    SBK_QTWIDGETS_QLIST_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 8, // QList<QPair< QAccessibleInterface*,QFlags<QAccessible::RelationFlag> > >
    SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                       = 9, // QList<QWindow* >
    SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                       = 10, // QList<QScreen* >
    SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX               = 11, // QList<QAbstractButton* >
    SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX             = 12, // QMap<QDate,QTextCharFormat >
    SBK_QTWIDGETS_QLIST_QCOLOR_IDX                           = 13, // const QList<QColor >
    SBK_QTWIDGETS_QLIST_QURL_IDX                             = 14, // QList<QUrl >
    SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                      = 15, // QMap<int,QVariant >
    SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX            = 16, // const QList<QPersistentModelIndex > &
    SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                   = 17, // QHash<int,QByteArray >
    SBK_QTWIDGETS_QLIST_QGESTUREPTR_IDX                      = 18, // const QList<QGesture* > &
    SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                    = 19, // QPair<qreal,QPointF >
    SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX              = 20, // QList<QPair< qreal,QPointF > >
    SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                      = 21, // QPair<qreal,qreal >
    SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                = 22, // QList<QPair< qreal,qreal > >
    SBK_QTWIDGETS_QLIST_QRECTF_IDX                           = 23, // const QList<QRectF > &
    SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                 = 24, // QList<QGraphicsView* >
    SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX               = 25, // QList<QListWidgetItem* >
    SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                   = 26, // const QList<QDockWidget* > &
    SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                 = 27, // QList<QMdiSubWindow* >
    SBK_QTWIDGETS_QLIST_QTEXTEDIT_EXTRASELECTION_IDX         = 28, // QList<QTextEdit::ExtraSelection >
    SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                     = 29, // QList<QScroller* >
    SBK_QTWIDGETS_QLIST_QREAL_IDX                            = 30, // const QList<qreal > &
    SBK_QTWIDGETS_QLIST_QLINE_IDX                            = 31, // const QList<QLine > &
    SBK_QTWIDGETS_QLIST_QLINEF_IDX                           = 32, // const QList<QLineF > &
    SBK_QTWIDGETS_QLIST_QPOINT_IDX                           = 33, // const QList<QPoint > &
    SBK_QTWIDGETS_QLIST_QPOINTF_IDX                          = 34, // const QList<QPointF > &
    SBK_QTWIDGETS_QLIST_QRECT_IDX                            = 35, // const QList<QRect > &
    SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX              = 36, // QList<QTableWidgetItem* >
    SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX       = 37, // QList<QTableWidgetSelectionRange >
    SBK_QTWIDGETS_QLIST_QTREEWIDGETITEMPTR_IDX               = 38, // const QList<QTreeWidgetItem* > &
    SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                     = 39, // const QList<QKeySequence > &
    SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX             = 40, // const QList<QWizard::WizardButton > &
