...
enum : int {
    ...
    SBK_QTCORE_QLIST_INT_IDX                                 = 16, // const QList<int > &
    ...
    SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                      = 19, // QHash<int,QByteArray >
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 20, // const QList<QVariant > &
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 21, // const QHash<QString,QVariant > &
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 22, // const QMap<QString,QVariant > &
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 23, // QList<QCborValue >
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 24, // const QList<QCommandLineOption > &
    SBK_QTCORE_QLIST_QABSTRACTITEMMODELPTR_IDX               = 25, // QList<QAbstractItemModel* >
    SBK_QTCORE_QPAIR_QINT64_UNSIGNEDINT_IDX                  = 26, // QPair<qint64,unsigned int >
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 27, // QList<QFileInfo >
    SBK_QTCORE_QLIST_QPOINTF_IDX                             = 28, // QList<QPointF >
    ...
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 35, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_QTIMEZONE_OFFSETDATA_IDX                = 36, // QList<QTimeZone::OffsetData >
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 37, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 38, // QList<QPair< QString,QString > >
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 39, // QList<QXmlStreamAttribute >
    SBK_QTCORE_QLIST_QXMLSTREAMNAMESPACEDECLARATION_IDX      = 40, // const QList<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QLIST_QXMLSTREAMENTITYDECLARATION_IDX         = 41, // QList<QXmlStreamEntityDeclaration >
