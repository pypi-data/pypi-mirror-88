...
// Converter indices
enum : int {
    SBK_QTHELP_QLIST_INT_IDX                                 = 0, // const QList<int > &
    SBK_QTHELP_QMAP_INT_QVARIANT_IDX                         = 1, // QMap<int,QVariant >
    SBK_QTHELP_QLIST_QPERSISTENTMODELINDEX_IDX               = 2, // const QList<QPersistentModelIndex > &
    SBK_QTHELP_QHASH_INT_QBYTEARRAY_IDX                      = 3, // QHash<int,QByteArray >
    ...
    SBK_QTHELP_QLIST_QOBJECTPTR_IDX                          = 7, // const QList<QObject* > &
    SBK_QTHELP_QLIST_QBYTEARRAY_IDX                          = 8, // QList<QByteArray >
    SBK_QTHELP_QLIST_QVERSIONNUMBER_IDX                      = 9, // const QList<QVersionNumber > &
    SBK_QTHELP_QMAP_QSTRING_QSTRING_IDX                      = 10, // QMap<QString,QString >
    SBK_QTHELP_QMAP_QSTRING_QVERSIONNUMBER_IDX               = 11, // QMap<QString,QVersionNumber >
    SBK_QTHELP_QLIST_QACTIONPTR_IDX                          = 12, // QList<QAction* >
    SBK_QTHELP_QMULTIMAP_QSTRING_QURL_IDX                    = 13, // const QMultiMap<QString,QUrl > &
    SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                    = 14, // QList<QHelpSearchQuery >
    SBK_QTHELP_QLIST_QHELPSEARCHRESULT_IDX                   = 15, // QList<QHelpSearchResult >
