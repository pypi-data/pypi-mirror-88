...
enum : int {
    ...
    SBK_QTOPENGL_QLIST_UNSIGNEDINT_IDX                       = 1, // const QList<unsigned int > &
    SBK_QTOPENGL_QLIST_QBYTEARRAY_IDX                        = 2, // QList<QByteArray >
    SBK_QTOPENGL_QLIST_QOPENGLDEBUGMESSAGE_IDX               = 3, // QList<QOpenGLDebugMessage >
    SBK_QTOPENGL_QLIST_QSIZE_IDX                             = 4, // QList<QSize >
    SBK_QTOPENGL_QLIST_FLOAT_IDX                             = 5, // QList<float >
    SBK_QTOPENGL_QLIST_QOPENGLSHADERPTR_IDX                  = 6, // QList<QOpenGLShader* >
    SBK_QTOPENGL_QPAIR_FLOAT_FLOAT_IDX                       = 7, // QPair<float,float >
    SBK_QTOPENGL_QPAIR_QOPENGLTEXTURE_FILTER_QOPENGLTEXTURE_FILTER_IDX = 8, // QPair<QOpenGLTexture::Filter,QOpenGLTexture::Filter >
    SBK_QTOPENGL_QPAIR_INT_INT_IDX                           = 9, // QPair<int,int >
    SBK_QTOPENGL_QLIST_UNSIGNEDLONGLONG_IDX                  = 10, // QList<unsigned long long >
