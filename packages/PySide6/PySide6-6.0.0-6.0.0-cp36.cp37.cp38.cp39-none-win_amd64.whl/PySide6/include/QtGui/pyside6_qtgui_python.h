...
enum : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 341,
    ...
    SBK_QKEYCOMBINATION_IDX                                  = 141,
    SBK_QKEYEVENT_IDX                                        = 142,
    SBK_QKEYSEQUENCE_STANDARDKEY_IDX                         = 146,
    SBK_QKEYSEQUENCE_SEQUENCEFORMAT_IDX                      = 144,
    SBK_QKEYSEQUENCE_SEQUENCEMATCH_IDX                       = 145,
    SBK_QKEYSEQUENCE_IDX                                     = 143,
    SBK_QLINEARGRADIENT_IDX                                  = 147,
    SBK_QMATRIX2X2_IDX                                       = 148,
    SBK_QGENERICMATRIX_2_2_FLOAT_IDX                         = 148,
    SBK_QMATRIX2X3_IDX                                       = 149,
    SBK_QGENERICMATRIX_2_3_FLOAT_IDX                         = 149,
    SBK_QMATRIX2X4_IDX                                       = 150,
    SBK_QGENERICMATRIX_2_4_FLOAT_IDX                         = 150,
    SBK_QMATRIX3X2_IDX                                       = 151,
    SBK_QGENERICMATRIX_3_2_FLOAT_IDX                         = 151,
    SBK_QMATRIX3X3_IDX                                       = 152,
    SBK_QGENERICMATRIX_3_3_FLOAT_IDX                         = 152,
    SBK_QMATRIX3X4_IDX                                       = 153,
    SBK_QGENERICMATRIX_3_4_FLOAT_IDX                         = 153,
    SBK_QMATRIX4X2_IDX                                       = 154,
    SBK_QGENERICMATRIX_4_2_FLOAT_IDX                         = 154,
    SBK_QMATRIX4X3_IDX                                       = 155,
    SBK_QGENERICMATRIX_4_3_FLOAT_IDX                         = 155,
    SBK_QMATRIX4X4_FLAG_IDX                                  = 157,
    SBK_QFLAGS_QMATRIX4X4_FLAG_IDX                           = 74,
    SBK_QMATRIX4X4_IDX                                       = 156,
    SBK_QMOUSEEVENT_IDX                                      = 158,
    SBK_QMOVEEVENT_IDX                                       = 159,
    SBK_QMOVIE_MOVIESTATE_IDX                                = 162,
    SBK_QMOVIE_CACHEMODE_IDX                                 = 161,
    SBK_QMOVIE_IDX                                           = 160,
    SBK_QNATIVEGESTUREEVENT_IDX                              = 163,
    SBK_QOFFSCREENSURFACE_IDX                                = 164,
    SBK_QOPENGLCONTEXT_OPENGLMODULETYPE_IDX                  = 166,
    SBK_QOPENGLCONTEXT_IDX                                   = 165,
    SBK_QOPENGLCONTEXTGROUP_IDX                              = 167,
    SBK_QOPENGLEXTRAFUNCTIONS_IDX                            = 168,
    SBK_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX                   = 170,
    SBK_QFLAGS_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX            = 75,
    SBK_QOPENGLFUNCTIONS_IDX                                 = 169,
    SBK_QPAGELAYOUT_UNIT_IDX                                 = 174,
    SBK_QPAGELAYOUT_ORIENTATION_IDX                          = 173,
    SBK_QPAGELAYOUT_MODE_IDX                                 = 172,
    SBK_QPAGELAYOUT_IDX                                      = 171,
    SBK_QPAGESIZE_PAGESIZEID_IDX                             = 176,
    SBK_QPAGESIZE_UNIT_IDX                                   = 178,
    SBK_QPAGESIZE_SIZEMATCHPOLICY_IDX                        = 177,
    SBK_QPAGESIZE_IDX                                        = 175,
    SBK_QPAGEDPAINTDEVICE_PDFVERSION_IDX                     = 180,
    SBK_QPAGEDPAINTDEVICE_IDX                                = 179,
    SBK_QPAINTDEVICE_PAINTDEVICEMETRIC_IDX                   = 182,
    SBK_QPAINTDEVICE_IDX                                     = 181,
    SBK_QPAINTDEVICEWINDOW_IDX                               = 183,
    SBK_QPAINTENGINE_PAINTENGINEFEATURE_IDX                  = 186,
    SBK_QFLAGS_QPAINTENGINE_PAINTENGINEFEATURE_IDX           = 77,
    SBK_QPAINTENGINE_DIRTYFLAG_IDX                           = 185,
    SBK_QFLAGS_QPAINTENGINE_DIRTYFLAG_IDX                    = 76,
    SBK_QPAINTENGINE_POLYGONDRAWMODE_IDX                     = 187,
    SBK_QPAINTENGINE_TYPE_IDX                                = 188,
    SBK_QPAINTENGINE_IDX                                     = 184,
    SBK_QPAINTENGINESTATE_IDX                                = 189,
    SBK_QPAINTEVENT_IDX                                      = 190,
    SBK_QPAINTER_RENDERHINT_IDX                              = 195,
    SBK_QFLAGS_QPAINTER_RENDERHINT_IDX                       = 79,
    SBK_QPAINTER_PIXMAPFRAGMENTHINT_IDX                      = 194,
    SBK_QFLAGS_QPAINTER_PIXMAPFRAGMENTHINT_IDX               = 78,
    SBK_QPAINTER_COMPOSITIONMODE_IDX                         = 192,
    SBK_QPAINTER_IDX                                         = 191,
    SBK_QPAINTER_PIXMAPFRAGMENT_IDX                          = 193,
    SBK_QPAINTERPATH_ELEMENTTYPE_IDX                         = 198,
    SBK_QPAINTERPATH_IDX                                     = 196,
    SBK_QPAINTERPATH_ELEMENT_IDX                             = 197,
    SBK_QPAINTERPATHSTROKER_IDX                              = 199,
    SBK_QPALETTE_COLORGROUP_IDX                              = 201,
    SBK_QPALETTE_COLORROLE_IDX                               = 202,
    SBK_QPALETTE_IDX                                         = 200,
    SBK_QPDFWRITER_IDX                                       = 203,
    SBK_QPEN_IDX                                             = 204,
    SBK_QPICTURE_IDX                                         = 205,
    SBK_QPIXELFORMAT_COLORMODEL_IDX                          = 211,
    SBK_QPIXELFORMAT_ALPHAUSAGE_IDX                          = 209,
    SBK_QPIXELFORMAT_ALPHAPOSITION_IDX                       = 207,
    SBK_QPIXELFORMAT_ALPHAPREMULTIPLIED_IDX                  = 208,
    SBK_QPIXELFORMAT_TYPEINTERPRETATION_IDX                  = 212,
    SBK_QPIXELFORMAT_YUVLAYOUT_IDX                           = 213,
    SBK_QPIXELFORMAT_BYTEORDER_IDX                           = 210,
    SBK_QPIXELFORMAT_IDX                                     = 206,
    SBK_QPIXMAP_IDX                                          = 214,
    SBK_QPIXMAPCACHE_IDX                                     = 215,
    SBK_QPIXMAPCACHE_KEY_IDX                                 = 216,
    SBK_QPOINTEREVENT_IDX                                    = 217,
    SBK_QPOINTINGDEVICE_POINTERTYPE_IDX                      = 220,
    SBK_QFLAGS_QPOINTINGDEVICE_POINTERTYPE_IDX               = 80,
    SBK_QPOINTINGDEVICE_GRABTRANSITION_IDX                   = 219,
    SBK_QPOINTINGDEVICE_IDX                                  = 218,
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 221,
    SBK_QPOLYGON_IDX                                         = 222,
    SBK_QLIST_QPOINT_IDX                                     = 222,
    SBK_QPOLYGONF_IDX                                        = 223,
    SBK_QLIST_QPOINTF_IDX                                    = 223,
    SBK_QPYTEXTOBJECT_IDX                                    = 224,
    SBK_QQUATERNION_IDX                                      = 225,
    SBK_QRADIALGRADIENT_IDX                                  = 226,
    SBK_QRASTERWINDOW_IDX                                    = 227,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 229,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 230,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 81,
    SBK_QRAWFONT_IDX                                         = 228,
    SBK_QREGION_REGIONTYPE_IDX                               = 232,
    SBK_QREGION_IDX                                          = 231,
    SBK_QREGULAREXPRESSIONVALIDATOR_IDX                      = 233,
    SBK_QRESIZEEVENT_IDX                                     = 234,
    SBK_QSCREEN_IDX                                          = 235,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 237,
    SBK_QSCROLLEVENT_IDX                                     = 236,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 238,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 240,
    SBK_QSESSIONMANAGER_IDX                                  = 239,
    SBK_QSHORTCUT_IDX                                        = 241,
    SBK_QSHORTCUTEVENT_IDX                                   = 242,
    SBK_QSHOWEVENT_IDX                                       = 243,
    SBK_QSINGLEPOINTEVENT_IDX                                = 244,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 246,
    SBK_QSTANDARDITEM_IDX                                    = 245,
    SBK_QSTANDARDITEMMODEL_IDX                               = 247,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 249,
    SBK_QSTATICTEXT_IDX                                      = 248,
    SBK_QSTATUSTIPEVENT_IDX                                  = 250,
    SBK_QSTYLEHINTS_IDX                                      = 251,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 253,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 254,
    SBK_QSURFACE_IDX                                         = 252,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 257,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 82,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 260,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 259,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 258,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 256,
    SBK_QSURFACEFORMAT_IDX                                   = 255,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 261,
    SBK_QTABLETEVENT_IDX                                     = 262,
    SBK_QTEXTBLOCK_IDX                                       = 263,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 264,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 342,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 266,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 265,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 267,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 268,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 272,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 271,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 270,
    SBK_QTEXTCHARFORMAT_IDX                                  = 269,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 274,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 275,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 276,
    SBK_QTEXTCURSOR_IDX                                      = 273,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 280,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 279,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 84,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 278,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 83,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 281,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 282,
    SBK_QTEXTDOCUMENT_IDX                                    = 277,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 283,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 284,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 286,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 289,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 287,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 288,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 85,
    SBK_QTEXTFORMAT_IDX                                      = 285,
    SBK_QTEXTFRAGMENT_IDX                                    = 290,
    SBK_QTEXTFRAME_IDX                                       = 291,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 292,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 295,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 294,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 293,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 296,
    SBK_QTEXTINLINEOBJECT_IDX                                = 297,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 299,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 86,
    SBK_QTEXTITEM_IDX                                        = 298,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 301,
    SBK_QTEXTLAYOUT_IDX                                      = 300,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 302,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 304,
    SBK_QTEXTLENGTH_IDX                                      = 303,
    SBK_QTEXTLINE_EDGE_IDX                                   = 307,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 306,
    SBK_QTEXTLINE_IDX                                        = 305,
    SBK_QTEXTLIST_IDX                                        = 308,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 310,
    SBK_QTEXTLISTFORMAT_IDX                                  = 309,
    SBK_QTEXTOBJECT_IDX                                      = 311,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 312,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 316,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 317,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 314,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 87,
    SBK_QTEXTOPTION_IDX                                      = 313,
    SBK_QTEXTOPTION_TAB_IDX                                  = 315,
    SBK_QTEXTTABLE_IDX                                       = 318,
    SBK_QTEXTTABLECELL_IDX                                   = 319,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 320,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 321,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 322,
    SBK_QTOUCHEVENT_IDX                                      = 323,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 325,
    SBK_QTRANSFORM_IDX                                       = 324,
    SBK_QUNDOCOMMAND_IDX                                     = 326,
    SBK_QUNDOGROUP_IDX                                       = 327,
    SBK_QUNDOSTACK_IDX                                       = 328,
    SBK_QVALIDATOR_STATE_IDX                                 = 330,
    SBK_QVALIDATOR_IDX                                       = 329,
    SBK_QVECTOR2D_IDX                                        = 331,
    SBK_QVECTOR3D_IDX                                        = 332,
    SBK_QVECTOR4D_IDX                                        = 333,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 334,
    SBK_QWHEELEVENT_IDX                                      = 335,
    SBK_QWINDOW_VISIBILITY_IDX                               = 338,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 337,
    SBK_QWINDOW_IDX                                          = 336,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 339,
    SBK_QtGuiQT_IDX                                          = 340,
    SBK_QtGui_IDX_COUNT                                      = 343
};
...
enum : int {
    SBK_WID_IDX                                              = 0,
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 1, // const QList<QObject* > &
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 2, // QList<QByteArray >
    SBK_QTGUI_QPAIR_INT_INT_IDX                              = 3, // QPair<int,int >
    SBK_QTGUI_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 4, // QPair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag> >
    SBK_QTGUI_QLIST_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 5, // QList<QPair< QAccessibleInterface*,QFlags<QAccessible::RelationFlag> > >
    SBK_QTGUI_QLIST_QACCESSIBLEINTERFACEPTR_IDX              = 6, // QList<QAccessibleInterface* >
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 7, // const QList<QKeySequence > &
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 8, // QList<QAction* >
    SBK_QTGUI_QLIST_INT_IDX                                  = 9, // QList<int >
    SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX          = 10, // QList<QFontDatabase::WritingSystem >
    SBK_QTGUI_QLIST_QWINDOWPTR_IDX                           = 11, // QList<QWindow* >
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 12, // QList<QScreen* >
    SBK_QTGUI_QLIST_QSIZE_IDX                                = 13, // QList<QSize >
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 14, // QList<unsigned int >
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 15, // QList<const QInputDevice* >
    SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX          = 16, // const QList<QInputMethodEvent::Attribute > &
    ...
    SBK_QTGUI_QLIST_QPOINT_IDX                               = 20, // QList<QPoint >
    ...
    SBK_QTGUI_QLIST_QREAL_IDX                                = 27, // QList<qreal >
    SBK_QTGUI_QLIST_QEVENTPOINT_IDX                          = 28, // const QList<QEventPoint > &
    SBK_QTGUI_QLIST_QUINT32_IDX                              = 29, // const QList<quint32 > &
    SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                     = 30, // const QList<QStandardItem* > &
    SBK_QTGUI_QMAP_INT_QVARIANT_IDX                          = 31, // QMap<int,QVariant >
    SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                = 32, // const QList<QPersistentModelIndex > &
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 33, // QHash<int,QByteArray >
    SBK_QTGUI_QLIST_QTEXTLAYOUT_FORMATRANGE_IDX              = 34, // QList<QTextLayout::FormatRange >
    SBK_QTGUI_QLIST_QTEXTLENGTH_IDX                          = 35, // QList<QTextLength >
    SBK_QTGUI_QLIST_QTEXTOPTION_TAB_IDX                      = 36, // const QList<QTextOption::Tab > &
    ...
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 40, // QList<QUndoStack* >
...
template<> inline PyTypeObject *SbkType< ::QKeyCombination >() { return reinterpret_cast<PyTypeObject *>(SbkPySide6_QtGuiTypes[SBK_QKEYCOMBINATION_IDX]); }
