...
enum : int {
    ...
    SBK_QTNETWORK_QLIST_QSSLERROR_IDX                        = 8, // const QList<QSslError > &
    ...
    SBK_QTNETWORK_QLIST_QHSTSPOLICY_IDX                      = 11, // const QList<QHstsPolicy > &
    SBK_QTNETWORK_QHASH_QNETWORKREQUEST_ATTRIBUTE_QVARIANT_IDX = 12, // QHash<QNetworkRequest::Attribute,QVariant >
    SBK_QTNETWORK_QLIST_QNETWORKCOOKIE_IDX                   = 13, // QList<QNetworkCookie >
    SBK_QTNETWORK_QLIST_QNETWORKADDRESSENTRY_IDX             = 14, // QList<QNetworkAddressEntry >
    SBK_QTNETWORK_QLIST_QNETWORKINTERFACE_IDX                = 15, // QList<QNetworkInterface >
    SBK_QTNETWORK_QLIST_QNETWORKPROXY_IDX                    = 16, // QList<QNetworkProxy >
    SBK_QTNETWORK_QLIST_QSSLCERTIFICATEEXTENSION_IDX         = 17, // QList<QSslCertificateExtension >
    SBK_QTNETWORK_QLIST_QSSLCERTIFICATE_IDX                  = 18, // QList<QSslCertificate >
    SBK_QTNETWORK_QMULTIMAP_QSSL_ALTERNATIVENAMEENTRYTYPE_QSTRING_IDX = 19, // QMultiMap<QSsl::AlternativeNameEntryType,QString >
    SBK_QTNETWORK_QMAP_QBYTEARRAY_QVARIANT_IDX               = 20, // QMap<QByteArray,QVariant >
    SBK_QTNETWORK_QLIST_QSSLCIPHER_IDX                       = 21, // QList<QSslCipher >
