...
class QJSEngine(PySide6.QtCore.QObject):
    ...
    CppOwnership             : QJSEngine = ... # 0x0
    JavaScriptOwnership      : QJSEngine = ... # 0x1
...
class QQmlImageProviderBase(PySide6.QtCore.QObject):
    Invalid                  : QQmlImageProviderBase = ... # 0x0
    ForceAsynchronousImageLoading: QQmlImageProviderBase = ... # 0x1
    Image                    : QQmlImageProviderBase = ... # 0x1
    Pixmap                   : QQmlImageProviderBase = ... # 0x2
    Texture                  : QQmlImageProviderBase = ... # 0x3
