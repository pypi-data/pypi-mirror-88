...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 400,
    ...
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 159,
    SBK_QLIBRARYINFO_IDX                                     = 158,
    SBK_QLINE_IDX                                            = 160,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 162,
    SBK_QLINEF_IDX                                           = 161,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 168,
    SBK_QLOCALE_SCRIPT_IDX                                   = 403,
    ...
    SBK_QMETATYPE_TYPE_IDX                                   = 187,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 188,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 106,
    SBK_QMETATYPE_IDX                                        = 186,
    SBK_QMIMEDATA_IDX                                        = 189,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 191,
    SBK_QMIMEDATABASE_IDX                                    = 190,
    SBK_QMIMETYPE_IDX                                        = 192,
    SBK_QMODELINDEX_IDX                                      = 193,
    SBK_QMUTEX_IDX                                           = 194,
    SBK_QOBJECT_IDX                                          = 195,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 197,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 196,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 198,
    SBK_QPAUSEANIMATION_IDX                                  = 199,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 200,
    SBK_QPLUGINLOADER_IDX                                    = 201,
    SBK_QPOINT_IDX                                           = 202,
    SBK_QPOINTF_IDX                                          = 203,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 209,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 210,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 207,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 208,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 206,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 205,
    SBK_QPROCESS_IDX                                         = 204,
    SBK_QPROCESSENVIRONMENT_IDX                              = 211,
    SBK_QPROPERTYANIMATION_IDX                               = 212,
    SBK_QRANDOMGENERATOR_IDX                                 = 213,
    SBK_QRANDOMGENERATOR64_IDX                               = 214,
    SBK_QREADLOCKER_IDX                                      = 215,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 217,
    SBK_QREADWRITELOCK_IDX                                   = 216,
    SBK_QRECT_IDX                                            = 218,
    SBK_QRECTF_IDX                                           = 219,
    SBK_QRECURSIVEMUTEX_IDX                                  = 220,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 224,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 108,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 223,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 222,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 107,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 225,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 109,
    SBK_QREGULAREXPRESSION_IDX                               = 221,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 226,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 227,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 229,
    SBK_QRESOURCE_IDX                                        = 228,
    SBK_QRUNNABLE_IDX                                        = 230,
    SBK_QSAVEFILE_IDX                                        = 231,
    SBK_QSEMAPHORE_IDX                                       = 232,
    SBK_QSEMAPHORERELEASER_IDX                               = 233,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 234,
    SBK_QSETTINGS_STATUS_IDX                                 = 238,
    SBK_QSETTINGS_FORMAT_IDX                                 = 236,
    SBK_QSETTINGS_SCOPE_IDX                                  = 237,
    SBK_QSETTINGS_IDX                                        = 235,
    SBK_QSIGNALBLOCKER_IDX                                   = 239,
    SBK_QSIGNALMAPPER_IDX                                    = 240,
    SBK_QSIZE_IDX                                            = 241,
    SBK_QSIZEF_IDX                                           = 242,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 243,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 245,
    SBK_QSOCKETNOTIFIER_IDX                                  = 244,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 246,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 249,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 248,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 110,
    SBK_QSTANDARDPATHS_IDX                                   = 247,
    SBK_QSTORAGEINFO_IDX                                     = 250,
    SBK_QSTRINGLISTMODEL_IDX                                 = 251,
    SBK_QSYSINFO_SIZES_IDX                                   = 254,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 253,
    SBK_QSYSINFO_IDX                                         = 252,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 256,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 257,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 255,
    SBK_QTEMPORARYDIR_IDX                                    = 258,
    SBK_QTEMPORARYFILE_IDX                                   = 259,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 262,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 261,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 111,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 260,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 266,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 264,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 267,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 265,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 112,
    SBK_QTEXTSTREAM_IDX                                      = 263,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 268,
    SBK_QTHREAD_PRIORITY_IDX                                 = 270,
    SBK_QTHREAD_IDX                                          = 269,
    SBK_QTHREADPOOL_IDX                                      = 271,
    SBK_QTIME_IDX                                            = 272,
    SBK_QTIMELINE_STATE_IDX                                  = 275,
    SBK_QTIMELINE_DIRECTION_IDX                              = 274,
    SBK_QTIMELINE_IDX                                        = 273,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 279,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 277,
    SBK_QTIMEZONE_IDX                                        = 276,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 278,
    SBK_QTIMER_IDX                                           = 280,
    SBK_QTIMEREVENT_IDX                                      = 281,
    SBK_QTRANSLATOR_IDX                                      = 282,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 283,
    SBK_QURL_PARSINGMODE_IDX                                 = 286,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 287,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 285,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 113,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 288,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 115,
    SBK_QURL_IDX                                             = 284,
    SBK_QURLQUERY_IDX                                        = 289,
    SBK_QUUID_VARIANT_IDX                                    = 292,
    SBK_QUUID_VERSION_IDX                                    = 293,
    SBK_QUUID_STRINGFORMAT_IDX                               = 291,
    SBK_QUUID_IDX                                            = 290,
    SBK_QVARIANTANIMATION_IDX                                = 294,
    SBK_QVERSIONNUMBER_IDX                                   = 295,
    SBK_QWAITCONDITION_IDX                                   = 296,
    SBK_QWRITELOCKER_IDX                                     = 297,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 298,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 299,
    SBK_QLIST_QXMLSTREAMATTRIBUTE_IDX                        = 299,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 300,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 301,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 302,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 303,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 307,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 306,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 305,
    SBK_QXMLSTREAMREADER_IDX                                 = 304,
    SBK_QXMLSTREAMWRITER_IDX                                 = 308,
    SBK_QT_GLOBALCOLOR_IDX                                   = 343,
    SBK_QT_MOUSEBUTTON_IDX                                   = 359,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 129,
    SBK_QT_ORIENTATION_IDX                                   = 364,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 131,
    SBK_QT_FOCUSPOLICY_IDX                                   = 338,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 377,
    SBK_QT_SORTORDER_IDX                                     = 375,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 376,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 133,
    SBK_QT_TILERULE_IDX                                      = 382,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 310,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 116,
    SBK_QT_TEXTFLAG_IDX                                      = 379,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 378,
    SBK_QT_WHITESPACEMODE_IDX                                = 391,
    SBK_QT_HITTESTACCURACY_IDX                               = 345,
    SBK_QT_WINDOWTYPE_IDX                                    = 396,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 138,
    SBK_QT_WINDOWSTATE_IDX                                   = 395,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 137,
    SBK_QT_APPLICATIONSTATE_IDX                              = 313,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 117,
    SBK_QT_SCREENORIENTATION_IDX                             = 369,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 132,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 392,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 312,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 346,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 123,
    SBK_QT_BGMODE_IDX                                        = 317,
    SBK_QT_KEY_IDX                                           = 353,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 354,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 127,
    SBK_QT_MODIFIER_IDX                                      = 358,
    SBK_QT_ARROWTYPE_IDX                                     = 314,
    SBK_QT_PENSTYLE_IDX                                      = 367,
    SBK_QT_PENCAPSTYLE_IDX                                   = 365,
    SBK_QT_PENJOINSTYLE_IDX                                  = 366,
    SBK_QT_BRUSHSTYLE_IDX                                    = 318,
    SBK_QT_SIZEMODE_IDX                                      = 374,
    SBK_QT_UIEFFECT_IDX                                      = 390,
    SBK_QT_CURSORSHAPE_IDX                                   = 327,
    SBK_QT_TEXTFORMAT_IDX                                    = 380,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 315,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 330,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 118,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 331,
    SBK_QT_TOOLBARAREA_IDX                                   = 385,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 135,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 386,
    SBK_QT_DATEFORMAT_IDX                                    = 328,
    SBK_QT_TIMESPEC_IDX                                      = 383,
    SBK_QT_DAYOFWEEK_IDX                                     = 329,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 370,
    SBK_QT_CASESENSITIVITY_IDX                               = 319,
    SBK_QT_CORNER_IDX                                        = 326,
    SBK_QT_EDGE_IDX                                          = 333,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 120,
    SBK_QT_CONNECTIONTYPE_IDX                                = 323,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 372,
    SBK_QT_FILLRULE_IDX                                      = 336,
    SBK_QT_MASKMODE_IDX                                      = 356,
    SBK_QT_CLIPOPERATION_IDX                                 = 322,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 351,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 352,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 389,
    SBK_QT_AXIS_IDX                                          = 316,
    SBK_QT_FOCUSREASON_IDX                                   = 339,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 324,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 348,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 125,
    SBK_QT_INPUTMETHODHINT_IDX                               = 347,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 124,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 334,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 387,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 355,
    SBK_QT_ANCHORPOINT_IDX                                   = 311,
    SBK_QT_FINDCHILDOPTION_IDX                               = 337,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 121,
    SBK_QT_DROPACTION_IDX                                    = 332,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 119,
    SBK_QT_CHECKSTATE_IDX                                    = 320,
    SBK_QT_ITEMDATAROLE_IDX                                  = 349,
    SBK_QT_ITEMFLAG_IDX                                      = 350,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 126,
    SBK_QT_MATCHFLAG_IDX                                     = 357,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 128,
    SBK_QT_WINDOWMODALITY_IDX                                = 394,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 381,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 134,
    SBK_QT_EVENTPRIORITY_IDX                                 = 335,
    SBK_QT_SIZEHINT_IDX                                      = 373,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 393,
    SBK_QT_COORDINATESYSTEM_IDX                              = 325,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 388,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 136,
    SBK_QT_GESTURESTATE_IDX                                  = 341,
    SBK_QT_GESTURETYPE_IDX                                   = 342,
    SBK_QT_GESTUREFLAG_IDX                                   = 340,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 122,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 362,
    SBK_QT_NAVIGATIONMODE_IDX                                = 363,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 404,
    SBK_QT_TIMERTYPE_IDX                                     = 384,
    SBK_QT_SCROLLPHASE_IDX                                   = 371,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 361,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 360,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 130,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 321,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 344,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 368,
    SBK_QtCoreQT_IDX                                         = 309,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 398,
    SBK_QCBORKNOWNTAGS_IDX                                   = 29,
    SBK_QCBORSIMPLETYPE_IDX                                  = 32,
    SBK_QTMSGTYPE_IDX                                        = 399,
    SBK_QtCore_IDX_COUNT                                     = 405
};
...
enum : int {
    ...
    SBK_QTCORE_QLIST_INT_IDX                                 = 15, // const QList<int > &
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 16, // QMap<int,QVariant >
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 17, // const QList<QPersistentModelIndex > &
    SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                      = 18, // QHash<int,QByteArray >
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 19, // const QList<QVariant > &
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 20, // const QHash<QString,QVariant > &
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 21, // const QMap<QString,QVariant > &
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 22, // QList<QCborValue >
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 23, // const QList<QCommandLineOption > &
    SBK_QTCORE_QLIST_QABSTRACTITEMMODELPTR_IDX               = 24, // QList<QAbstractItemModel* >
    SBK_QTCORE_QPAIR_QINT64_UNSIGNEDINT_IDX                  = 25, // QPair<qint64,unsigned int >
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 26, // QList<QFileInfo >
    SBK_QTCORE_QLIST_QPOINTF_IDX                             = 27, // QList<QPointF >
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 28, // QList<QItemSelectionRange > &&
    SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                     = 29, // QList<QLocale::Country >
    SBK_QTCORE_QLIST_QLOCALE_IDX                             = 30, // QList<QLocale >
    SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                        = 31, // QList<Qt::DayOfWeek >
    SBK_QTCORE_QLIST_QURL_IDX                                = 32, // const QList<QUrl > &
    SBK_QTCORE_QLIST_QMIMETYPE_IDX                           = 33, // QList<QMimeType >
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 34, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_QTIMEZONE_OFFSETDATA_IDX                = 35, // QList<QTimeZone::OffsetData >
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 36, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 37, // QList<QPair< QString,QString > >
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 38, // QList<QXmlStreamAttribute >
    SBK_QTCORE_QLIST_QXMLSTREAMNAMESPACEDECLARATION_IDX      = 39, // const QList<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QLIST_QXMLSTREAMENTITYDECLARATION_IDX         = 40, // QList<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QLIST_QXMLSTREAMNOTATIONDECLARATION_IDX       = 41, // QList<QXmlStreamNotationDeclaration >
