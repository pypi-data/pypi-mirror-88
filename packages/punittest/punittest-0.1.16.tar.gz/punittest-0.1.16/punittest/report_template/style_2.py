                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r" style="height:350px">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-danger">用例出错:</label>
                                    <div class="col-sm-5">
                    ...
                    <div class="input-group panel-heading"
                        ...
                        <div style="width: 30%; float: right">
                            <label class="form-control">
                                ...
                                <span class="text-danger">出错: </span><span class="text-danger"
                                                                           id="filterError">3</span><span>|</span>
            ...
            $.each(resultData["testResult"], function (i, n) {
                if ((className === "" || n["className"] === className) && (caseResult === "" || n["status"] === caseResult)) {
                    ...
                    if (n["status"] === '成功') {
                        ...
                        filterError += 1;
                        status = "<td><span class='text-danger'>出错</span></td>";
                    } else if (n["status"] === '跳过') {
                        filterSkip += 1;
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            {value: resultData["testError"], name: '出错'},
