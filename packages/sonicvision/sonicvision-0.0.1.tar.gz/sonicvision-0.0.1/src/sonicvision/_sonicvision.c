...
static struct PyModuleDef moduledef = {
    ...
    "sonicvision._sonicvision", /* m_name */
    NULL,             /* m_doc */
    -1,               /* m_size */
...
#else
    module = Py_InitModule3("sonicvision._sonicvision", module_functions, NULL);
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_sonicvision(void) {
    moduleinit();
}
#else
PyMODINIT_FUNC PyInit__sonicvision(void) {
    return moduleinit();
}
#endif
