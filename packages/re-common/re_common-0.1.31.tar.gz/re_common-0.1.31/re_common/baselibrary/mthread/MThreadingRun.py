...
class MThreadingRun2(ABC):
    ...
    def deal_results(self, *args, **kwargs):
        ...
        :return:
        """
        self.dealresults(self.thread_pool.result_queue, *args, **kwargs)

    @abstractmethod
    def dealresults(self, result_queue, *args, **kwargs):
        """
        每次调用result_queue.get() 后需要调用result_queue.task_done()进行确认
