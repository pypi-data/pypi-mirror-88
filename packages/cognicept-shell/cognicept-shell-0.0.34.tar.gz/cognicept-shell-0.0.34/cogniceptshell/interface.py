...
def main():
    ...
    parser_restart.add_argument('list', help='List of agents to restart', metavar='list', type=str , nargs='*')
    parser_restart.add_argument('--datadog', help='Restart only datadog agent', action='store_true')
    parser_restart.add_argument('--agents', help='Restart only cognicept agents', action='store_true')
    ...
    parser_start.add_argument('list', help='List of agents to start', metavar='list', type=str , nargs='*')
    parser_start.add_argument('--datadog', help='Restart only datadog agent', action='store_true')
    parser_start.add_argument('--agents', help='Restart only cognicept agents', action='store_true')
    ...
    parser_stop.add_argument('list', help='List of agents to stop', metavar='list', type=str , nargs='*')
    parser_stop.add_argument('--datadog', help='Stop only datadog agent', action='store_true')
    parser_stop.add_argument('--agents', help='Stop only cognicept agents', action='store_true')
