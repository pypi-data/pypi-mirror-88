...
class SquaredNorm(QuadraticExpression):
    ...
    def __init__(self, x):
        ...
        if x.is0:
            ...
            A = abs(cvxopt_hcat(list(vec._coefs.values()) + [vec._const]))
    ...
    def _quadratic_form(self):
        ...
        assert isinstance(result, (AffineExpression, QuadraticExpression))
    ...
    def _get_refined(self):
        if self._x.constant:
            value = self._x.safe_value_as_matrix
    ...
    def _get_subtype(self):
        return self.Subtype(len(self._x), self._quadratic_form.subtype)
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, AffineExpression):
            ...
            result = SquaredNorm(self._x*other)
