...
"""
    ...
    This file is copied from flask_session and modified by brifuture for werkzeug has upgraded to v1.0,
    memcache is not avialable from werkzueg but from cachelib
"""
