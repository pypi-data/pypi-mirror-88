...
void MainWindow::InitializeComponent()
{
   ...
   statusBarA = gcnew Windows::Forms::StatusBar;
   statusBarA->TabIndex = 2;
   statusBarA->Text =  "For Help,  press F1";
   ...
   imageListA = gcnew Windows::Forms::ImageList;
   imageListA->ImageSize = System::Drawing::Size( 16, 16 );
   imageListA->TransparentColor = System::Drawing::Color::Transparent;
   
   //imageListA->ImageStream = (System::Windows::Forms::ImageListStreamer*)resources->GetObject("imageListA.ImageStream");
   imageListA->Images->Add( Image::FromFile( "Images\\new.bmp" ) );
   imageListA->Images->Add( Image::FromFile( "Images\\open.bmp" ) );
   imageListA->Images->Add( Image::FromFile( "Images\\save.bmp" ) );
   imageListA->Images->Add( Image::FromFile( "Images\\preview.bmp" ) );
   imageListA->Images->Add( Image::FromFile( "Images\\print.bmp" ) );
   imageListA->Images->Add( Image::FromFile( "Images\\help.bmp" ) );
   toolBar1 = gcnew Windows::Forms::ToolBar;
   toolBar1->ImageList = imageListA;
...
void MainWindow::MenuItemHandler( Object^ sender, EventArgs^ )
{
   ...
   {
      statusBarA->Visible =  !statusBarA->Visible;
      statusbarMenuItem->Checked = statusBarA->Visible;
   }
}
...
void MainWindow::Open()
{
   ...
   System::Windows::Forms::DialogResult res = openDialog->ShowDialog();
   if ( res == System::Windows::Forms::DialogResult::OK )
   {
      if (  !(openDialog->FileName)->EndsWith(  ".scb" ) &&  !(openDialog->FileName)->EndsWith(  ".SCB" ) )
...
void MainWindow::Save()
{
   try
   {
      ...
      System::Windows::Forms::DialogResult res = saveDialog->ShowDialog();
      if ( res == System::Windows::Forms::DialogResult::OK )
      {
         if ( selectedView )
         {
            ScribbleDoc^ doc = selectedView->GetDocument();
            doc->SaveDocument( saveDialog->FileName );
         }
      }
   }
   catch ( Exception^ ex ) 
...
void MainWindow::PenWidthsDlg()
{
   ...
   buttonA->Location = System::Drawing::Point( 264, 20 );
   buttonA->Size = System::Drawing::Size( 75, 23 );
   buttonA->TabIndex = 1;
   buttonA->Text =  "OK";
   buttonA->DialogResult = System::Windows::Forms::DialogResult::OK; //Make this "OK" button
   Button^ buttonB = gcnew Button;
   buttonB->Location = System::Drawing::Point( 264, 52 );
   buttonB->Size = System::Drawing::Size( 75, 23 );
   buttonB->TabIndex = 6;
   buttonB->Text =  "Cancel";
   TextBox^ textBoxA = gcnew TextBox;
   ...
   TextBox^ textBoxB = gcnew TextBox;
   ...
   labelB->Location = System::Drawing::Point( 16, 76 );
   labelB->Text =  "Thick Pen Width:";
   labelB->Size = System::Drawing::Size( 88, 16 );
   labelB->TabIndex = 4;
   ...
   // Set the accept button of the form to buttonA.
   f->AcceptButton = buttonA;
   
   // Set the cancel button of the form to buttonB.
   f->CancelButton = buttonB;
   f->StartPosition = FormStartPosition::CenterScreen;
   f->Controls->Add( buttonA );
   f->Controls->Add( buttonB );
   f->Controls->Add( label1 );
   f->Controls->Add( labelB );
