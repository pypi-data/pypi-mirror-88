...
class SearchPage(QWidget):
    ...
    def addBoilerplate(self):
        ...
        if len(self.boilerfilenames):
            self.outputDisplay.append("Boilerplate Files:")
            for names in range(0,len(self.boilerfilenames)):
                self.outputDisplay.append(self.boilerfilenames[names])
    ...
    def addStudent(self):
        ...
        if len(self.studentfilenames) > 0:
            self.outputDisplay.append("Student Files:")
            for names in range(0,len(self.studentfilenames)):
                self.outputDisplay.append(self.studentfilenames[names])
    ...
    def genReport(self):
        ...
        if self.genFileName:
            ...
            self.genFile.write("HINT: The larger the k-gram value is, the more likely it is the fingerprint found was a\n "
