...
toolchain supports `gcc-8`, `gcc-9`, `gcc-10`, `clang-8`, `clang-10`,
`clang-11`.
...
There is a minimal set of environment variables that are supported as
of now, and the list may expand in future. Arbitrary environment
...
```
tuxbuild build --git-repo https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git --git-ref master --target-arch arm --toolchain clang-10 --kconfig
