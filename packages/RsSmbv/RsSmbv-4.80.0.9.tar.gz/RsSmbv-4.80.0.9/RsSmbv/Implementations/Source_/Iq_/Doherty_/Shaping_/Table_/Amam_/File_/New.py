...
class New:
	...
	def set(self, ipartd_pi_db_dpd_am_table_data_new_file: List[float], stream=repcap.Stream.Default) -> None:
		"""[SOURce<HW>]:IQ:DOHerty<ST>:SHAPing:TABLe:AMAM:FILE:NEW \n
		...
		self._core.io.write(f'SOURce<HwInstance>:IQ:DOHerty{stream_cmd_val}:SHAPing:TABLe:AMAM:FILE:NEW {param}')
