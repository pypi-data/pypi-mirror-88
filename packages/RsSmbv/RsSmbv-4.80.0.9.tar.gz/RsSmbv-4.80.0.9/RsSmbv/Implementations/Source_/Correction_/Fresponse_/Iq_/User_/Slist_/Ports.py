...
class Ports:
	"""Ports commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Ports':
		...
		new_group = Ports(self._core, self._base.parent)
	...
	def fromPy(self):
		...
		if not hasattr(self, '_fromPy'):
			from .Ports_.FromPy import FromPy
