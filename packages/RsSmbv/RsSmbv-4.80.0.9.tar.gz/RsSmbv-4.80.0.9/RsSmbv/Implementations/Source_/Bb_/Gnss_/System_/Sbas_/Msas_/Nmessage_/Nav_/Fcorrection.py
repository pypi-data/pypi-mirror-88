...
class Fcorrection:
	"""Fcorrection commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def period(self):
		...
		if not hasattr(self, '_period'):
			from .Fcorrection_.Period import Period
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Fcorrection_.State import State
