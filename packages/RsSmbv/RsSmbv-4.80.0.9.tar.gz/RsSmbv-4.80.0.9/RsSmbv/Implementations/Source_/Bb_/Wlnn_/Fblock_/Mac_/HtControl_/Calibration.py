...
class Calibration:
	"""Calibration commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def position(self):
		...
		if not hasattr(self, '_position'):
			from .Calibration_.Position import Position
	...
	def sequence(self):
		...
		if not hasattr(self, '_sequence'):
			from .Calibration_.Sequence import Sequence
