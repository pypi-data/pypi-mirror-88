...
class Tmodel:
	"""Tmodel commands group definition. 4 total commands, 2 Sub-groups, 0 group commands"""
	...
	def bstation(self):
		...
		if not hasattr(self, '_bstation'):
			from .Tmodel_.Bstation import Bstation
	...
	def mstation(self):
		...
		if not hasattr(self, '_mstation'):
			from .Tmodel_.Mstation import Mstation
