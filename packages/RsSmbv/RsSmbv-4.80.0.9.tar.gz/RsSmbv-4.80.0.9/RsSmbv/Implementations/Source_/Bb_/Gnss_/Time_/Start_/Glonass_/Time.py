...
class Time:
	...
	def get(self, stream=repcap.Stream.Default) -> GetStruct:
		"""[SOURce<HW>]:BB:GNSS:TIME:STARt:GLONass<ST>:TIME \n
		...
		return self._core.io.query_struct(f'SOURce<HwInstance>:BB:GNSS:TIME:STARt:GLONass{stream_cmd_val}:TIME?', self.__class__.GetStruct())
