...
class Csi1:
	"""Csi1 commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Csi1':
		...
		new_group = Csi1(self._core, self._base.parent)
	...
	def pattern(self):
		...
		if not hasattr(self, '_pattern'):
			from .Csi1_.Pattern import Pattern
