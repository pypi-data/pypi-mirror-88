...
class Active:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""[SOURce<HW>]:BB:GNSS:SV:SELection:GLONass<ST>:ACTive \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:GNSS:SV:SELection:GLONass{stream_cmd_val}:ACTive?')
