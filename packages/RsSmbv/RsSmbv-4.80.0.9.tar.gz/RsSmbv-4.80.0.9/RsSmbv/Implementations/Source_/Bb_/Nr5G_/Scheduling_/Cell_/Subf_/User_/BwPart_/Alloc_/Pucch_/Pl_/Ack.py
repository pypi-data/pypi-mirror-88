...
class Ack:
	"""Ack commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Ack':
		...
		new_group = Ack(self._core, self._base.parent)
	...
	def pattern(self):
		...
		if not hasattr(self, '_pattern'):
			from .Ack_.Pattern import Pattern
