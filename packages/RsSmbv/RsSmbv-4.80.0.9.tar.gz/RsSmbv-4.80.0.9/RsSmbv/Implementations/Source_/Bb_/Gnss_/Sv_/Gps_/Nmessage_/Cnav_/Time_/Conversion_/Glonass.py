...
class Glonass:
	"""Glonass commands group definition. 9 total commands, 5 Sub-groups, 0 group commands
	...
	@property
	def atwo(self):
		"""atwo commands group. 1 Sub-classes, 1 commands."""
	...
	def wnot(self):
		...
		if not hasattr(self, '_wnot'):
			from .Glonass_.Wnot import Wnot
