...
class Beidou:
	"""Beidou commands group definition. 4 total commands, 4 Sub-groups, 0 group commands
	...
	def active(self):
		...
		if not hasattr(self, '_active'):
			from .Beidou_.Active import Active
	...
	def available(self):
		...
		if not hasattr(self, '_available'):
			from .Beidou_.Available import Available
