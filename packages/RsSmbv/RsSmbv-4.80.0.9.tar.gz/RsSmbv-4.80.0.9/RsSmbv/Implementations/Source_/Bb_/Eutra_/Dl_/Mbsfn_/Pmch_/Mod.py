...
class Mod:
	...
	def get(self, channel=repcap.Channel.Default) -> enums.ModulationD:
		"""[SOURce<HW>]:BB:EUTRa:DL:MBSFn:PMCH<CH>:MOD \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:EUTRa:DL:MBSFn:PMCH{channel_cmd_val}:MOD?')
