...
class Qzss:
	"""Qzss commands group definition. 4 total commands, 4 Sub-groups, 0 group commands
	...
	def active(self):
		...
		if not hasattr(self, '_active'):
			from .Qzss_.Active import Active
	...
	def available(self):
		...
		if not hasattr(self, '_available'):
			from .Qzss_.Available import Available
