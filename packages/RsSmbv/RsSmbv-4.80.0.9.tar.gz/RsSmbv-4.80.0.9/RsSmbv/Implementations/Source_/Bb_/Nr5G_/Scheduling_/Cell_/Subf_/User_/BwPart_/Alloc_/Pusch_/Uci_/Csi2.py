...
class Csi2:
	"""Csi2 commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Csi2':
		...
		new_group = Csi2(self._core, self._base.parent)
	...
	def pattern(self):
		...
		if not hasattr(self, '_pattern'):
			from .Csi2_.Pattern import Pattern
