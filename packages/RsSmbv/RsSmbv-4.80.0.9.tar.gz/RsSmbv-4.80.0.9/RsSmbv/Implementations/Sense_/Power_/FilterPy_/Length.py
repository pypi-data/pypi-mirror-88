...
class Length:
	"""Length commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Length':
		...
		new_group = Length(self._core, self._base.parent)
