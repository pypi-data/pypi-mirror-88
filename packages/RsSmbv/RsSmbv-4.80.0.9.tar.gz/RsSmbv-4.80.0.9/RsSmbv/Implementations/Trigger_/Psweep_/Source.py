...
class Source:
	...
	def get_advanced(self) -> enums.TrigSweepImmBusExt:
		...
		"""
		response = self._core.io.query_str('TRIGger<HwInstance>:PSWeep:SOURce:ADVanced?')
	...
	def set_advanced(self, ps_trig_source_adv: enums.TrigSweepImmBusExt) -> None:
		...
		self._core.io.write(f'TRIGger<HwInstance>:PSWeep:SOURce:ADVanced {param}')
	...
	def get_value(self) -> enums.SingExtAuto:
		...
		"""
		response = self._core.io.query_str('TRIGger<HwInstance>:PSWeep:SOURce?')
	...
	def set_value(self, source: enums.SingExtAuto) -> None:
		...
		self._core.io.write(f'TRIGger<HwInstance>:PSWeep:SOURce {param}')
