...
class Store:
	...
	def get_fast(self) -> bool:
		"""[SOURce<HW>]:BB:WLAN:SETTing:STORe:FAST \n
		No command help available \n
			:return: fast: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:WLAN:SETTing:STORe:FAST?')
	...
	def set_fast(self, fast: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:WLAN:SETTing:STORe:FAST {param}')

	def set_value(self, filename: str) -> None:
		"""[SOURce<HW>]:BB:WLAN:SETTing:STORe \n
		No command help available \n
			:param filename: No help available
		"""
		param = Conversions.value_to_quoted_str(filename)
		self._core.io.write(f'SOURce<HwInstance>:BB:WLAN:SETTing:STORe {param}')
