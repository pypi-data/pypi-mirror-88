...
class Available:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""[SOURce<HW>]:BB:GNSS:SV:SELection:BEIDou<ST>:AVAilable \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:GNSS:SV:SELection:BEIDou{stream_cmd_val}:AVAilable?')
