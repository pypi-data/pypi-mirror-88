...
class ToWeek:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""[SOURce<HW>]:BB:GNSS:TIME:STARt:SBAS<ST>:GAGAN:TOWeek \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:GNSS:TIME:STARt:SBAS{stream_cmd_val}:GAGAN:TOWeek?')
