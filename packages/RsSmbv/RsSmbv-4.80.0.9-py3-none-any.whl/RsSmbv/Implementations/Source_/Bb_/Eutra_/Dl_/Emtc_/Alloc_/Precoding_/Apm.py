...
class Apm:
	...
	def get(self, channel=repcap.Channel.Default) -> enums.EutraBfapMapMode:
		"""[SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH>:PRECoding:APM \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:EUTRa:DL:EMTC:ALLoc{channel_cmd_val}:PRECoding:APM?')
