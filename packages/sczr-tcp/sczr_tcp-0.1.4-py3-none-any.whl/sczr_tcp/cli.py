...
def render_frame(screen, frame, screen_width: int, screen_height: int, use_original_size: bool):
    screen.fill((0, 0, 0))
    cur_x = 0
    for face in frame.faces:
        ...
        if use_original_size:
            ...
            act_width = int(width * screen_height / height)
...
def run(host: str = typer.Option(default='0.0.0.0'), port: int = typer.Option(default=9000),
        ...
        use_original_size: bool = typer.Option(default=False),
    ...
    while check_quit():
        ...
        while check_quit():
            ...
            try:
                ...
                break
            render_frame(screen, frame, width, height, use_original_size)
