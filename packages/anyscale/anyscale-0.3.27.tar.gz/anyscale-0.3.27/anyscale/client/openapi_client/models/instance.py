...
class Instance(object):
    ...
    def __init__(self, instance_id=None, instance_config=None, status=None, status_updated_at=None, updated_at=None, external_ip='', internal_ip='', attributes=None, conditions=None, local_vars_configuration=None):  # noqa: E501
    ...
    def instance_config(self):
        """Gets the instance_config of this Instance.  # noqa: E501


        :return: The instance_config of this Instance.  # noqa: E501
        :rtype: object
        """
    ...
    def instance_config(self, instance_config):
        """Sets the instance_config of this Instance.


        :param instance_config: The instance_config of this Instance.  # noqa: E501
        :type: object
        """
        if self.local_vars_configuration.client_side_validation and instance_config is None:  # noqa: E501
            raise ValueError("Invalid value for `instance_config`, must not be `None`")  # noqa: E501
