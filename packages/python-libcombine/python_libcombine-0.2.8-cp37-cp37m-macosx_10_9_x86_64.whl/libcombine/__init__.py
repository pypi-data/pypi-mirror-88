...
class OmexDescription(object):
    ...
    def getModified(self, *args):
        r"""
        getModified(OmexDescription self) -> std::vector< Date,std::allocator< Date > > const
        getModified(OmexDescription self) -> std::vector< Date,std::allocator< Date > >
    ...
    def setModified(self, modified):
        r"""setModified(OmexDescription self, std::vector< Date,std::allocator< Date > > const & modified)"""
