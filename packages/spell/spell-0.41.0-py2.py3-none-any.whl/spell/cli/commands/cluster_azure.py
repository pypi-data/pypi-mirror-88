...
def create_azure(ctx, name, resource_group_name, service_principal_name):
    ...
    while not click.confirm(
        ...
        "grant VM Image Read permissions to your App.\nPlease contact your Spell representative and "
        "have them grant these permissions now.\nWhen finished, continue with 'y'."
    ):
        pass
