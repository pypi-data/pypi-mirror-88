...
class AidlabSDK:
    ...
    plank_callback_type = CFUNCTYPE(None, c_void_p)
    ...
    def setup_user_callback(self):
        ...
        self.plank_start_c_callback = self.plank_callback_type(self.did_start_plank_callback)
        self.plank_end_c_callback = self.plank_callback_type(self.did_end_plank_callback)
        ...
        self.lib.initUserServiceCallback(self.ecg_c_callback, self.respiration_c_callback, self.temperature_c_callback,
                                         ...
                                         self.exercise_c_callback, self.receive_command_c_callback, self.plank_start_c_callback, 
                                         self.plank_end_c_callback, self.aidlab_sdk_ptr)
    ...
    def setup_process_types(self):
        ...
        self.lib.initUserServiceCallback.argtypes = [self.samples_time_callback_type, self.samples_time_callback_type, self.sample_time_callback_type,
                                                     ...
                                                     self.exercise_callback_type, self.received_command_callback_type, c_void_p]
    ...
    def did_start_plank_callback(self, context):
        self.delegate.did_start_plank()

    def did_end_plank_callback(self, context):
        self.delegate.did_end_plank()
