class UserMethods(object):
    ...
    def user(self, user_id, text_format=None):
        ...
        return self.requester.make_request(path, params=params, public_api=True)

    def user_accomplishments(
        self, user_id, per_page=None, next_cursor=None,
    ):
        ...
        return self.requester.make_request(
            path=endpoint, params=params, public_api=True
        )
