...
class TestCLIPublish(TestCLI):
    ...
    def test_publish_yml_yaml(self, mock_post: Mock, _mock_decoded_jwt):
    ...
    @patch('catalog.jwt.decode', return_value=TestCLI.MOCK_DECODED_JWT)
    @patch('catalog.requests.post')
    def test_publish_ipynb_with_headings(self, mock_post: Mock, _mock_decoded_jwt):
    ...
    @patch('catalog.jwt.decode', return_value=TestCLI.MOCK_DECODED_JWT)
    @patch('catalog.requests.post')
    def test_publish_ipynb_with_no_headings(self, mock_post: Mock, _mock_decoded_jwt):
