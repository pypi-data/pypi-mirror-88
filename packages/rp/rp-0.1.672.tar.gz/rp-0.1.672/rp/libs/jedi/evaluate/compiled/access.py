...
from rp.libs.jedi._compatibility import unicode, is_py3, builtins, \
    ...
    def getattr_paths(self, name, default=_sentinel):
        try:
            ...
            with warnings.catch_warnings():
                #Don't let deprecations in various libraries spam your console
                #For example, Pandas DataFrames are notorious...
                import sys
                old_write=sys.stdout.write
                try:
                    sys.stdout.write=len
                    return_obj = getattr(self._obj, name) #Don't let Pandas print annoying things like "FutureWarning: _AXIS_NUMBERS has been deprecated." when we're just trying to do autocompletion...
                finally:
