...
class RDBService:
    ...
    def insert(self,table,data):
        try:
            ...
            traceback.print_exc()
            logging.warnning('while excute insert new data({}) in {}'.format(table,data))
            self.close()
    ...
    def update(self, table, query, update):
        try:
            ...
            traceback.print_exc()
            logging.warnning('while excute updating({}) sql with query({}) in {}'.format(update,table,query))
            self.close()
    ...
    def delete(self,table,query):
        try:
            ...
            traceback.print_exc()
            logging.warnning('while excute deleting sql with query({}) in {}'.format(table,query))
            self.close()
    ...
    def count(self,table,query):
        try:
            ...
            traceback.print_exc()
            logging.warnning('while excute counting sql with query({}) in {}'.format(table,query))
            self.close()
...
class MssqlService(RDBService):
    ...
    def find_one(self, table, query,sort=None,fields=None):
        try:
            ...
            sql = 'select top 1 {} from {} {} {}'.format(s,table, query,sort)
            cusor = self.conn.cursor()
            if not cusor:
            ...
            self.close()
            logging.warnning('while excute find_one sql with query({}) in {}'.format(table,query))
            raise e
    ...
    def find(self, table, query, sort, fields):
        try:
            ...
            self.close()
            logging.warnning('while excute find sql with query({}) in {}'.format(table,query))
            raise e
...
class MysqlService(RDBService):
    ...
    def find_one(self, table, query,sort=None,fields=None):
        try:
            ...
            sql = 'select {} from {} {} {} limit 1'.format(s,table, query,sort)
            cusor = self.conn.cursor()
            res = cusor.execute(sql)
            res = cusor.fetchall()
            cusor.close()
