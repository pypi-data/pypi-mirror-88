...
def convolution_sequence_shape(*args):
    return _cntk_py.convolution_sequence_shape(*args)
convolution_sequence_shape = _cntk_py.convolution_sequence_shape

def spatial_convolution(*args):
    return _cntk_py.spatial_convolution(*args)
spatial_convolution = _cntk_py.spatial_convolution

def spatial_convolution_sequence_shape(*args):
    return _cntk_py.spatial_convolution_sequence_shape(*args)
spatial_convolution_sequence_shape = _cntk_py.spatial_convolution_sequence_shape

def mat_mul(*args):
    return _cntk_py.mat_mul(*args)
mat_mul = _cntk_py.mat_mul

def gemm(*args):
    return _cntk_py.gemm(*args)
gemm = _cntk_py.gemm

def unsqueeze(*args):
    return _cntk_py.unsqueeze(*args)
unsqueeze = _cntk_py.unsqueeze
...
DataType_Int8 = _cntk_py.DataType_Int8
DataType_Int16 = _cntk_py.DataType_Int16
...
def atan(*args):
    return _cntk_py.atan(*args)
atan = _cntk_py.atan

def tan(*args):
    return _cntk_py.tan(*args)
tan = _cntk_py.tan
...
def constant_like(*args):
    return _cntk_py.constant_like(*args)
constant_like = _cntk_py.constant_like
...
def eye_like(*args):
    return _cntk_py.eye_like(*args)
eye_like = _cntk_py.eye_like
...
def straight_through(*args):
    return _cntk_py.straight_through(*args)
straight_through = _cntk_py.straight_through
...
def custom_proxy_op(*args):
    return _cntk_py.custom_proxy_op(*args)
custom_proxy_op = _cntk_py.custom_proxy_op
...
class Learner(_object):
    ...
    def set_need_to_update_master_parameter(self):
        return _cntk_py.Learner_set_need_to_update_master_parameter(self)
...
class MinibatchSourceConfig(_object):
    ...
    __swig_setmethods__["max_errors"] = _cntk_py.MinibatchSourceConfig_max_errors_set
    __swig_getmethods__["max_errors"] = _cntk_py.MinibatchSourceConfig_max_errors_get
    if _newclass:
        max_errors = _swig_property(_cntk_py.MinibatchSourceConfig_max_errors_get, _cntk_py.MinibatchSourceConfig_max_errors_set)
...
def htk_mlf_binary_deserializer(streamName, mlfFiles, dimension):
    return _cntk_py.htk_mlf_binary_deserializer(streamName, mlfFiles, dimension)
htk_mlf_binary_deserializer = _cntk_py.htk_mlf_binary_deserializer
...
def make_shared(object, increaseRefCount=True):
    return _cntk_py.make_shared(object, increaseRefCount)
