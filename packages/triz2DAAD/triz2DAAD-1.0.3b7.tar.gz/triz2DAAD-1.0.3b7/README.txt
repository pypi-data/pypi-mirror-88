...
Triz2DAAD versión 1.0.3b7 201209 (c) 2019-20 Pedro Fernández
...
- La opción -dr creará una plantilla compatible con DAAD Ready 0.2.
...
**NUEVO**: la opción -dr creará una plantilla compatible con DAAD Ready 0.2. En este modo la barra de estado y la opción -md quedan desactivadas.
...
Triz2DAAD version 1.0.3b7 201209 (c) 2019-20 Pedro Fernández
...
- Option -dr will create a DAAD Ready compatible template.
...
**NEW**: -dr option will create a DAAD Ready 0.2 compatible template. In this mode status line and -md options are disabled.
