...
entry_points = \
{'console_scripts': ['mixcloud_upload = media_tools.mixcloud_upload:main']}

setup_kwargs = {
    'name': 'media-tools',
    'version': '0.0.1',
    'description': 'Media Tools - creating and managing playlists, and managing the filenames and directory structure for large numbers of music files.',
