...
# @Last Modified time: 2020-12-10 16:09:05
...
if __name__ == '__main__':
	td = ThirdInfo()
	# print(td.get_container_ip("AppHelloBikeTradeService",env="pre"))
	print(td.get_container_ip("AppHellobikeRideApiService",env="uat",tag="group1"))
