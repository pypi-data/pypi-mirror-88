...
[boto3.CognitoIdentityProvider 1.16.38](https://boto3.amazonaws.com/v1/documentation/api/1.16.38/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
