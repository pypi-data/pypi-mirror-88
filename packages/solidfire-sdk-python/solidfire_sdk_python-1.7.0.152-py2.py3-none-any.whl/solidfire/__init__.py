...
class Element(ServiceBase):
    ...
    def delete_snap_mirror_relationships(
        ...
        :param destinationVolumes: [required] The destination volume or volumes in the SnapMirror relationship. 
    ...
    def test_ping(
            ...
            source_address_v4=OPTIONAL,
            source_address_v6=OPTIONAL,
            interface=OPTIONAL,
        ...
        :param sourceAddressV4:  The ipv4 source address to be used in the ICMP ping packets sourceAddressV4 or sourceAddressV6 is required 
        :type sourceAddressV4: str

        :param sourceAddressV6:  The ipv6 source address to be used in the ICMP ping packets sourceAddressV4 or sourceAddressV6 is required 
        :type sourceAddressV6: str

        :param interface:  Existing interface on which the temporary vlan interface is created 
        :type interface: str

        :param virtualNetworkTag:  VLAN on which host addresses reachability needs to be tested The temporary vlan interface is created with this tag 
        ...
        if source_address_v4 is not None:
            params["sourceAddressV4"] = source_address_v4
        if source_address_v6 is not None:
            params["sourceAddressV6"] = source_address_v6
    ...
    def create_volume(
        ...
        :param protectionScheme:  Protection scheme that should be used for this volume. The default value is the defaultProtectionScheme stored in the ClusterInfo object. 
        :type protectionScheme: ProtectionScheme
        """
        ...
        if access is not None:
            if self.api_version < 10.0:
                raise ApiParameterVersionError("create_volume", 10.0,
                    [("access", access, 10.0, False)])
            else:
                params["access"] = access
        if enable_snap_mirror_replication is not None:
            if self.api_version < 10.0:
                raise ApiParameterVersionError("create_volume", 10.0,
                    [("enable_snap_mirror_replication", enable_snap_mirror_replication, 10.0, False)])
            else:
                params["enableSnapMirrorReplication"] = enable_snap_mirror_replication
        if qos_policy_id is not None:
            if self.api_version < 10.0:
    ...
    def clone_volume(
        ...
        :param newSize:  New size of the volume, in bytes. Must be greater or less than the size of the volume being cloned. If unspecified, the volume size is not changed. Size is rounded to the nearest 1MB. 
        :type newSize: int
        ...
        :param enableSnapMirrorReplication:  Specifies whether SnapMirror replication is enabled or not. Defaults to false. 
        :type enableSnapMirrorReplication: bool
        """
        ...
        if attributes is not None:
            if self.api_version < 6.0:
                raise ApiParameterVersionError("clone_volume", 6.0,
                    [("attributes", attributes, 6.0, False)])
            else:
                params["attributes"] = attributes
        if enable512e is not None:
            params["enable512e"] = enable512e
        if enable_snap_mirror_replication is not None:
            if self.api_version < 10.0:
                raise ApiParameterVersionError("clone_volume", 10.0,
                    [("enable_snap_mirror_replication", enable_snap_mirror_replication, 10.0, False)])
            else:
                params["enableSnapMirrorReplication"] = enable_snap_mirror_replication
    ...
    def list_volume_qos_histograms(
            self,
            volume_ids=OPTIONAL,):
        """
        ...
        :param volumeIDs:  List of volumes to return data for. If no volumes are specified then information for all volumes will be returned. 
        :type volumeIDs: int
        """

        self._check_connection_type("list_volume_qos_histograms", "Cluster")
    ...
    def list_volumes(
        ...
        :param protectionSchemes:  Only volumes that are using one of the protection schemes in this set are returned. 
        :type protectionSchemes: ProtectionScheme
        """
    ...
    def create_key_server_kmip(
        ...
        :param kmipCaCertificate: [required] The public key certificate of the external key server's root CA. This will be used to verify the certificate presented by external key server in the TLS communication. For key server clusters where individual servers use different CAs, provide a concatenated string containing the root certificates of all the CAs. 
        :type kmipCaCertificate: str

        :param kmipClientCertificate: [required] A PEM format Base64 encoded PKCS#10 X.509 certificate used by the Solidfire KMIP client. 
        :type kmipClientCertificate: str

        :param kmipKeyServerHostnames: [required] Array of the hostnames or IP addresses associated with this KMIP Key Server. Multiple hostnames or IP addresses must only be provided if the key servers are in a clustered configuration. 
        :type kmipKeyServerHostnames: str

        :param kmipKeyServerName: [required] The name of the KMIP Key Server.  This name is only used for display purposes and does not need to be unique. 
        :type kmipKeyServerName: str

        :param kmipKeyServerPort:  The port number associated with this KMIP Key Server (typically 5696). 
        :type kmipKeyServerPort: int
        """

        self._check_connection_type("create_key_server_kmip", "Cluster")

        params = { 
            "kmipCaCertificate": kmip_ca_certificate,
            "kmipClientCertificate": kmip_client_certificate,
            "kmipKeyServerHostnames": kmip_key_server_hostnames,
            "kmipKeyServerName": kmip_key_server_name,
        }
        if kmip_key_server_port is not None:
            params["kmipKeyServerPort"] = kmip_key_server_port
    ...
    def get_key_provider_kmip(
        ...
        self._check_connection_type("get_key_provider_kmip", "Cluster")
    ...
    def create_public_private_key_pair(
        ...
        :param commonName:  This is the X.509 distinguished name Common Name field (CN). 
        :type commonName: str

        :param organization:  This is the X.509 distinguished name Organization Name field (O). 
        :type organization: str

        :param organizationalUnit:  This is the X.509 distinguished name Organizational Unit Name field (OU). 
        ...
        :param emailAddress:  This is the X.509 distinguished name Email Address field (MAIL). 
        :type emailAddress: str
        """

        self._check_connection_type("create_public_private_key_pair", "Cluster")
        ...
        if organizational_unit is not None:
            params["organizationalUnit"] = organizational_unit
    ...
    def list_key_providers_kmip(
            self,
            key_provider_is_active=OPTIONAL,
            kmip_key_provider_has_server_assigned=OPTIONAL,):
        """
    ...
    def get_client_certificate_sign_request(
            self,):
        """
        ...
        self._check_connection_type("get_client_certificate_sign_request", "Cluster")
    ...
    def list_key_servers_kmip(
            self,
            key_provider_id=OPTIONAL,
            kmip_assigned_provider_is_active=OPTIONAL,
            kmip_has_provider_assigned=OPTIONAL,):
        """
        ...
        :param keyProviderID:  If omitted, returned KMIP Key Server objects will not be filtered based on whether they're assigned to the specified KMIP Key Provider. If specified, returned KMIP Key Server objects will be filtered to those assigned to the specified KMIP Key Provider. 
        :type keyProviderID: int

        :param kmipAssignedProviderIsActive:  If omitted, returned KMIP Key Server objects will not be filtered based on whether they're active. If true, returns only KMIP Key Server objects which are active (providing keys which are currently in use). If false, returns only KMIP Key Server objects which are inactive (not providing any keys and able to be deleted). 
        :type kmipAssignedProviderIsActive: bool

        :param kmipHasProviderAssigned:  If omitted, returned KMIP Key Server objects will not be filtered based on whether they have a KMIP Key Provider assigned. If true, returns only KMIP Key Server objects which have a KMIP Key Provider assigned. If false, returns only KMIP Key Server objects which do not have a KMIP Key Provider assigned. 
        :type kmipHasProviderAssigned: bool
        """

        self._check_connection_type("list_key_servers_kmip", "Cluster")

        params = { 
        }
        if key_provider_id is not None:
            params["keyProviderID"] = key_provider_id
        if kmip_assigned_provider_is_active is not None:
            params["kmipAssignedProviderIsActive"] = kmip_assigned_provider_is_active
        if kmip_has_provider_assigned is not None:
            params["kmipHasProviderAssigned"] = kmip_has_provider_assigned
    ...
    def test_key_server_kmip(
            self,
            key_server_id,):
        """
        Test whether the specified KMIP (Key Management Interoperability Protocol) Key Server is functioning normally.
        :param keyServerID: [required] The ID of the KMIP Key Server to test. 
        :type keyServerID: int
        """

        self._check_connection_type("test_key_server_kmip", "Cluster")

        params = { 
            "keyServerID": key_server_id,
        }
    ...
    def create_key_provider_kmip(
        ...
        :param keyProviderName: [required] The name to associate with the created KMIP Key Provider.  This name is only used for display purposes and does not need to be unique. 
        :type keyProviderName: str
        """

        self._check_connection_type("create_key_provider_kmip", "Cluster")

        params = { 
            "keyProviderName": key_provider_name,
        }
    ...
    def remove_key_server_from_provider_kmip(
            self,
            key_server_id,):
        """
        ...
        :param keyServerID: [required] The ID of the KMIP Key Server to unassign. 
        :type keyServerID: int
        """

        self._check_connection_type("remove_key_server_from_provider_kmip", "Cluster")
    ...
    def get_key_server_kmip(
        ...
        self._check_connection_type("get_key_server_kmip", "Cluster")
    ...
    def test_key_provider_kmip(
            self,
            key_provider_id,):
        """
        Test whether the specified Key Provider is functioning normally.
        :param keyProviderID: [required] The ID of the Key Provider to test. 
        :type keyProviderID: int
        """

        self._check_connection_type("test_key_provider_kmip", "Cluster")
    ...
    def delete_key_provider_kmip(
            self,
            key_provider_id,):
        """
        Delete the specified inactive Key Provider.
        :param keyProviderID: [required] The ID of the Key Provider to delete. 
        :type keyProviderID: int
        """

        self._check_connection_type("delete_key_provider_kmip", "Cluster")
    ...
    def get_fips_report(
        ...
        self._check_connection_type("get_fips_report", "Cluster")
    ...
    def add_key_server_to_provider_kmip(
            self,
            key_provider_id,
            key_server_id,):
        """
        ...
        :param keyProviderID: [required] The ID of the Key Provider to assign the KMIP Key Server to. 
        :type keyProviderID: int

        :param keyServerID: [required] The ID of the KMIP Key Server to assign. 
        :type keyServerID: int
        """

        self._check_connection_type("add_key_server_to_provider_kmip", "Cluster")
    ...
    def delete_key_server_kmip(
        ...
        :param keyServerID: [required] The ID of the KMIP Key Server to delete. 
        :type keyServerID: int
        """

        self._check_connection_type("delete_key_server_kmip", "Cluster")
    ...
    def modify_key_server_kmip(
            self,
            key_server_id,
            kmip_ca_certificate=OPTIONAL,
            kmip_client_certificate=OPTIONAL,
            kmip_key_server_hostnames=OPTIONAL,
            kmip_key_server_name=OPTIONAL,
            kmip_key_server_port=OPTIONAL,):
        """
        ...
        :param kmipCaCertificate:  The public key certificate of the external key server's root CA. This will be used to verify the certificate presented by external key server in the TLS communication. For key server clusters where individual servers use different CAs, provide a concatenated string containing the root certificates of all the CAs. 
        :type kmipCaCertificate: str

        :param kmipClientCertificate:  A PEM format Base64 encoded PKCS#10 X.509 certificate used by the Solidfire KMIP client. 
        :type kmipClientCertificate: str

        :param kmipKeyServerHostnames:  Array of the hostnames or IP addresses associated with this KMIP Key Server. Multiple hostnames or IP addresses must only be provided if the key servers are in a clustered configuration. 
        :type kmipKeyServerHostnames: str

        :param keyServerID: [required] The ID of the KMIP Key Server to modify. 
        :type keyServerID: int

        :param kmipKeyServerName:  The name of the KMIP Key Server.  This name is only used for display purposes and does not need to be unique. 
        :type kmipKeyServerName: str
        ...
        self._check_connection_type("modify_key_server_kmip", "Cluster")

        params = { 
            "keyServerID": key_server_id,
        }
        if kmip_ca_certificate is not None:
            params["kmipCaCertificate"] = kmip_ca_certificate
        if kmip_client_certificate is not None:
            params["kmipClientCertificate"] = kmip_client_certificate
        if kmip_key_server_hostnames is not None:
            params["kmipKeyServerHostnames"] = kmip_key_server_hostnames
        if kmip_key_server_name is not None:
            params["kmipKeyServerName"] = kmip_key_server_name
        if kmip_key_server_port is not None:
            params["kmipKeyServerPort"] = kmip_key_server_port
    ...
    def modify_volume_access_group(
        ...
        :param deleteOrphanInitiators:  true: Default. Delete initiator objects after they are removed from a volume access group. false: Do not delete initiator objects after they are removed from a volume access group. 
    ...
    def delete_idp_configuration(
            self,
            idp_configuration_id=OPTIONAL,
            idp_name=OPTIONAL,):
        """
        ...
        :param idpConfigurationID:  UUID for the third party Identity Provider (IdP) Configuration. 
        :type idpConfigurationID: UUID

        :param idpName:  Name for identifying and retrieving IdP provider for SAML 2.0 single sign-on. 
        :type idpName: str
        """

        self._check_connection_type("delete_idp_configuration", "Cluster")

        params = { 
        }
        if idp_configuration_id is not None:
            params["idpConfigurationID"] = idp_configuration_id
        if idp_name is not None:
            params["idpName"] = idp_name
    ...
    def update_idp_configuration(
            ...
            idp_configuration_id=OPTIONAL,
            idp_name=OPTIONAL,
            new_idp_name=OPTIONAL,
            idp_metadata=OPTIONAL,
            generate_new_certificate=OPTIONAL,):
        """
        ...
        :param newIdpName:  If specified replaces the IdP name. 
        :type newIdpName: str

        :param idpMetadata:  IdP Metadata for configuration and integration details for SAML 2.0 single sign-on. 
        :type idpMetadata: str

        :param generateNewCertificate:  If true, generate new SAML key/certificate and replace the existing pair.  NOTE: Replacing the existing certificate will disrupt the established trust between the Cluster and the Idp until Cluster's Service Provider metadata is reloaded at the Idp If not provided or false, the SAML certificate and key will remain unchanged. 
        :type generateNewCertificate: bool
        """

        self._check_connection_type("update_idp_configuration", "Cluster")
        ...
        if idp_name is not None:
            params["idpName"] = idp_name
        if new_idp_name is not None:
            params["newIdpName"] = new_idp_name
        if idp_metadata is not None:
            params["idpMetadata"] = idp_metadata
        if generate_new_certificate is not None:
            params["generateNewCertificate"] = generate_new_certificate
    ...
    def get_idp_authentication_state(
            self,):
        """
        Return information regarding the state of authentication using third party Identity Providers        """

        self._check_connection_type("get_idp_authentication_state", "Cluster")
    ...
    def list_idp_configurations(
        ...
        :param idpName:  Filters the result to an IdP configuration information for a specific IdP name. 
        :type idpName: str

        :param enabledOnly:  Filters the result to return the currently enabled Idp configuration. 
        :type enabledOnly: bool
        """

        self._check_connection_type("list_idp_configurations", "Cluster")
    ...
    def disable_idp_authentication(
            self,):
        """
        ...
        self._check_connection_type("disable_idp_authentication", "Cluster")
    ...
    def add_idp_cluster_admin(
        ...
        :param acceptEula: [required] Accept the End User License Agreement. Set to true to add a cluster administrator account to the system. If omitted or set to false, the method call fails. 
        ...
        self._check_connection_type("add_idp_cluster_admin", "Cluster")
    ...
    def create_idp_configuration(
        ...
        :param idpName: [required] Name used to identify an IdP provider for SAML 2.0 single sign-on. 
        :type idpName: str

        :param idpMetadata: [required] IdP Metadata to store. 
        :type idpMetadata: str
        """

        self._check_connection_type("create_idp_configuration", "Cluster")
    ...
    def enable_idp_authentication(
        ...
        :param idpConfigurationID:  UUID for the third party Identity Provider (IdP) Configuration.   If only one IdP Configuration exists, then we will default to enabling that configuration. 
        :type idpConfigurationID: UUID
        """

        self._check_connection_type("enable_idp_authentication", "Cluster")
    ...
    def get_ipmi_info(
        ...
        self._check_connection_type("get_ipmi_info", "Node")
    ...
    def disable_bmc_cold_reset(
        ...
        self._check_connection_type("disable_bmc_cold_reset", "Cluster")
    ...
    def enable_bmc_cold_reset(
        ...
        self._check_connection_type("enable_bmc_cold_reset", "Cluster")
    ...
    def set_snmp_trap_info(
        ...
        :param trapRecipients:  List of hosts that are to receive the traps generated by the Cluster Master. At least one object is required if any one of the trap types is enabled. 
        ...
        if trap_recipients is not None:
            params["trapRecipients"] = trap_recipients
    ...
    def list_active_auth_sessions(
        ...
        self._check_connection_type("list_active_auth_sessions", "Cluster")
    ...
    def modify_cluster_admin(
        ...
        :param clusterAdminID: [required] ClusterAdminID for the cluster admin, LDAP cluster admin, or IdP cluster admin to modify. 
    ...
    def list_auth_sessions_by_cluster_admin(
            self,
            cluster_admin_id,):
        """
        ...
        :param clusterAdminID: [required] ID that identifies a clusterAdmin. 
        :type clusterAdminID: int
        """

        self._check_connection_type("list_auth_sessions_by_cluster_admin", "Cluster")
    ...
    def delete_auth_session(
        ...
        :param sessionID: [required] UUID for the auth session to be deleted. 
        :type sessionID: UUID
        """

        self._check_connection_type("delete_auth_session", "Cluster")
    ...
    def delete_auth_sessions_by_cluster_admin(
            self,
            cluster_admin_id,):
        """
        ...
        self._check_connection_type("delete_auth_sessions_by_cluster_admin", "Cluster")
    ...
    def list_auth_sessions_by_username(
            self,
            username=OPTIONAL,
        ...
        :param authMethod:  Authentication method of the user sessions to be listed. Only a caller in the ClusterAdmins / Administrator AccessGroup can provide this parameter. 
        :type authMethod: AuthMethod
        """

        self._check_connection_type("list_auth_sessions_by_username", "Cluster")
    ...
    def delete_auth_sessions_by_username(
            self,
            username=OPTIONAL,
            auth_method=OPTIONAL,):
        """
        ...
        :param authMethod:  Authentication method of the user sessions to be deleted. Only a caller in the ClusterAdmins / Administrator AccessGroup can provide this parameter. 
        :type authMethod: AuthMethod
        """

        self._check_connection_type("delete_auth_sessions_by_username", "Cluster")
    ...
    def get_node_active_tls_ciphers(
            self,):
        """
        ...
        self._check_connection_type("get_node_active_tls_ciphers", "Node")
    ...
    def set_node_supplemental_tls_ciphers(
            self,
        ...
        :param supplementalCiphers: [required] The supplemental cipher suite names using the OpenSSL naming scheme. Use of cipher suite names is case-insensitive. 
        :type supplementalCiphers: str
        """

        self._check_connection_type("set_node_supplemental_tls_ciphers", "Node")

        params = { 
            "supplementalCiphers": supplemental_ciphers,
        }
    ...
    def check_proposed_cluster(
        ...
        self._check_connection_type("check_proposed_cluster", "Node")
    ...
    def add_nodes(
        ...
        :param autoInstall:  If true, RTFI will be performed on the nodes.  The default behavior is to perform RTFI. 
    ...
    def remove_nodes(
            self,
            nodes,
            ignore_ensemble_tolerance_change=OPTIONAL,):
        """
        ...
        :param ignoreEnsembleToleranceChange:  Ignore changes to the ensemble's node failure tolerance when removing nodes. 
        :type ignoreEnsembleToleranceChange: bool
        """
        ...
        if ignore_ensemble_tolerance_change is not None:
            params["ignoreEnsembleToleranceChange"] = ignore_ensemble_tolerance_change
    ...
    def control_power(
            ...
            action,
            force,
            wakeup_delay=OPTIONAL,):
        """
        ControlPower can be used to reboot or halt a node.
        :param action: [required] The action to take (Must be either Halt or Restart). 
        :type action: str

        :param wakeupDelay:  The delay in seconds to wait before powering on.  This is only usable when action=Halt. 
        :type wakeupDelay: str

        :param force: [required] Required for the command to succeed. 
        :type force: bool
        """

        self._check_connection_type("control_power", "Node")

        params = { 
            "action": action,
            "force": force,
        }
        if wakeup_delay is not None:
            params["wakeupDelay"] = wakeup_delay
    ...
    def remove_initiators_from_volume_access_group(
        ...
        if delete_orphan_initiators is not None:
            if self.api_version < 9.0:
                raise ApiParameterVersionError("remove_initiators_from_volume_access_group", 9.0,
                    [("delete_orphan_initiators", delete_orphan_initiators, 9.0, False)])
            else:
                params["deleteOrphanInitiators"] = delete_orphan_initiators
    ...
    def add_account(
        ...
        :param initiatorSecret:  The CHAP secret to use for the initiator. If unspecified, a random secret is created. 
        :type initiatorSecret: CHAPSecret

        :param targetSecret:  The CHAP secret to use for the target (mutual CHAP authentication). If unspecified, a random secret is created. 
        :type targetSecret: CHAPSecret

        :param attributes:  List of name-value pairs in JSON object format. 
        :type attributes: dict

        :param enableChap:  Specify if chap account credentials can be used by an initiator to access volumes. 
        :type enableChap: bool
        """
        ...
        if attributes is not None:
            params["attributes"] = attributes
        if enable_chap is not None:
            if self.api_version < 12.2:
                raise ApiParameterVersionError("add_account", 12.2,
                    [("enable_chap", enable_chap, 12.2, False)])
            else:
                params["enableChap"] = enable_chap
    ...
    def modify_account(
        ...
        :param initiatorSecret:  The CHAP secret to use for the initiator. 
        :type initiatorSecret: CHAPSecret

        :param targetSecret:  The CHAP secret to use for the target (mutual CHAP authentication). 
        :type targetSecret: CHAPSecret
        ...
        if enable_chap is not None:
            if self.api_version < 12.2:
                raise ApiParameterVersionError("modify_account", 12.2,
                    [("enable_chap", enable_chap, 12.2, False)])
            else:
                params["enableChap"] = enable_chap
    ...
    def set_lldp_config(
        ...
        :param lldpConfig: [required] LLDP configuration to be set 
        :type lldpConfig: LldpConfig
        """

        self._check_connection_type("set_lldp_config", "Node")

        params = { 
            "lldpConfig": lldp_config,
        }
    ...
    def get_lldp_config(
        ...
        self._check_connection_type("get_lldp_config", "Node")
    ...
    def set_cluster_structure(
        ...
        self._check_connection_type("set_cluster_structure", "Cluster")
        ...
        if qos_policies is not None:
            params["qosPolicies"] = qos_policies
        ...
        if tls_ciphers is not None:
            params["tlsCiphers"] = tls_ciphers
        if virtual_networks is not None:
            params["virtualNetworks"] = virtual_networks
        if volume_access_group_lun_assignments is not None:
            params["volumeAccessGroupLunAssignments"] = volume_access_group_lun_assignments
        if volume_access_groups is not None:
            params["volumeAccessGroups"] = volume_access_groups
        if volumes is not None:
            params["volumes"] = volumes
        if storage_containers is not None:
            params["storageContainers"] = storage_containers
    ...
    def set_supplemental_tls_ciphers(
            self,
            supplemental_ciphers,):
        """
        ...
        self._check_connection_type("set_supplemental_tls_ciphers", "Cluster")
    ...
    def create_cluster(
            ...
            attributes=OPTIONAL,
            enable_software_encryption_at_rest=OPTIONAL,):
        """
        ...
        :param serialNumber:  Nine-digit alphanumeric Serial Number. May be required on software-based platforms. 
        :type serialNumber: str

        :param orderNumber:  Alphanumeric sales order number. May be required on software-based platforms. 
        ...
        :param enableSoftwareEncryptionAtRest:  Enable this flag to use software-based encryption-at-rest. Defaults to true on SolidFire software-only clusters. Defaults to false on all other clusters. 
        :type enableSoftwareEncryptionAtRest: bool
        """
        ...
        if serial_number is not None:
            if self.api_version < 12.2:
                raise ApiParameterVersionError("create_cluster", 12.2,
                    [("serial_number", serial_number, 12.2, False)])
            else:
                params["serialNumber"] = serial_number
        if order_number is not None:
            if self.api_version < 12.2:
                raise ApiParameterVersionError("create_cluster", 12.2,
                    [("order_number", order_number, 12.2, False)])
            else:
                params["orderNumber"] = order_number
        if attributes is not None:
            params["attributes"] = attributes
        if enable_software_encryption_at_rest is not None:
            if self.api_version < 12.2:
                raise ApiParameterVersionError("create_cluster", 12.2,
                    [("enable_software_encryption_at_rest", enable_software_encryption_at_rest, 12.2, False)])
            else:
                params["enableSoftwareEncryptionAtRest"] = enable_software_encryption_at_rest
    ...
    def list_events(
            ...
            node_id=OPTIONAL,
            drive_id=OPTIONAL,
            start_report_time=OPTIONAL,
            end_report_time=OPTIONAL,
            start_publish_time=OPTIONAL,
            end_publish_time=OPTIONAL,):
        """
        ListEvents returns events detected on the cluster, sorted from oldest to newest.
        :param maxEvents:  Specifies the maximum number of events to return. 
        :type maxEvents: int

        :param startEventID:  Specifies the beginning of a range of events to return. 
        :type startEventID: int

        :param endEventID:  Specifies the end of a range of events to return. 
        :type endEventID: int

        :param eventType:  Specifies the type of events to return. 
        :type eventType: str

        :param serviceID:  Specifies that only events with this ServiceID will be returned. 
        :type serviceID: int

        :param nodeID:  Specifies that only events with this NodeID will be returned. 
        :type nodeID: int

        :param driveID:  Specifies that only events with this DriveID will be returned. 
        :type driveID: int

        :param startReportTime:  Specifies that only events reported after this time will be returned. 
        :type startReportTime: str

        :param endReportTime:  Specifies that only events reported earlier than this time will be returned. 
        :type endReportTime: str

        :param startPublishTime:  Specifies that only events published after this time will be returned. 
        :type startPublishTime: str

        :param endPublishTime:  Specifies that only events published earlier than this time will be returned. 
        :type endPublishTime: str
        """
        ...
        if start_report_time is not None:
            params["startReportTime"] = start_report_time
        if end_report_time is not None:
            params["endReportTime"] = end_report_time
        if start_publish_time is not None:
            params["startPublishTime"] = start_publish_time
        if end_publish_time is not None:
            params["endPublishTime"] = end_publish_time
    ...
    def get_bin_assignment_properties(
            self,):
        """
        GetBinAssignmentProperties enables you to retrieve the bin assignment properties in the database.        """

        self._check_connection_type("get_bin_assignment_properties", "Cluster")
    ...
    def test_address_availability(
        ...
        :param virtualNetworkTag:  The target VLAN ID. 
        :type virtualNetworkTag: int
        ...
        self._check_connection_type("test_address_availability", "Node")
    ...
    def check_proposed_node_additions(
            self,
            nodes,):
        """
        ...
        self._check_connection_type("check_proposed_node_additions", "Cluster")
    ...
    def enable_encryption_at_rest(
        ...
        :param keyProviderID:  The ID of a Key Provider to use.  This is a unique value returned as part of one of the CreateKeyProvider* methods. 
        :type keyProviderID: int
        """
        ...
        if key_provider_id is not None:
            if self.api_version < 11.7:
                raise ApiParameterVersionError("enable_encryption_at_rest", 11.7,
                    [("key_provider_id", key_provider_id, 11.7, False)])
            else:
                params["keyProviderID"] = key_provider_id
    ...
    def enable_maintenance_mode(
            self,
            nodes,
            per_minute_primary_swap_limit=OPTIONAL,
            timeout=OPTIONAL,
            force_with_unresolved_faults=OPTIONAL,):
        """
        ...
        :param perMinutePrimarySwapLimit:  Number of primaries to swap per minute. If not specified, all will be swapped at once. 
        :type perMinutePrimarySwapLimit: int
        ...
        :param forceWithUnresolvedFaults:  Force maintenance mode to be enabled even with blocking cluster faults present. 
        :type forceWithUnresolvedFaults: bool
        """

        self._check_connection_type("enable_maintenance_mode", "Cluster")

        params = { 
            "nodes": nodes,
        }
        if per_minute_primary_swap_limit is not None:
            params["perMinutePrimarySwapLimit"] = per_minute_primary_swap_limit
        if timeout is not None:
            params["timeout"] = timeout
        if force_with_unresolved_faults is not None:
            params["forceWithUnresolvedFaults"] = force_with_unresolved_faults
    ...
    def modify_cluster_full_threshold(
            ...
            stage3_metadata_threshold_percent=OPTIONAL,
        ...
        :param stage3MetadataThresholdPercent:  The percentage of metadata storage utilization below the "Error" threshold that causes the system to trigger a cluster "Warning" alert. 
        :type stage3MetadataThresholdPercent: int
        ...
        if stage3_metadata_threshold_percent is not None:
            params["stage3MetadataThresholdPercent"] = stage3_metadata_threshold_percent
    ...
    def get_protection_domain_layout(
            self,):
        """
        GetProtectionDomainLayout returns all of the Protection Domain information for the cluster.        """

        self._check_connection_type("get_protection_domain_layout", "Cluster")
    ...
    def disable_maintenance_mode(
        ...
        self._check_connection_type("disable_maintenance_mode", "Cluster")
    ...
    def get_cluster_structure(
        ...
        self._check_connection_type("get_cluster_structure", "Cluster")
    ...
    def get_license_key(
        ...
        self._check_connection_type("get_license_key", "Cluster")
    ...
    def get_supported_tls_ciphers(
            self,):
        """
        You can use the GetSupportedTlsCiphers method to get a list of the supported TLS ciphers.        """

        self._check_connection_type("get_supported_tls_ciphers", "Cluster")
    ...
    def set_license_key(
        ...
        :param serialNumber: [required] The new Serial Number for this cluster. 
        :type serialNumber: str

        :param orderNumber: [required] The new sales order number for this cluster. 
        :type orderNumber: str
        """

        self._check_connection_type("set_license_key", "Cluster")
    ...
    def set_protection_domain_layout(
            self,
        ...
        :param protectionDomainLayout: [required] The Protection Domains for each Node. 
        :type protectionDomainLayout: NodeProtectionDomains
        """

        self._check_connection_type("set_protection_domain_layout", "Cluster")

        params = { 
            "protectionDomainLayout": protection_domain_layout,
        }
