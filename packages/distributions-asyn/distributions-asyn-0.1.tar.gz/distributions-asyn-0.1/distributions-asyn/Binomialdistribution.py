...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  8 18:24:06 2020
...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, num=20):
    ...
    def replace_stats_with_data(self):
        ...
        try:
            ...
            print("Please provide data to update metrics")
    ...
    def plot_bar(self):
        """Method to output a bar chart of the instance variable data using 
    ...
    def plot_bar_pdf(self):
        ...
        plt.bar(x,y)
        plt.title('Probability density function of outcomes')
        plt.xlabel('Outcome')
