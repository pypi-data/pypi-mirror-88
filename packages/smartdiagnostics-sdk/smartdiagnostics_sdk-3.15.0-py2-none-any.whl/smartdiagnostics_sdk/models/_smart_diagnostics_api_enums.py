...
class HostOptions(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    HTTPS_SD_KCFTECH_COM_ = "https://sd.kcftech.com/"  #: host: https://sd.kcftech.com/.
    HTTP_SD_KCFTECH_COM_ = "http://sd.kcftech.com/"  #: host: http://sd.kcftech.com/.
...
class UserCorporationWithLocationsChildCorporationUserRole(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
