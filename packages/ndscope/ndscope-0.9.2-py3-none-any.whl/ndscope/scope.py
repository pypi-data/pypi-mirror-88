...
class NDScope(QMainWindow, Ui_MainWindow):
    ...
    def _update_plots(self, recv):
        ...
        if trend != self.preferred_trend():
            logger.debug(f"DROP {trend} trend packet")
            return
    ...
    def export(self, path=None):
        ...
        self.exportPath.setText(path)
        QtCore.QTimer.singleShot(1, self._export)
