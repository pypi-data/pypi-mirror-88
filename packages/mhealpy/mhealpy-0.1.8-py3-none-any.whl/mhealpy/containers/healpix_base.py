...
class HealpixBase:
    ...
    def __init__(self,
        ...
        if base is not None:
            ...
            self._order = hp.nside2order(mhp.uniq2nside(max(uniq)))
    ...
    def pix_order_list(self):
        ...
        for pix in range(self.npix):
            ...
            nside, nest_pix = mhp.uniq2nest(self.pix2uniq(pix))
    ...
    def pix2range(self, nside, pix):
        ...
        if self.is_moc:
            ...
            return mhp.uniq2range(nside, self._uniq[pix])
            ...
            return mhp.nest2range(self.nside, pix, nside)
    ...
    def pixarea(self, pix = 0):
        ...
        if self.is_moc:
            nside = mhp.uniq2nside(self._uniq[pix])
        else:
            nside = self.nside
    ...
    def pix2ang(self, pix):
        ...
        if self.is_moc:
            ...
            nside, pix = mhp.uniq2nest(self.pix2uniq(pix))
    ...
    def pix2uniq(self, pix):
        ...
        if self.is_moc:
            ...
            return mhp.nest2uniq(self.nside, pix)
    ...
    def boundaries(self, pix, step = 1):
        ...
        if self.is_moc:
            ...
            def single_pix_bounds(pix):
                ...
                nside, nest_pix = mhp.uniq2nest(self._uniq[pix])
