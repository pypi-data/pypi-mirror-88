...
setup(
  ...
  url = 'https://github.com/DiamondLightSource/python-swmrtools/releases/tag/v0.3',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/DiamondLightSource/python-swmrtools/archive/v0.3.tar.gz', 
