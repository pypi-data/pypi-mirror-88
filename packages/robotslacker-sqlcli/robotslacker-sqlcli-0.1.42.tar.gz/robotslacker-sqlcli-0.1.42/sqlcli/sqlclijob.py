...
class TransactionStaistics:
    def __init__(self):
        ...
        self.avg_transaction_time = 0                  # transaction 平均耗时
        self.min_transaction_time = 0                  # transaction 最小耗时
        self.transaction_standard_eviation = 0         # transaction 耗时偏差（方差）
        self.transaction_count = 0                     # transaction 次数
        self.transaction_name = ""                     # transaction 名称
...
class TransactionHistory:
    def __init__(self):
        self.transaction_name = ""                     # transaction 名称
        self.transaction_start_time = ""               # transaction 开始时间
        self.transaction_end_time = ""                 # transaction 结束时间
        self.transaction_status = ""                   # transaction 结束状态
