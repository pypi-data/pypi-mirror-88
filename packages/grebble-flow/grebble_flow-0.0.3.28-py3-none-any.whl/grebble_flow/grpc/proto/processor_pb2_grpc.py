...
class ExternalProcessorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Execute = channel.unary_stream(
                '/grebble_flow.grpc.proto.ExternalProcessorService/Execute',
...
class ExternalProcessorServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ExternalProcessorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'grebble_flow.grpc.proto.ExternalProcessorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class ExternalProcessorService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Execute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/grebble_flow.grpc.proto.ExternalProcessorService/Execute',
