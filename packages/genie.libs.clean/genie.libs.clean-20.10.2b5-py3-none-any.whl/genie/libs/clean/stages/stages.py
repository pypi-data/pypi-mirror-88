                    ...
                    if not overwrite and file_data['exist']:
                        step.skipped(
                            ...
                            "the device {} {}, skipped copying".format(
                                device.name, dest))
                    testbed = device.testbed
                    if (protocol in testbed.servers and 'default'
                            in testbed.servers[protocol].credentials
                            and 'username'
                            in testbed.servers[protocol].credentials.default
                            and 'password'
                            in testbed.servers[protocol].credentials.default):
                        username = testbed.servers[
                            protocol].credentials.default.username
                        password = testbed.servers[
                            protocol].credentials.default.password
                    else:
                        username = None
                        password = None
...
@aetest.test
def apply_configuration(section,
                        steps,
                        device,
                        configuration=None,
