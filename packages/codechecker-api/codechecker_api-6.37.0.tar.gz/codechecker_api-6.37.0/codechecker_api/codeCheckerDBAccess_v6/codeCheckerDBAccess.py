...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i233 in range(_size229):
                        ...
                        self.reportHashes.append(_elem234)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i239 in range(_size235):
                        ...
                        self.skipDetectionStatuses.append(_elem240)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter242 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter243 in self.skipDetectionStatuses:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i311 in range(_size307):
                        ...
                        for _i318 in range(_size314):
                            _elem319 = AnalysisFailureInfo()
                            _elem319.read(iprot)
                            _val313.append(_elem319)
                        iprot.readListEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter320, viter321 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRUCT, len(viter321))
                for iter322 in viter321:
                    iter322.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i327 in range(_size323):
                        _elem328 = LinesInFilesRequested()
                        _elem328.read(iprot)
                        self.linesInFilesRequested.append(_elem328)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter329 in self.linesInFilesRequested:
                iter329.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter344, viter345 in self.success.items():
                ...
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter345))
                for kiter346, viter347 in viter345.items():
                    oprot.writeI64(kiter346)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter383, viter384 in self.success.items():
                oprot.writeI32(kiter383)
                oprot.writeI64(viter384)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i444 in range(_size440):
                        _key445 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getRunHistoryTagCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter469 in self.runIds:
                oprot.writeI64(iter469)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i497 in range(_size493):
                        ...
                        self.sourceComponentFilter.append(_elem498)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter499 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i511 in range(_size507):
                        ...
                        self.fileHashes.append(_elem512)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter513 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i525 in range(_size521):
                        ...
                        self.trimPathPrefixes.append(_elem526)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter527 in self.trimPathPrefixes:
...
class getAnalysisStatistics_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i541 in range(_size537):
                        ...
                        _val543 = AnalyzerStatistics()
                        _val543.read(iprot)
                        self.success[_key542] = _val543
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter544, viter545 in self.success.items():
