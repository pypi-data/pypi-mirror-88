...
class Bucket(core.Construct):
    ...
    Args:
        ...
        bucket_is_privately_accessed_from_vpc (str): Force the bucket to be private and enable private accessed from within the VPC.
    ...
    def __init__(
        ...
        bucket_is_privately_accessed_from_vpc=False,
        **kwargs
    ):
        ...
        if bucket_is_privately_accessed_from_vpc:
