...
@pass_context
def cli(ctx):
    """listdeleted setdefaultqos modify liststatsbyaccount removefromaccessgroup updatebulkstatus getefficiency modifyqospolicy getdefaultqos startbulkread clonemultiple listactive liststatsbyaccessgroup startbulkwrite delete restoredeleted listbulkjobs getstats cancelclone deleteqospolicy create createqospolicy listqospolicies purgedeleted getcount copy clone addtoaccessgroup getqospolicy liststats listqoshistograms list listforaccount cancelgroupclone liststatsby """
