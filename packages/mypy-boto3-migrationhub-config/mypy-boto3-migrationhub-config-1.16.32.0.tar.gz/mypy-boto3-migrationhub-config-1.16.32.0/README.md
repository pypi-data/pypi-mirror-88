...
[boto3.MigrationHubConfig 1.16.32](https://boto3.amazonaws.com/v1/documentation/api/1.16.32/reference/services/migrationhub-config.html#MigrationHubConfig) service
compatible with
