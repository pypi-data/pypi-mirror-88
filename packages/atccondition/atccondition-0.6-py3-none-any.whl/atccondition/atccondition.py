...
class ATCCondition():
    def __init__(self,edgercLocation,accountSwitchKey=None):
        ...
        self._prdHttpCaller = EdgeGridHttpCaller(self._session, debug, False, self._baseurl_prd)
    ...
    def createCondition(self,conditionJson):
        ...
        if status == 400:
        	...
        	print("Create Condition Failed..! Reason: " + failedReason)
        return 0
    ...
    def listConditions(self):
        ...
        if self.accountSwitchKey:
            params = {'accountSwitchKey':self.accountSwitchKey}
            conditionListJson = self._prdHttpCaller.getResult(listConditionsEndPoint,params=params)
        else:
    ...
    def deleteCondition(self,conditionId):
        ...
        if self.accountSwitchKey:
            params = {'accountSwitchKey':self.accountSwitchKey}
            deleteConditionJson = self._prdHttpCaller.deleteResult(deleteConditionEndPoint,params=params)
        else:
