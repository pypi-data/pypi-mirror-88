...
from . import seq2seq_constant as constant
...
def get_wordvec_file(w2v_name, wordvec_dir, shorthand, wordvec_type=None):
    ...
    if wordvec_type is not None:
        ...
        raise FileNotFoundError("Cannot locate word vector directory for language: {}  Looked in {} and {}".format(w2v_name, word2vec_dir, fasttext_dir))
