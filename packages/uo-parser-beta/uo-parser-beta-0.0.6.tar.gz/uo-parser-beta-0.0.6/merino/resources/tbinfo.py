...
lang2treebank = {
    ...
    'bokmaal-norwegian': 'UD_Norwegian-Bokmaal',
    'nynorsk-norwegian': 'UD_Norwegian_Nynorsk-Nynorsk',
...
tbname2training_id = {"UD_Afrikaans-AfriBooms": 2, "UD_Ancient_Greek-Perseus": 2, "UD_Ancient_Greek-PROIEL": 2,
                      ...
                      "UD_Russian-SynTagRus": 2, "UD_Russian-Taiga": 2, "UD_Scottish_Gaelic-ARCOSG": 1,
...
tbname2shorthand = {
    'UD_Arabic-PADT': 'ar_padt',
    'UD_French-GSD': 'fr_gsd',
    'UD_Spanish-AnCora': 'es_ancora',
    'UD_Chinese-GSD': 'zh_gsd',
    'UD_English-EWT': 'en_ewt',
    'UD_Afrikaans-AfriBooms': 'af_afribooms',
    'UD_Ancient_Greek-Perseus': 'grc_perseus',
    'UD_Ancient_Greek-PROIEL': 'grc_proiel',
    'UD_Armenian-ArmTDP': 'hy_armtdp',
    'UD_Basque-BDT': 'eu_bdt',
    'UD_Belarusian-HSE': 'be_hse',
    'UD_Bulgarian-BTB': 'bg_btb',
    'UD_Catalan-AnCora': 'ca_ancora',
    'UD_Classical_Chinese-Kyoto': 'lzh_kyoto',
    'UD_Croatian-SET': 'hr_set',
    'UD_Czech-CAC': 'cs_cac',
    'UD_Czech-CLTT': 'cs_cltt',
    'UD_Czech-FicTree': 'cs_fictree',
    'UD_Czech-PDT': 'cs_pdt',
    'UD_Danish-DDT': 'da_ddt',
    'UD_Dutch-Alpino': 'nl_alpino',
    'UD_Dutch-LassySmall': 'nl_lassysmall',
    'UD_English-GUM': 'en_gum',
    'UD_English-LinES': 'en_lines',
    'UD_English-ParTUT': 'en_partut',
    'UD_Estonian-EDT': 'et_edt',
    'UD_Estonian-EWT': 'et_ewt',
    'UD_Estonian-EWT2': 'et_ewt2',
    'UD_Finnish-FTB': 'fi_ftb',
    'UD_Finnish-TDT': 'fi_tdt',
    'UD_French-ParTUT': 'fr_partut',
    'UD_French-Sequoia': 'fr_sequoia',
    'UD_French-Spoken': 'fr_spoken',
    'UD_Galician-CTG': 'gl_ctg',
    'UD_Galician-TreeGal': 'gl_treegal',
    'UD_Galician-TreeGal2': 'gl_treegal2',
    'UD_German-GSD': 'de_gsd',
    'UD_German-HDT': 'de_hdt',
    'UD_Greek-GDT': 'el_gdt',
    'UD_Hebrew-HTB': 'he_htb',
    'UD_Hindi-HDTB': 'hi_hdtb',
    'UD_Hungarian-Szeged': 'hu_szeged',
    'UD_Indonesian-GSD': 'id_gsd',
    'UD_Irish-IDT': 'ga_idt',
    'UD_Italian-ISDT': 'it_isdt',
    'UD_Italian-ParTUT': 'it_partut',
    'UD_Italian-PoSTWITA': 'it_postwita',
    'UD_Italian-TWITTIRO': 'it_twittiro',
    'UD_Italian-VIT': 'it_vit',
    'UD_Japanese-GSD': 'ja_gsd',
    'UD_Kazakh-KTB': 'kk_ktb',
    'UD_Kazakh-KTB2': 'kk_ktb2',
    'UD_Korean-GSD': 'ko_gsd',
    'UD_Korean-Kaist': 'ko_kaist',
    'UD_Kurmanji-MG': 'kmr_mg',
    'UD_Kurmanji-MG2': 'kmr_mg2',
    'UD_Latin-ITTB': 'la_ittb',
    'UD_Latin-Perseus': 'la_perseus',
    'UD_Latin-Perseus2': 'la_perseus2',
    'UD_Latin-PROIEL': 'la_proiel',
    'UD_Latvian-LVTB': 'lv_lvtb',
    'UD_Lithuanian-ALKSNIS': 'lt_alksnis',
    'UD_Lithuanian-HSE': 'lt_hse',
    'UD_Livvi-KKPP': 'olo_kkpp',
    'UD_Maltese-MUDT': 'mt_mudt',
    'UD_Marathi-UFAL': 'mr_ufal',
    'UD_North_Sami-Giella': 'sme_giella',
    'UD_Norwegian_Nynorsk-Nynorsk': 'no_nynorsk',
    'UD_Norwegian_Nynorsk-NynorskLIA': 'no_nynorsklia',
    'UD_Norwegian-Bokmaal': 'no_bokmaal',
    'UD_Old_Church_Slavonic-PROIEL': 'cu_proiel',
    'UD_Old_French-SRCMF': 'fro_srcmf',
    'UD_Old_Russian-TOROT': 'orv_torot',
    'UD_Persian-Seraji': 'fa_seraji',
    'UD_Polish-LFG': 'pl_lfg',
    'UD_Polish-PDB': 'pl_pdb',
    'UD_Portuguese-Bosque': 'pt_bosque',
    'UD_Portuguese-GSD': 'pt_gsd',
    'UD_Romanian-Nonstandard': 'ro_nonstandard',
    'UD_Romanian-RRT': 'ro_rrt',
    'UD_Russian-GSD': 'ru_gsd',
    'UD_Russian-SynTagRus': 'ru_syntagrus',
    'UD_Russian-Taiga': 'ru_taiga',
    'UD_Scottish_Gaelic-ARCOSG': 'gd_arcosg',
    'UD_Serbian-SET': 'sr_set',
    'UD_Simplified_Chinese-GSDSimp': 'zh_gsdsimp',
    'UD_Slovak-SNK': 'sk_snk',
    'UD_Slovenian-SSJ': 'sl_ssj',
    'UD_Slovenian-SST': 'sl_sst',
    'UD_Slovenian-SST2': 'sl_sst2',
    'UD_Spanish-GSD': 'es_gsd',
    'UD_Swedish_Sign_Language-SSLC': 'swl_sslc',
    'UD_Swedish-LinES': 'sv_lines',
    'UD_Swedish-Talbanken': 'sv_talbanken',
    'UD_Tamil-TTB': 'ta_ttb',
    'UD_Telugu-MTG': 'te_mtg',
    'UD_Turkish-IMST': 'tr_imst',
    'UD_Ukrainian-IU': 'uk_iu',
    'UD_Upper_Sorbian-UFAL': 'hsb_ufal',
    'UD_Urdu-UDTB': 'ur_udtb',
    'UD_Uyghur-UDT': 'ug_udt',
    'UD_Vietnamese-VTB': 'vi_vtb',
    'UD_Wolof-WTB': 'wo_wtb'
}
