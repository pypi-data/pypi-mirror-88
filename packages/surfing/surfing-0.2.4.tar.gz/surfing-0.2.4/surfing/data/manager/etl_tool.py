...
class S3RetrieverForDM(S3ETLTool):
    ...
    def _retrieve_dts(self, data_tables: FundDataTables) -> List[str]:
        ...
        for field in dataclasses.fields(data_tables):
            ...
            if field.name in ['index_fund_indicator_pack','stock_ipo_data','conv_bond_ipo_data','stock_ipo_data_detail','conv_bond_ipo_data_detail']:
                continue
            name = field.name
    ...
    def _retrieve_misc(self, dm) -> List[str]:
        ...
        for field in dataclasses.fields(dm.dts):
            ...
            try:
                ...
                elif name in ('stock_ipo_data','conv_bond_ipo_data','stock_ipo_data_detail','conv_bond_ipo_data_detail'):
                    data = {}
                else:
