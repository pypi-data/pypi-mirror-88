...
class EmRawDataDownloader:
    ...
    def em_stock_ipo_info(self, today):
        ...
        data = c.css(code_list,"IPOPRICE,IPOISSUEDATE,IPOSHARESVOL,IPOPE,PURCHACODEONL,SUCRATIOONL,NAME,CEILINGONL,EMIND2016,TRADEMARKET,IPOPURCHDATEONL,IPOANNCDATE,WSZQJGGGDATE,LISTDATE","ClassiFication=1,Ispandas=1")
    ...
    def em_conv_bond_ipo_info(self, today):
        ...
        data=c.css(code_list,"CBCODE,CBNAME,CBSTOCKCODE,CBSTOCKNAME,CBISSUEAMT,IPOANNCDATE,CBIPOTYPE,CBPURCODEONL,ISSRATE,CBTERM,CBISSUEPRICE,ISSUEONLEDATE,CBCONVPRICE,CBDATEONL,CBLISTDATE,CBRESULTDATE,CBSUCRATEONL,QUANTLIMITINTRO","Ispandas=1")
        data = data.reset_index().drop(columns=['DATES'])
        total_data = existed_df[~existed_df.CODES.isin(data.CODES)].append(data)
