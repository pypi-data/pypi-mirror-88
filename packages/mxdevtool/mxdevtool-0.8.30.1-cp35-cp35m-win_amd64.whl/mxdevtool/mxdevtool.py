...
class core_ProcessValue(ProcessValue):
    ...
    def __pos__(self) -> "ProcessValuePtr":
        r"""__pos__(core_ProcessValue self) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue___pos__(self)

    def __neg__(self) -> "ProcessValuePtr":
        r"""__neg__(core_ProcessValue self) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue___neg__(self)

    def __add__(self, *args) -> "ProcessValuePtr":
        r"""
        __add__(core_ProcessValue self, core_ProcessValue pv) -> core_ProcessValue
        __add__(core_ProcessValue self, double v) -> core_ProcessValue
        """
        return _mxdevtool.core_ProcessValue___add__(self, *args)

    def __sub__(self, *args) -> "ProcessValuePtr":
        r"""
        __sub__(core_ProcessValue self, core_ProcessValue pv) -> core_ProcessValue
        __sub__(core_ProcessValue self, double v) -> core_ProcessValue
        """
        return _mxdevtool.core_ProcessValue___sub__(self, *args)

    def __mul__(self, *args) -> "ProcessValuePtr":
        r"""
        __mul__(core_ProcessValue self, core_ProcessValue pv) -> core_ProcessValue
        __mul__(core_ProcessValue self, double v) -> core_ProcessValue
        """
        return _mxdevtool.core_ProcessValue___mul__(self, *args)

    def __truediv__(self, *args) -> "ProcessValuePtr":
        r"""
        __truediv__(core_ProcessValue self, core_ProcessValue pv) -> core_ProcessValue
        __truediv__(core_ProcessValue self, double v) -> core_ProcessValue
        """
        return _mxdevtool.core_ProcessValue___truediv__(self, *args)

    def __radd__(self, v: "double") -> "ProcessValuePtr":
        r"""__radd__(core_ProcessValue self, double v) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue___radd__(self, v)

    def __rsub__(self, v: "double") -> "ProcessValuePtr":
        r"""__rsub__(core_ProcessValue self, double v) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue___rsub__(self, v)

    def __rmul__(self, v: "double") -> "ProcessValuePtr":
        r"""__rmul__(core_ProcessValue self, double v) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue___rmul__(self, v)

    def __rtruediv__(self, v: "double") -> "ProcessValuePtr":
        r"""__rtruediv__(core_ProcessValue self, double v) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue___rtruediv__(self, v)
    ...
    def withName(self, name: "std::string") -> "ProcessValuePtr":
        r"""withName(core_ProcessValue self, std::string name) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_withName(self, name)

    def linearOper(self, name: "std::string", multiple: "double"=1.0, spread: "double"=0.0) -> "ProcessValuePtr":
        r"""linearOper(core_ProcessValue self, std::string name, double multiple=1.0, double spread=0.0) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_linearOper(self, name, multiple, spread)

    def unaryFunction(self, name: "std::string", func_type: "std::string") -> "ProcessValuePtr":
        r"""unaryFunction(core_ProcessValue self, std::string name, std::string func_type) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_unaryFunction(self, name, func_type)

    def returns(self, name: "std::string", returns_type: "std::string") -> "ProcessValuePtr":
        r"""returns(core_ProcessValue self, std::string name, std::string returns_type) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_returns(self, name, returns_type)

    def shift(self, name: "std::string", shift: "int", fill_value: "double"=0.0) -> "ProcessValuePtr":
        r"""shift(core_ProcessValue self, std::string name, int shift, double fill_value=0.0) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_shift(self, name, shift, fill_value)

    def overwrite(self, name: "std::string", start_pos: "int", values: "DoubleVector") -> "ProcessValuePtr":
        r"""overwrite(core_ProcessValue self, std::string name, int start_pos, DoubleVector values) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_overwrite(self, name, start_pos, values)

    def spot(self, name: "std::string", maturity: "Period", compounding: "Compounding"=Compounded) -> "ProcessValuePtr":
        r"""spot(core_ProcessValue self, std::string name, Period maturity, Compounding compounding=Compounded) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_spot(self, name, maturity, compounding)

    def forward(self, name: "std::string", startPeriod: "Period", maturity: "Period", compounding: "Compounding"=Compounded) -> "ProcessValuePtr":
        r"""forward(core_ProcessValue self, std::string name, Period startPeriod, Period maturity, Compounding compounding=Compounded) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_forward(self, name, startPeriod, maturity, compounding)

    def discountFactor(self, name: "std::string") -> "ProcessValuePtr":
        r"""discountFactor(core_ProcessValue self, std::string name) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_discountFactor(self, name)

    def discountBond(self, name: "std::string", maturity: "Period") -> "ProcessValuePtr":
        r"""discountBond(core_ProcessValue self, std::string name, Period maturity) -> core_ProcessValue"""
        return _mxdevtool.core_ProcessValue_discountBond(self, name, maturity)
...
class core_GBMModel(core_ProcessModel):
    ...
    def rfCurve(self) -> "Handle< YieldTermStructure >":
        r"""rfCurve(core_GBMModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_GBMModel_rfCurve(self)

    def divCurve(self) -> "Handle< YieldTermStructure >":
        r"""divCurve(core_GBMModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_GBMModel_divCurve(self)

    def volTs(self) -> "Handle< BlackVolTermStructure >":
        r"""volTs(core_GBMModel self) -> BlackVolTermStructureHandle"""
        return _mxdevtool.core_GBMModel_volTs(self)

    x0 = property(x0,None,None)
    rfCurve = property(rfCurve,None,None)
    divCurve = property(divCurve,None,None)
    volTs = property(volTs,None,None)
...
class core_HestonModel(core_ProcessModel):
    ...
    def rfCurve(self) -> "Handle< YieldTermStructure >":
        r"""rfCurve(core_HestonModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_HestonModel_rfCurve(self)

    def divCurve(self) -> "Handle< YieldTermStructure >":
        r"""divCurve(core_HestonModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_HestonModel_divCurve(self)
...
class core_HullWhite1FModel(core_ProcessModel):
    ...
    def __init__(self, name: "std::string const &", fittingCurve: "YieldTermStructure", alphaCurve: "Parameter", sigmaCurve: "Parameter"):
        r"""__init__(core_HullWhite1FModel self, std::string const & name, YieldTermStructure fittingCurve, Parameter alphaCurve, Parameter sigmaCurve) -> core_HullWhite1FModel"""
        _mxdevtool.core_HullWhite1FModel_swiginit(self, _mxdevtool.new_core_HullWhite1FModel(name, fittingCurve, alphaCurve, sigmaCurve))

    def fittingCurve(self) -> "Handle< YieldTermStructure >":
        r"""fittingCurve(core_HullWhite1FModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_HullWhite1FModel_fittingCurve(self)
...
class core_BK1FModel(core_ProcessModel):
    ...
    def fittingCurve(self) -> "Handle< YieldTermStructure >":
        r"""fittingCurve(core_BK1FModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_BK1FModel_fittingCurve(self)
...
class core_GTwoExtModel(core_ProcessModel):
    ...
    def fittingCurve(self) -> "Handle< YieldTermStructure >":
        r"""fittingCurve(core_GTwoExtModel self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_GTwoExtModel_fittingCurve(self)
    ...
    def correlation(self) -> "double":
        r"""correlation(core_GTwoExtModel self) -> double"""
        return _mxdevtool.core_GTwoExtModel_correlation(self)
    ...
    correlation = property(correlation,None,None)
...
class core_ScenarioGenerator2(IEvolverBase):
    ...
    def __init__(self, models: "ProcessValueVector", calcs: "ProcessValueVector", corr: "Matrix", timeGrid: "core_TimeGrid", rsg: "IRsgWrapper", filename: "std::string const &", processMomentMatch: "bool"):
        r"""__init__(core_ScenarioGenerator2 self, ProcessValueVector models, ProcessValueVector calcs, Matrix corr, core_TimeGrid timeGrid, IRsgWrapper rsg, std::string const & filename, bool processMomentMatch) -> core_ScenarioGenerator2"""
        _mxdevtool.core_ScenarioGenerator2_swiginit(self, _mxdevtool.new_core_ScenarioGenerator2(models, calcs, corr, timeGrid, rsg, filename, processMomentMatch))
...
class core_ScenarioResult(object):
    ...
    def genInfo(self) -> "StrVector":
        r"""genInfo(core_ScenarioResult self) -> StrVector"""
        return _mxdevtool.core_ScenarioResult_genInfo(self)
...
class core_SpotRateCalc(core_ProcessValue):
    ...
    def __init__(self, name: "std::string", pv: "ProcessValue", maturity: "Period", compounding: "Compounding"):
        r"""__init__(core_SpotRateCalc self, std::string name, ProcessValue pv, Period maturity, Compounding compounding) -> core_SpotRateCalc"""
        _mxdevtool.core_SpotRateCalc_swiginit(self, _mxdevtool.new_core_SpotRateCalc(name, pv, maturity, compounding))
...
class core_ForwardRateCalc(core_ProcessValue):
    ...
    def __init__(self, name: "std::string", pv: "ProcessValue", startPeriod: "Period", maturity: "Period", compounding: "Compounding"):
        r"""__init__(core_ForwardRateCalc self, std::string name, ProcessValue pv, Period startPeriod, Period maturity, Compounding compounding) -> core_ForwardRateCalc"""
        _mxdevtool.core_ForwardRateCalc_swiginit(self, _mxdevtool.new_core_ForwardRateCalc(name, pv, startPeriod, maturity, compounding))
...
class core_YieldCurveValueCalc(core_ProcessValue):
    ...
    def __init__(self, name: "std::string", ts: "YieldTermStructure", output_type: "std::string", compound: "Compounding"):
        r"""__init__(core_YieldCurveValueCalc self, std::string name, YieldTermStructure ts, std::string output_type, Compounding compound) -> core_YieldCurveValueCalc"""
        _mxdevtool.core_YieldCurveValueCalc_swiginit(self, _mxdevtool.new_core_YieldCurveValueCalc(name, ts, output_type, compound))
