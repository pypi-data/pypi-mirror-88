...
setup(
  ...
  version = 'v0.6.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JesseBonanno/IndeterminateBeam/archive/v0.6.0.tar.gz',    # I explain this later on
