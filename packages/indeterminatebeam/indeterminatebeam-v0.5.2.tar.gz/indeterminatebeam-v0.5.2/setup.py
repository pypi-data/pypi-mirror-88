...
setup(
  ...
  version = 'v0.5.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JesseBonanno/IndeterminateBeam/archive/v0.5.2.tar.gz',    # I explain this later on
