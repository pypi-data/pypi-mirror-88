...
[boto3.ServerlessApplicationRepository 1.16.32](https://boto3.amazonaws.com/v1/documentation/api/1.16.32/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
