...
from .permissions import is_django_staff, is_authenticated
from .utils import set_cookie, invalidate_cookie, set_session_key, get_session_key, get_random_fingerprint, check_user_can_login
...
class ConfirmEmailView(allauth_account_views.ConfirmEmailView, DjangoSsoAppBaseViewMixin):
    def get(self, request, *args, **kwargs):
...
class PasswordSetView(allauth_account_views.PasswordSetView, DjangoSsoAppBaseViewMixin):
    def get(self, *args, **kwargs):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            adapter.try_update_response_jwt(request.user, response)
