...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    if out_file is None and opt.write_out is True:
...
class Translator(object):
    ...
    def __init__(
        ...
        # Added by Sonvx on Dec 11, 2020: Not use out_file if write_out is False.
    ...
    def from_opt(
        ...
        # Added by Sonvx on Dec 11, 2020: not write out if write_out is True.
        if not opt.write_out:
            out_file = None
