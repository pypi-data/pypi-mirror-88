...
class AccountInvoiceService(Component):
    ...
    def _prepare_create(self, params):
        ...
        invoice_lines = [
            line
            for category in params['categoryInvoiceAgregate']
        ...
        oc_taxes_parsed = params['taxAggregate']
        ...
        oc_taxes = json.dumps(params['taxAggregate'])
        return {
            "partner_id": partner_id,
            "oc_number": params['invoiceNumber'],
            "date_invoice": params['recordedInvoiceDto']['invoiceDate'],
