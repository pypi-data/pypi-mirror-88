...
class OAPDash(dash.Dash):
    ...
    def _serve_main_css(self):
        ...
        for file_path in self.static_files['css']:
            body += pkgutil.get_data('oap_dash', 'assets/'+file_path).decode("utf-8")
    ...
    def _generate_renderer(self):
        return """
            ...
            <script src="/opsramp-analytics-utils/dummy_dash_renderer.js"></script>
        """
    ...
    def _generate_css_dist_html(self):
        return '<link rel="stylesheet" href="/opsramp-analytics-utils/main.css">'

    def _generate_scripts_html(self):
        return '<script src="/opsramp-analytics-utils/main.js"></script>'
