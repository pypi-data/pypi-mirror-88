...
UNABLE_TO_SET_LISTENER = "Unable to set delivery listener receiver"
DELIVERY_LISTENER_SERVICE_DOWN_EXIT_MESSAGE = f"{MESSAGING_SERVICE_DOWN} exiting the delivery listener thread"
...
RECEIVER_UNAVAILABLE_FOR_TERMINATE = f"{CANNOT_TERMINATE_RECEIVER} {CURRENT_STATUS}"
...
GRACE_PERIOD_MIN_MS = 1000  # 1 second
GRACE_PERIOD_MAX_MS = 600000  # 10 minutes
...
FLOW_DOWN_UNBLOCK_RECEIVE_MESSAGE = "Flow Down, blocking receive_message may receive None"
