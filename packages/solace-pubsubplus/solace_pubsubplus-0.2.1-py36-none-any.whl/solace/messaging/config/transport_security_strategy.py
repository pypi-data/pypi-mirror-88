...
class TransportSecurityStrategy(ABC):
    ...
    def get_configuration(self) -> dict:  # pylint: disable=no-self-use
        """Retrieves the TLS configuration.

        Returns:
            dict: A dictionary object containing the TLS  configuration.
        """
    ...
    def security_configuration(self) -> dict:
        ...
        Returns:
            dict: A dictionary object containing the TLS  configuration.et method to gthe security configuration"""
