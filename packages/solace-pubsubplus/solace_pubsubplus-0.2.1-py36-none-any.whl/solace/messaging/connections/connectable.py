...
class Connectable(ABC):
    ...
    def disconnect(self):
        ...
        the ``Messaging Service`` can be connected again by calling
        :py:meth:`solace.messaging.connections.async_connectable.AsyncConnectable.connect_async()` or
        :py:meth:`Connectable.connect()`.
        """
