...
""" This module contains error classes for the PubSub+ Messaging API for Python Clients. """
...
class PubSubPlusClientError(Exception):
    ...
    def __init__(self, message):
        ...
        Raises:
            PubSubPlusClientError: Raises the error.
        """
...
class IllegalArgumentError(ValueError):
    """
    A class for throwiraisingng errors for illegal argument, which extends ``ValueError``.
    """
...
class MessageRejectedByBrokerError(PubSubPlusClientError):
    """ A class for raising errors when a message has bee rejected by event broker. """
