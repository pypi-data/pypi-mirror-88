...
cdef extern from "varlen.h":
    object PyInit_0a7abb6edc2e920e222aad66029fa68765324b168acd5dabbaf3603a4fc5eef7()
...
cdef object get_definition_by_name(str name):
    if name == "tempsdb.series":
        ...
        return PyInit_0a7abb6edc2e920e222aad66029fa68765324b168acd5dabbaf3603a4fc5eef7()
...
def bootstrap_cython_submodules():
    modules_set = {'tempsdb.chunks.normal', 'tempsdb.database', 'tempsdb.varlen', 'tempsdb.iterators', 'tempsdb.chunks.maker', 'tempsdb.exceptions', 'tempsdb.series', 'tempsdb.chunks.base', 'tempsdb.chunks.direct', 'tempsdb.chunks.gzip'}
