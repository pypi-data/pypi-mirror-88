...
class WaterfallMixin(BaseMixin):
    ...
    class ChartDataMeta:
        orientation = 'v'
        totals = {'marker': {'color': ColorsNormal.NAVY.value}}
        increasing = {'marker': {'color': ColorsNormal.GREEN.value}}
        decreasing = {'marker': {'color': ColorsNormal.RED.value}}
        showlegend = False
...
class TableMixin(BaseMixin):
    ...
    class LayoutMeta:
        titlefont = dict(color="rgb(22, 96, 167)", size=20)
