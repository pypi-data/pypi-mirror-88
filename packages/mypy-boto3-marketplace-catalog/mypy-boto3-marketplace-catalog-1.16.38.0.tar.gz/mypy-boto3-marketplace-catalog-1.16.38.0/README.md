...
[boto3.MarketplaceCatalog 1.16.38](https://boto3.amazonaws.com/v1/documentation/api/1.16.38/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
