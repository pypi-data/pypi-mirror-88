...
def get_version():
    version_file = osp.join("gorilla2d", "version.py")
...
if __name__ == "__main__":
    setup(name="gorilla2d",
          version=get_version(),
          author="Gorilla Authors",
          author_email="eehjzhang@mail.scut.edu.cn",
          description="2D ToolBox Package for Gorilla-Lab using PyTorch",
