...
class TestLimits(unittest.TestCase):
    ...
    def test_limit(self):
        limited_type = VPPType(
            "limited_type_t", [["string", "name", 0, {"limit": 16}]]
        )
...
class TestDefaults(unittest.TestCase):
    def test_defaults(self):
        ...
        without_default_type = VPPType(
            "without_default_type_t", [["u16", "mtu"]]
        )
...
class TestAddType(unittest.TestCase):
    ...
    def test_address(self):
        ...
        b = address.pack(
            {
                "af": af.ADDRESS_IP4,
                "un": {"ip4": inet_pton(AF_INET, "2.2.2.2")},
            }
        )
    ...
    def test_address_with_prefix(self):
        ...
        awp_type = VPPType(
            "foobar_t", [["vl_api_address_with_prefix_t", "address"]]
        )
    ...
    def test_recursive_address(self):
        ...
        message_addr = VPPMessage(
            "svs_address", [["vl_api_address_t", "address"]]
        )
    ...
    def test_lisp(self):
        ...
        b = eid.pack(
            {"type": 1, "address": {"mac": MACAddress("aa:bb:cc:dd:ee:ff")}}
        )
