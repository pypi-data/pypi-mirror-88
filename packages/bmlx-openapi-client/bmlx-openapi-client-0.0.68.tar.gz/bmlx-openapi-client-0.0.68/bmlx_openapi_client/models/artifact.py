...
class Artifact(object):
    ...
    def __init__(self, create_time=None, description=None, experiment_run_id=None, id=None, import_only=None, name=None, producer_component=None, status=None, type=None, uri=None, local_vars_configuration=None):  # noqa: E501
