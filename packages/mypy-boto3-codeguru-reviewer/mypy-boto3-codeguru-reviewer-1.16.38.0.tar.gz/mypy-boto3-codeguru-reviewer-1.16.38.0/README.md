...
[boto3.CodeGuruReviewer 1.16.38](https://boto3.amazonaws.com/v1/documentation/api/1.16.38/reference/services/codeguru-reviewer.html#CodeGuruReviewer) service
compatible with
