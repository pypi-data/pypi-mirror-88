...
from ._exceptions import get_error_category, ErrorCategory
...
IS_IN_CI_PIPELINE = bool(os.environ.get("IS_IN_CI_PIPELINE", 'False'))
...
class _LoggerFactory:
    ...
    def _get_version_info():
        ...
        if component_ver is None:
            try:
                from azure.ml.component.dsl._version import VERSION as component_ver
            except Exception:
                component_ver = ''
        ...
        def wrapper(*args, **kwargs):
            ...
            with _LoggerFactory.track_activity(logger, _activity_name, _activity_full_name,
                ...
                try:
                    ...
                    if IS_IN_CI_PIPELINE and category == ErrorCategory.InternalSDKError:
                        raise Exception('Got InternalSDKError', e)
                    else:
                        raise
