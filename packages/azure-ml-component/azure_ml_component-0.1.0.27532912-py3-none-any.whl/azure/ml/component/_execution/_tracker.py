...
class RunHistoryTracker:
    ...
    def with_definition(cls, experiment_name, component, working_dir, track_run_history, path=None):
        ...
        run = None
        print_to_terminal(
            'Start initialize run history tracker of component [ %s ] to record execution infomation.' %
            component.name)
        ...
        print_to_terminal(
            'Finished initialize run history tracker of component [ %s ] to record execution infomation.' %
            component.name)
        return tracker
    ...
    def without_definition(cls, workspace, experiment_name, track_run_history, path=None):
        ...
        run = None
        print_to_terminal(
            'Start initialize run history tracker of experiment [ %s ] to record execution infomation.' %
            experiment_name)
        if track_run_history:
        ...
        tracker = cls(run, track_run_history, path)
        print_to_terminal(
            'Finished initialize run history tracker of experiment [ %s ] to record execution infomation.' %
            experiment_name)
        return tracker
