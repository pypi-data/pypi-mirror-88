...
from json_tools.json_fingerprint import (
    _create_hash_list,
    _flatten_json,
    FingerprintHashFunctionError,
    FingerprintInputDataTypeError,
    FingerprintJSONLoadError,
...
class TestJsonFingerprint(unittest.TestCase):
    def setUp(self):
        ...
        with open(os.path.join(TESTDATA_DIR, 'jsfpv1_test_obj_1.json'), 'r') as file:
            self.test_obj_1 = file.read()
            file.close()

        with open(os.path.join(TESTDATA_DIR, 'jsfpv1_test_obj_2.json'), 'r') as file:
    ...
    def test_jfpv1_sha256_mixed_order(self):
        ...
        fp_1 = jt.json_fingerprint(self.test_obj_1, hash_function='sha256', version=1)
        fp_2 = jt.json_fingerprint(self.test_obj_2, hash_function='sha256', version=1)
    ...
    def test_jfpv1_sha256_output_format(self):
        ...
        fp = jt.json_fingerprint('{"foo": "bar"}', hash_function='sha256', version=1)
    ...
    def test_jfpv1_json_fingerprint_version_error(self):
        ...
        with self.assertRaises(FingerprintVersionError):
            jt.json_fingerprint(data=self.test_obj_1, hash_function='sha256', version=-1)
    ...
    def test_jfpv1_input_data_type_error(self):
        ...
        with self.assertRaises(FingerprintInputDataTypeError):
            jt.json_fingerprint(data={'foo': 'bar'}, hash_function='sha256', version=1)
    ...
    def test_jfpv1_hash_function_error(self):
        ...
        with self.assertRaises(FingerprintHashFunctionError):
            jt.json_fingerprint(data=self.test_obj_1, hash_function='not123', version=1)
    ...
    def test_jfpv1_json_load_error(self):
        ...
        with self.assertRaises(FingerprintJSONLoadError):
            jt.json_fingerprint('{"foo": bar}', hash_function='sha256', version=1)
    ...
    def test_jfpv1_flattened_json_list_format(self):
        ...
        obj_out = []
        _flatten_json(data=obj_in, out=obj_out)
    ...
    def test_jfpv1_flattened_json_depth_handling(self):
        ...
        obj_out_1 = []
        _flatten_json(data=obj_in_1, out=obj_out_1)
        ...
        obj_out_2 = []
        _flatten_json(data=obj_in_2, out=obj_out_2)
    ...
    def test_jfpv1_create_hash_list(self):
        ...
        output_data_hashes = _create_hash_list(data=input_data)
