...
██║ ╚═╝ ██║███████╗███████╗███████╗╚██████╔╝
╚═╝     ╚═╝╚══════╝╚══════╝╚══════╝ ╚═════╝ 
V0.0.5 {Fore.LIGHTMAGENTA_EX + "Coded"} {Fore.RED + "P"}{Fore.GREEN + "i"}{Fore.YELLOW + "r"}{Fore.BLUE + "x"}{Fore.MAGENTA + "c"}{Fore.RED + "y"} {Fore.LIGHTMAGENTA_EX + "for Mello!"} \nJoin The Discord and Contact @pirxcy or Helpers for Help!\nhttps://discord.gg/25fKfvrqwC Enjoy!
"""
os.system('cls||clear')
print(intro)
...
async def event_ready():
    while true:
        ...
        os.system('cls||clear')
        print(intro)
        print(Fore.BLUE + '[MelloBot] ' + Fore.RESET + 'Client ready as ' + Fore.CYAN + f'{client.user.display_name}\n')
        os.system('cls||clear')
        print(intro)
        print(Fore.BLUE + '[MelloBot] ' + Fore.RESET + 'Client ready as ' + Fore.CYAN + f'{client.user.display_name}\n' + Fore.RESET)
