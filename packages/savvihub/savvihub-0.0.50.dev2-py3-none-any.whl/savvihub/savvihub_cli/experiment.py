...
def run(
    ...
    images = client.kernel_image_list(context.project.workspace.name, selected_resource.processor_type)
    if not image_arg:
    ...
    if diff_file:
        ...
        volume = client.volume_create(context.project.workspace.name)
