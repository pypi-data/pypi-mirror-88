...
import traceback
import os
import bygfiles.default_settings as default_settings
import logging
...
class Settings():
    """ Projects settings. Rather similar implementations to django.conf.settings """
    ...
    def __init__(self, module_name=None):
        ...
        if module_name:
            ...
            self.__dict__['SETTINGS_MODULE'] = os.environ.get('BYGFILES_SETTINGS_MODULE', 'settings')
