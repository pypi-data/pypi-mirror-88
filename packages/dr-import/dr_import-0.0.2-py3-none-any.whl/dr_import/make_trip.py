...
if __name__=="__main__":
  ...
  section_list = api.get_section_list(args.project)
  section_pk = None
  for section in section_list:
    if section.name in args.trip_id:
      section_pk = section.id

  if section_pk is None:
    print(f"Could not find {args.trip_id}")

  media_list = api.get_media_list(args.project,section=section_pk)
