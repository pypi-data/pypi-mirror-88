...
"""
from basedata1.constants import (get_student_field, get_section_field, get_card_field, get_student_class_table_field,
                                 get_teacher_class_table_field, get_subject_field, get_teacher_field)
from basedata1.oracleutils import query_data
