...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.34.0-alpha.1608155750+152b5bff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.34.0-alpha.1608155750+152b5bff`
                """)
            else:
                raise
