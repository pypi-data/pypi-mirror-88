...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.34.0-alpha.1608141574+fbea8748'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.34.0-alpha.1608141574+fbea8748`
                """)
            else:
                raise
