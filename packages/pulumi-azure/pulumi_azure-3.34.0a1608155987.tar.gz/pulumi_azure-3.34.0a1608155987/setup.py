...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.34.0-alpha.1608155987+314e2fbe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.34.0-alpha.1608155987+314e2fbe`
                """)
            else:
                raise
