...
class WeiboCrawl():
    ...
    def go(self):
        ...
        # response=self.requests_get('https://weibo.com/u/5140353859?pids=Pl_Official_MyProfileFeed__20&is_ori=1&is_forward=1&is_text=1&is_pic=1&is_video=1&is_music=1&is_article=1&key_word=&start_time=2020-03-01&end_time=2020-09-30&is_search=1&is_searchadv=1&ajaxpagelet=1&ajaxpagelet_v6=1&__ref=%2Fu%2F5140353859%3Fis_search%3D0%26visible%3D0%26is_all%3D1%26is_tag%3D0%26profile_ftype%3D1%26page%3D4%23feedtop&_t=FM_160710015217291', headers=self.headers['home'])

        # response=self.requests_get(self.urls['weibo2'].format('5140353859'), data=self.param['weibo2'], headers=self.headers['home'])
        # print(response.text)

        # self.weibo_parse(response.text)
