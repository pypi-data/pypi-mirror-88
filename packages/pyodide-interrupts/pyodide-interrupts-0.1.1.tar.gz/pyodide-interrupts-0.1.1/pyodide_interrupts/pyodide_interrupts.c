...
static PyObject *pyodide_interrupts__start(PyObject *self,  PyObject *args);
static PyObject *pyodide_interrupts__end(PyObject *self,  PyObject *args);
static PyObject *pyodide_interrupts__get_interval(PyObject *self,  PyObject *args);
static PyObject *pyodide_interrupts__set_interval(PyObject *self,  PyObject *args);
static int
...
static PyMethodDef module_methods[] = {
    {"start", pyodide_interrupts__start, METH_VARARGS, start_docstring},
    {"end", pyodide_interrupts__end, METH_VARARGS, end_docstring},
    {"get_interval", pyodide_interrupts__get_interval, METH_VARARGS, get_interval_docstring},
    {"set_interval", pyodide_interrupts__set_interval, METH_VARARGS, set_interval_docstring},
    {NULL, NULL, 0, NULL}
};

static struct PyModuleDef module = {
    PyModuleDef_HEAD_INIT,
    "_pyodide_interrupts",   /* name of module */
...
PyMODINIT_FUNC PyInit__pyodide_interrupts(void)
{
