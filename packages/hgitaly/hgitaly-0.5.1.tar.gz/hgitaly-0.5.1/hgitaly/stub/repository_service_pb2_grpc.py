...
class RepositoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FetchHTTPRemote = channel.unary_unary(
                '/gitaly.RepositoryService/FetchHTTPRemote',
                request_serializer=repository__service__pb2.FetchHTTPRemoteRequest.SerializeToString,
                response_deserializer=repository__service__pb2.FetchHTTPRemoteResponse.FromString,
                )
...
class RepositoryServiceServicer(object):
    ...
    def FetchHTTPRemote(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RepositoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FetchHTTPRemote': grpc.unary_unary_rpc_method_handler(
                    servicer.FetchHTTPRemote,
                    request_deserializer=repository__service__pb2.FetchHTTPRemoteRequest.FromString,
                    response_serializer=repository__service__pb2.FetchHTTPRemoteResponse.SerializeToString,
            ),
...
class RepositoryService(object):
    ...
    def FetchHTTPRemote(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/FetchHTTPRemote',
            repository__service__pb2.FetchHTTPRemoteRequest.SerializeToString,
            repository__service__pb2.FetchHTTPRemoteResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
