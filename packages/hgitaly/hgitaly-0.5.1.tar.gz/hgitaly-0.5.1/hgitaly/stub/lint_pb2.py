...
op_type = _descriptor.FieldDescriptor(
  name='op_type', full_name='gitaly.op_type', index=0,
...
storage = _descriptor.FieldDescriptor(
  name='storage', full_name='gitaly.storage', index=1,
...
repository = _descriptor.FieldDescriptor(
  name='repository', full_name='gitaly.repository', index=2,
...
target_repository = _descriptor.FieldDescriptor(
  name='target_repository', full_name='gitaly.target_repository', index=3,
...
additional_repository = _descriptor.FieldDescriptor(
  name='additional_repository', full_name='gitaly.additional_repository', index=4,
