...
_FETCHHTTPREMOTEREQUEST = _descriptor.Descriptor(
  name='FetchHTTPRemoteRequest',
  full_name='gitaly.FetchHTTPRemoteRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='repository', full_name='gitaly.FetchHTTPRemoteRequest.repository', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\230\306,\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remote', full_name='gitaly.FetchHTTPRemoteRequest.remote', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='gitaly.FetchHTTPRemoteRequest.timeout', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FETCHHTTPREMOTERESPONSE = _descriptor.Descriptor(
  name='FetchHTTPRemoteResponse',
  full_name='gitaly.FetchHTTPRemoteResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_FETCHHTTPREMOTEREQUEST.fields_by_name['repository'].message_type = shared__pb2._REPOSITORY
_FETCHHTTPREMOTEREQUEST.fields_by_name['remote'].message_type = _REMOTE
...
DESCRIPTOR.message_types_by_name['FetchHTTPRemoteRequest'] = _FETCHHTTPREMOTEREQUEST
DESCRIPTOR.message_types_by_name['FetchHTTPRemoteResponse'] = _FETCHHTTPREMOTERESPONSE
...
FetchHTTPRemoteRequest = _reflection.GeneratedProtocolMessageType('FetchHTTPRemoteRequest', (_message.Message,), {
  'DESCRIPTOR' : _FETCHHTTPREMOTEREQUEST,
  '__module__' : 'repository_service_pb2'
  # @@protoc_insertion_point(class_scope:gitaly.FetchHTTPRemoteRequest)
  })
_sym_db.RegisterMessage(FetchHTTPRemoteRequest)

FetchHTTPRemoteResponse = _reflection.GeneratedProtocolMessageType('FetchHTTPRemoteResponse', (_message.Message,), {
  'DESCRIPTOR' : _FETCHHTTPREMOTERESPONSE,
  '__module__' : 'repository_service_pb2'
  # @@protoc_insertion_point(class_scope:gitaly.FetchHTTPRemoteResponse)
  })
_sym_db.RegisterMessage(FetchHTTPRemoteResponse)
...
_FETCHHTTPREMOTEREQUEST.fields_by_name['repository']._options = None
...
_REPOSITORYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='FetchHTTPRemote',
    full_name='gitaly.RepositoryService.FetchHTTPRemote',
    index=34,
    containing_service=None,
    input_type=_FETCHHTTPREMOTEREQUEST,
    output_type=_FETCHHTTPREMOTERESPONSE,
    serialized_options=b'\372\227(\002\010\001',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
