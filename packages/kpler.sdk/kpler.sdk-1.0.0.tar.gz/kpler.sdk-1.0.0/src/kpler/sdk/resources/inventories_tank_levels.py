...
class InventoriesTankLevels(KplerClient):
    ...
    """
    The ``inventories/tank-levels`` endpoint provides with the level of each and every tank in the indicated installation or zone, on a configurable period of maximum 31 days.
    """
