...
class BallastCapacityPortCalls(KplerClient):
    ...
    """
    The ``ballast-capacity/port-calls`` endpoint is providing with all the list of ballast vessels on the input period with their next load ETA and Destination.
    """
