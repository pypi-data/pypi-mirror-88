...
class Weather(object):
    ...
    Attributes:
        ...
        main (string): This field contains the type of weather.
        description (string): This field contains the description of weather
            type in detail
        icon (string): This field contains icon
