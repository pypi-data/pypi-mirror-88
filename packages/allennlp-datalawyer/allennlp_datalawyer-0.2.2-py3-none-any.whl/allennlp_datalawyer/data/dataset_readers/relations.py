...
class Entity:
    def __init__(self, eid: int, sentence_id: str, entity_type: str, tokens: List[SingleToken], phrase: str):
        self._eid = get_id(eid, sentence_id)  # ID within the corresponding dataset
