...
def docs():
    ...
    print(
        ...
        "[6] ssap.boxplot01(par,label,title)\n"
    )
...
# boxplot02 (same parameter, different gategory)
def boxplot02(dataset, title):
    import matplotlib.pyplot as plt
    import numpy as np
...
# boxplot03 (differrent parameter, same category)


# map (with province / city)