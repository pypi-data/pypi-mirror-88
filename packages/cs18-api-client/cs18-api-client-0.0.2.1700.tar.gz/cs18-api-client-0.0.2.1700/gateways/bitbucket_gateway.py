...
class BitbucketGateway:
    ...
    def get_consumer_app_temporary_code(self):
        ...
        #todo_moshe: add error log with information regarding uth consumer permission (expiration? revoked?)
...
# def main():
#     bitbucket = BitbucketGateway(
#         'quali_buckettest',
#         '!QAZ2wsx_buckettest',
#         'Buckettest@qualisystems.com',
#         'VWnDjWe7GscnqHh6LC')
#
#     try:
#         code = bitbucket.get_consumer_app_temporary_code()
#         print(code)
