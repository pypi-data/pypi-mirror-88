...
"items": "double"}, "doc": "", "default": []}, {"name": "referenceDepth", "type": ["null", "int"],
"doc": "", "default": null}, {"name": "alternateDepth", "type": {"type": "array", "items": ["null",
"int"]}, "doc": "", "default": []}, {"name": "info", "type": {"type": "map", "values": {"type":
...
"""
    ...
    __slots__ = [
        'alternateDepth', 'callSetId', 'callSetName', 'genotype',
        'genotypeLikelihood', 'info', 'phaseset', 'referenceDepth'
    ]

    def __init__(self, **kwargs):
        self.alternateDepth = kwargs.get(
            'alternateDepth', [])
        ...
        self.phaseset = kwargs.get(
            'phaseset', None)
        self.referenceDepth = kwargs.get(
            'referenceDepth', None)
...
[]}, {"name": "referenceDepth", "type": ["null", "int"], "doc": "", "default": null}, {"name":
"alternateDepth", "type": {"type": "array", "items": ["null", "int"]}, "doc": "", "default": []},
{"name": "info", "type": {"type": "map", "values": {"type": "array", "items": "string"}}, "doc": "",
"default": {}}]}}, "doc": "", "default": []}]}}, "doc": "", "default": []}, {"name":
...
"doc": "", "default": null}, {"name": "alternateDepth", "type": {"type": "array", "items": ["null",
"int"]}, "doc": "", "default": []}, {"name": "info", "type": {"type": "map", "values": {"type":
"array", "items": "string"}}, "doc": "", "default": {}}]}}, "doc": "", "default": []}]}
"""
    schema = avro_parse(_schemaSource)
    requiredFields = {
        "end",
