...
dag = DAG(
    dag_id="xdl_build_and_upload_airflow_trigger_controller_new",
...
task1 = HDFSDockerOperator(
    task_id="xdl_build_and_upload_airflow_trigger_controller_new",
    ...
    volumes=[
        ...
        "/recommend/xdl_build_and_upload_airflow1:/xdl",
    ],
    command="cd /workspace/platform/xdl_to_platform && python xdl_to_platform_multi.py --folder=xdl_build_and_upload_airflow1",
    network_mode="host",
    exec_user="hdfs",
    auto_remove=True,
    force_pull=True,
