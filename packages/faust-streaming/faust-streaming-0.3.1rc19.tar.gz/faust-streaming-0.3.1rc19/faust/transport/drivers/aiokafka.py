...
class Producer(base.Producer):
    ...
    _scaleup_producers: typing.Dict[int, aiokafka.AIOKafkaProducer] = {}
    ...
    async def on_start(self) -> None:
        ...
        self._scaleup_producers[0] = producer
        for i in range(1, 5):
            self._scaleup_producers[i] = self._new_producer()
            await self._scaleup_producers[i].start()
    ...
    async def send(
        ...
        *,
        ...
        if transactional_id:
            ...
            producer_key = 0
            if partition is not None:
                producer_key = partition
            transaction_producer = self._scaleup_producers.get(producer_key)
