"""
tests user_inputs_for_args
"""
import user_inputs_for_args
import pytest
...
def test_get_arg_doc_anns(doc_str, expected) -> None:
    ...
    """
    actual_ouput = user_inputs_for_args.get_arg_doc_anns(['1', '2', '3', '4', '5'], doc_str)
...
def test_get_args_anns(all_arg_names, kwarg_names, current_anns, expected) -> None:
    ...
    tests get_args_anns()
    """
    actual_ouput = user_inputs_for_args.get_args_anns(all_arg_names, kwarg_names, current_anns)
    assert actual_ouput == expected
...
def test_get_default_args(kwarg_values, expected) -> None:
    ...
    actual_output = user_inputs_for_args.get_default_args(all_arg_names, kwarg_values)
