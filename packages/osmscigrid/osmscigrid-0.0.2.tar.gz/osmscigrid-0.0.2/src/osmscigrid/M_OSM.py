...
def read(PBF_inputfile,JSON_outputfile,countrycode='EU', NewPreFilterData=False, 
         CreateElements=False, LoadElements=True,
         CreateCountryCodeForLines=False, LoadCountryCodeForLines=False,
         length=100,min_length=0, verbose=True,multiprocess=True):
...
#                          CreateElements=CreateElements, LoadElements=LoadElements)
    ...
    # length=length
    print(countrycode)
    OSM=M_OSM_convert.RawData2ClassData(Data,Elements,JSON_outputfile,
                                        countrycode=countrycode, 
                                        CreateCountryCodeForLines=CreateCountryCodeForLines,
                                        LoadCountryCodeForLines=LoadCountryCodeForLines,
                                        min_length=min_length,segment_length=length)
