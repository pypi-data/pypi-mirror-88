...
class Clusterer:
    ...
    def generate_df_cluster_meta(self):
        ...
        self.df_cluster_meta['valid'] = 1
        self.df_cluster_meta['valid'] = np.where(self.df_cluster_meta['n'] < self.min_n, 0, self.df_cluster_meta['valid'])
