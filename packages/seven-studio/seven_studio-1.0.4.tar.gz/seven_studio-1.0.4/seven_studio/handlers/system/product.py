...
class GetProductListHandler(SevenBaseHandler):
    """
    @description: 产品列表
    """
    @login_filter(True)
...
class GetAllProductListHandler(SevenBaseHandler):
    """
    @description: 全部产品列表
    """
    @login_filter(True)
...
class SaveProductHandler(SevenBaseHandler):
    """
    @description: 保存产品
    """
    @login_filter(True)
...
class DeleteProductHandler(SevenBaseHandler):
    """
    @description: 删除产品
    """
    @login_filter(True)
