...
@LastEditTime: 2020-12-10 10:52:15
@LastEditors: ChenXiaolei
@Description: 文件操作相关接口
"""
from handlers.seven_base import *

from models.db_models.file.file_storage_path_model import *
from models.db_models.file.file_resource_model import *
from models.db_models.file.file_restrict_model import *
from models.db_models.file.file_water_image_model import *
from models.db_models.file.file_history_model import *
from models.seven_model import InvokeResult
from libs.customize.file.ks3 import *


class GetStoragePathListHandler(SevenBaseHandler):
    """
...
class GetStoragePathDataHandler(SevenBaseHandler):
    """
    @description: 获取存储配置
    @param {type} 
    @return: 
...
class SaveStoragePathHandler(SevenBaseHandler):
    """
    @description: 保存存储配置
    """
    @login_filter(True)
...
class DeleteStoragePathHandler(SevenBaseHandler):
    """
    @description: 删除存储配置
    """
    @login_filter(True)
...
class GetResourceListHandler(SevenBaseHandler):
    """
...
class GetResourceInfoHandler(SevenBaseHandler):
    """
    @description: 获取文件配置
    """
    @login_filter(True)
...
class SaveResourceHandler(SevenBaseHandler):
    """
    @description: 保存文件配置
    """
    @login_filter(True)
...
class DeleteResourceHandler(SevenBaseHandler):
    """
    @description: 删除资源
    """
    @login_filter(True)
...
class GetRestrictListHandler(SevenBaseHandler):
    """
    @description: 获取上传限制
    """
    @login_filter(True)
...
class SaveRestrictHandler(SevenBaseHandler):
    """
...
class DeleteRestrictHandler(SevenBaseHandler):
    """
...
class GetWaterImageListHandler(SevenBaseHandler):
    """
...
class GetWaterImageDataHandler(SevenBaseHandler):
    """
    @description: 获取水印图片
    """
    @login_filter(True)
...
class SaveWaterImageHandler(SevenBaseHandler):
    """
    @description: 保存图片水印
    """
    @login_filter(True)
...
class DeleteWaterImageHandler(SevenBaseHandler):
    """
    @description: 删除水印图
    """
    @login_filter(True)
...
class GetHistoryListHandler(SevenBaseHandler):
    """
    @description: 获取文件历史
    """
    @login_filter(True)
...
class DeleteHistoryHandler(SevenBaseHandler):
    """
