...
from models.db_models.menu.menu_cote_model import *
from models.db_models.menu.menu_info_model_ex import *
from models.power_model import *


class PowerPlatformMenuHandler(SevenBaseHandler):
    """
...
class PowerMenuTreeHandler(SevenBaseHandler):
    """
    @description: 菜单权限路由
    """
    @login_filter(True)
...
class MenuTreeHandler(SevenBaseHandler):
    """
    @description: 系统菜单路由
    """
    @login_filter(True)
...
class MenuPowerInfoHandler(SevenBaseHandler):
    """
    @description: 栏目权限路由
    """
    def get_async(self):
...
class MenuCoteListHandler(SevenBaseHandler):
    """
    @description: 栏目数据路由
    """
    def post_async(self):
...
class MenuCoteSelectHandler(SevenBaseHandler):
    """
...
class SaveMenuHandler(SevenBaseHandler):
    """
    @description: 保存菜单
    """
    def post_async(self):
...
class AddFastMenuHandler(SevenBaseHandler):
    """
    @description: 快速添加菜单
    """
    def get_async(self):
...
class DeleteMenuHandler(SevenBaseHandler):
    """
    @description: 删除菜单
    """
    def get_async(self):
...
class SaveCopyMenuHandler(SevenBaseHandler):
    """
    @description: 复制粘贴菜单
    """
    def get_async(self):
...
class MoveMenuHandler(SevenBaseHandler):
    """
    @description: 移动菜单
    """
    def get_async(self):
...
class SaveMenuCoteHandler(SevenBaseHandler):
    """
    @description: 修改栏目数据
    """
    def post_async(self):
...
class DeleteMenuCoteHandler(SevenBaseHandler):
    """
    @description: 删除栏目数据
    """
    def get_async(self):
...
class SyncSqlHandler(SevenBaseHandler):
    """
...
class InsertSqlHandler(SevenBaseHandler):
    """
...
class UpdateSqlHandler(SevenBaseHandler):
    """
