...
class ConfigService:
    ...
    def get_expected_categories(self) -> bool:
        # returns a expected categories boolean if the course should contains categories
        try:
            return self.get_property('expected_categories')
        except ValueError:
            return True
