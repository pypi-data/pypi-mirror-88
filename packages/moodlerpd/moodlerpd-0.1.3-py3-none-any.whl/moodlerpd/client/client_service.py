...
class ClientService:
    ...
    def fetch_state(self) -> [Course]:
        ...
        expected_categories = self.config_service.get_expected_categories()
        ...
        try:
            ...
            for course in courses:
                ...
                if expected_categories:
                    course.categories = self.build_course_categories(course.category_id, categories_list)
    ...
    def build_course_categories(self, course_category: int, categories: [Category]) -> [Category]:
        """
        ...
        if category:
            course_categories = self.build_course_categories(category.parent_id, categories)
    ...
    def filter_courses(changes: [Course], config_service: ConfigService) -> [Course]:
        ...
        for course in changes:
            ...
            if (ResultsHandler.should_download_course(
                    course.id, download_course_ids, dont_download_course_ids) and len(course.files) > 0):
