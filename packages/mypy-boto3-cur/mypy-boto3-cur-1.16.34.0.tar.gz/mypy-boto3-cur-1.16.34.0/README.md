...
[boto3.CostandUsageReportService 1.16.34](https://boto3.amazonaws.com/v1/documentation/api/1.16.34/reference/services/cur.html#CostandUsageReportService) service
compatible with
