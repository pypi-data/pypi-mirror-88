...
[boto3.ResourceGroupsTaggingAPI 1.16.32](https://boto3.amazonaws.com/v1/documentation/api/1.16.32/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
compatible with
