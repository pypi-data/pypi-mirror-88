...
var RuleNode = /** @class */ (function (_super) {
    ...
    function RuleNode() {
        ...
        _this.getChoiceField = function (name, fieldConfig) {
            ...
            var _a = _this.props, data = _a.data, index = _a.index, onPropertyChange = _a.onPropertyChange, disabled = _a.disabled;
            var initialVal;
            if (data) {
            ...
            }} disabled={disabled} choices={choices} onChange={function (_a) {
                var value = _a.value;
        ...
        _this.updateParent = function (data, dynamicFieldChoices) {
            var e_1, _a;
            var _b;
            try {
                ...
                for (var _c = __values(Object.entries(data)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    _this.props.onPropertyChange(_this.props.index, name_1, value);
                    // We only know the choices after the form loads.
                    if (['assignee', 'reporter'].includes(name_1) && dynamicFieldChoices[name_1]) {
                        var dynamicFormFieldsCopy = ((_b = _this.props.node) === null || _b === void 0 ? void 0 : _b.formFields) || {};
                        // Overwrite the choices because the user's pick is in this list.
                        dynamicFormFieldsCopy[name_1].choices = dynamicFieldChoices[name_1];
                        _this.props.onPropertyChange(_this.props.index, 'dynamic_form_fields', dynamicFormFieldsCopy);
                    }
                }
            }
    ...
    RuleNode.prototype.render = function () {
        var _this = this;
        var _a = this.props, data = _a.data, disabled = _a.disabled, index = _a.index, node = _a.node, onPropertyChange = _a.onPropertyChange;
        ...
        <RuleRow>
          <Rule>
            ...
            return openModal(function (deps) { return (<TicketRuleModal {...deps} formFields={node.formFields || {}} link={node.link} ticketType={node.ticketType} instance={data} index={index} onSubmitAction={_this.updateParent} onPropertyChange={onPropertyChange}/>); });
        }}>
