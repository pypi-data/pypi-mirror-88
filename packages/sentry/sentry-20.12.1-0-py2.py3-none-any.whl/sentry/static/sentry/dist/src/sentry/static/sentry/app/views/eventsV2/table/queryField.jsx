...
var QueryField = /** @class */ (function (_super) {
    ...
    function QueryField() {
        ...
        _this.handleFieldChange = function (_a) {
            var value = _a.value;
            ...
            if (value.kind === FieldValueKind.FUNCTION) {
                value.meta.parameters.forEach(function (param, i) {
                    ...
                    if (param.kind === 'column') {
                        ...
                        else if ((field.kind === FieldValueKind.FIELD || field.kind === FieldValueKind.TAG) &&
...
var BlankSpace = styled('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  /* Match the height of the select boxes */\n  height: 41px;\n  min-width: 50px;\n  background: ", ";\n  border-radius: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  &:after {\n    content: '", "';\n    color: ", ";\n  }\n"], ["\n  /* Match the height of the select boxes */\n  height: 41px;\n  min-width: 50px;\n  background: ", ";\n  border-radius: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  &:after {\n    content: '", "';\n    color: ", ";\n  }\n"])), function (p) { return p.theme.backgroundSecondary; }, function (p) { return p.theme.borderRadius; }, t('No parameter'), function (p) { return p.theme.gray300; });
export { QueryField };
