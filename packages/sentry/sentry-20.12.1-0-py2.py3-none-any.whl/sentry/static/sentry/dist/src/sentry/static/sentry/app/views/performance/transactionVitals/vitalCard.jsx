    ...
    VitalCard.prototype.renderHistogram = function () {
        ...
        {function (zoomRenderProps) { return (<Container>
            ...
            <Feature features={['organizations:performance-vitals-overview']}>
              <PercentContainer>
                <VitalInfo eventView={eventView} organization={organization} location={location} vitalName={vital} hideBar hideVitalPercentNames hideDurationDetail/>
              </PercentContainer>
            </Feature>
