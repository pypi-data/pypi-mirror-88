...
var HeaderItem = /** @class */ (function (_super) {
    ...
    HeaderItem.prototype.render = function () {
        ...
        {!locked && !loading && (<StyledChevron>
            <IconChevron direction={isOpen ? 'up' : 'down'} color={isOpen ? 'gray500' : 'gray300'} size="sm"/>
          </StyledChevron>)}
...
var StyledChevron = styled('div')(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  width: ", ";\n  height: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"], ["\n  width: ", ";\n  height: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])), space(2), space(2));
var SettingsIconLink = styled(Link)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  color: ", ";\n  align-items: center;\n  display: inline-flex;\n  justify-content: space-between;\n  margin-right: ", ";\n  margin-left: ", ";\n  transition: 0.5s opacity ease-out;\n\n  &:hover {\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n  align-items: center;\n  display: inline-flex;\n  justify-content: space-between;\n  margin-right: ", ";\n  margin-left: ", ";\n  transition: 0.5s opacity ease-out;\n\n  &:hover {\n    color: ", ";\n  }\n"])), function (p) { return p.theme.gray300; }, space(1.5), space(1.0), function (p) { return p.theme.textColor; });
var StyledLock = styled(IconLock)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  margin-top: ", ";\n  stroke-width: 1.5;\n"], ["\n  margin-top: ", ";\n  stroke-width: 1.5;\n"])), space(0.75));
