...
var theme = __assign(__assign(__assign({}, commonTheme), aliases), { button: generateButtonTheme(aliases) });
export var darkTheme = __assign(__assign(__assign({}, commonTheme), darkAliases), { button: generateButtonTheme(darkAliases) });
