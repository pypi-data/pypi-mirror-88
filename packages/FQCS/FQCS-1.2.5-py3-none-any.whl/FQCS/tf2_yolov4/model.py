...
from .csp_darknet53 import csp_darknet53
from .yolov3_head import yolov3_head
from .yolov4_neck import yolov4_neck
from .weights import get_weights_by_keyword_or_path
...
def YOLOv4(
    ...
    if weights_path is not None:
        yolov4.load_weights(str(weights_path),
                            by_name=True,
                            skip_mismatch=True)
