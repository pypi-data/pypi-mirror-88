...
class Diagnoses:
    ...
    def dm_initial_review_model_cls(self):
        return django_apps.get_model("mocca_subject.dminitialreview")

    @property
    def hiv_initial_review_model_cls(self):
        return django_apps.get_model("mocca_subject.hivinitialreview")

    @property
    def htn_initial_review_model_cls(self):
        return django_apps.get_model("mocca_subject.htninitialreview")

    @property
    def clinical_review_model_cls(self):
        return django_apps.get_model("mocca_subject.clinicalreview")

    @property
    def clinical_review_baseline_model_cls(self):
        return django_apps.get_model("mocca_subject.clinicalreviewbaseline")

    @property
    def subject_visit_model_cls(self):
        return django_apps.get_model("mocca_subject.subjectvisit")
