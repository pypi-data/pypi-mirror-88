...
navbar.append_item(
    [item for item in mocca_dashboard_navbar.items if item.name == "screened_subject"][
        0
    ]
)

navbar.append_item(
    [item for item in mocca_dashboard_navbar.items if item.name == "consented_subject"][
        0
    ]
)
