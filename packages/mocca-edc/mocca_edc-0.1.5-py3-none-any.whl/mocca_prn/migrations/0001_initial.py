    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="+",
                        to="mocca_prn.UnblindingReviewerUser",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="+",
                        to="mocca_prn.UnblindingRequestorUser",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+",
                        to="mocca_lists.OffstudyReasons",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="mocca_prn_u_subject_f3a3d9_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="mocca_prn_u_subject_7eeaba_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="mocca_prn_p_subject_2ca745_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="mocca_prn_o_id_90760f_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="mocca_prn_l_subject_ee1838_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="mocca_prn_e_id_1808ef_idx",
            ),
        ),
    ]
