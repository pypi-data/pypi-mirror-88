...
class Predicates(PredicateCollection):
    ...
    visit_model = "mocca_subject.subjectvisit"
    ...
    def health_economics_required(visit, **kwargs):
        ...
        if (
            ...
            model_cls = django_apps.get_model("mocca_subject.healtheconomicsrevised")
            try:
    ...
    def family_history_required(visit, **kwargs):
        ...
        if not is_baseline(visit):
            model_cls = django_apps.get_model("mocca_subject.familyhistory")
