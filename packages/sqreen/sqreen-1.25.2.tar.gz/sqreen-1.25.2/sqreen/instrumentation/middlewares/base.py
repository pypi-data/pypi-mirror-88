...
class BaseMiddleware(object):
    ...
    def execute_pre_callbacks(self, transaction, args=None, record_attack=True):
        """ Execute pre callbacks. Only process valid action, in this context it's raising.
        """
        action = execute_pre_callbacks(
            self.strategy.strategy_id, transaction["pre"], self, args=args,
    ...
    def execute_post_callbacks(self, transaction, response, args=None, record_attack=True):
    ...
    def execute_failing_callbacks(self, transaction, exception, args=None):
