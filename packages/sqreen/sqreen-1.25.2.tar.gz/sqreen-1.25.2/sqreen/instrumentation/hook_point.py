...
def execute_pre_callbacks(
    key, callbacks, instance, args=None, kwargs=None, storage=runtime,
...
def execute_failing_callbacks(
    key, callbacks, instance, exc_info, args=None, kwargs=None, storage=runtime,
...
def execute_post_callbacks(
    key, callbacks, instance, result, args=None, kwargs=None, storage=runtime,
...
def hook_point_wrapper(strategy, hook_name, hook_method, storage=runtime):
    ...
    def wrapper(wrapped, instance, args, kwargs):
        ...
        while retry is True:
            try:
                ...
                action = execute_failing_callbacks(
                    key, callbacks["failing"], instance, exc_info, args, kwargs,
                    storage=storage
                )
        ...
        action = execute_post_callbacks(
            key, callbacks["post"], instance, result, args, kwargs, storage=storage,
        )
