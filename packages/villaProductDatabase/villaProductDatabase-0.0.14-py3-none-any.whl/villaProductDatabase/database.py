...
__all__ = ['DATABASE_TABLE_NAME', 'INVENTORY_BUCKET_NAME', 'INPUT_BUCKET_NAME', 'REGION', 'ACCESS_KEY_ID',
           ...
           'setUpdate', 'fromDict', 'updateWithDict', 'loadFromS3', 'dumpToS3', 'ERRORITEMS', 'lambdaDumpToS3',
           'Product', 'ValueUpdate', 'valueUpdate', 'lambdaUpdateProduct', 'updateS3Input', 'lambdaUpdateS3',
