...
setup(
    name = 'lorenz_zonoid',
    version = '0.0.5',
    description = 'Computes the Shapley Lorenz Zonoid share of covariates',
    ...
    license = 'MIT',
    py_modules = ['lorenz_zonoid'], # list of actual python code modules,
    ...
    install_requires = ['numpy <= 1.15.4', 'scipy <= 1.1.0', 'tqdm <= 4.28.1', 'matplotlib <= 3.0.2'],
