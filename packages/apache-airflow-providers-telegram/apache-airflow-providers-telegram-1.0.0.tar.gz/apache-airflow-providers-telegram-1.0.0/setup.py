...
try:
    with open(os.path.join(my_dir, 'airflow/providers/telegram/README.md'), encoding='utf-8') as f:
...
def do_setup(version_suffix_for_pypi=''):
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.0.0a0', 'python-telegram-bot==13.0'],
