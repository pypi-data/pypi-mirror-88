...
class InstrumentPhysics:
    ...
    def actualize_netlist(self):
        """
        Actualize the graph after a modification of a geometric parameter.
        ...
        self.netlist = Netlist()
        self.__build_netlist()
        self.netlist.set_fingering_chart(self.instrument_geometry.fingering_chart)
