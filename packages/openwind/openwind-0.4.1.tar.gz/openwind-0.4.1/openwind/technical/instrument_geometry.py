...
# %% Parsing geometry data
    ...
    def _parse_detailed_geometry(self, raw_part, Xlast, Rlast, label):
        ...
        elif self.__estim_value(raw_part[0]) == Xlast.get_value():  # the parts of the main bore must be connected
            X = [Xlast]
        else:
        ...
        if (Rlast is None
            or self.__estim_value(raw_part[2]) != Rlast.get_value()):  # begining or discontinuity
