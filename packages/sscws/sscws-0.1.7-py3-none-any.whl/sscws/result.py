...
class Result(metaclass=ABCMeta):
        ...
        for data_element in data_result_element.findall(\
            ...
            for b_trace_data in data_element.findall(\
                ...
                for name in ['Latitude', 'Longitude', 'ArcLength']:
                    result['Data'][data_i]['BTraceData'][-1][name] = \
            ...
            result['Data'][data_i]['SpacecraftRegion'] = \
                Result._get_data(data_element, 'SpacecraftRegion', SpaceRegion)
            ...
            for name in ['RadialTracedFootpointRegions',
                ...
                result['Data'][data_i][name] = \
                    Result._get_data(data_element, name, FootpointRegion)
    ...
    def _get_data(
        ...
        np.ndarray
            ...
            data_element.
        """
        data_elements = data_element.findall(\
               '{http://sscweb.gsfc.nasa.gov/schema}' + name)
