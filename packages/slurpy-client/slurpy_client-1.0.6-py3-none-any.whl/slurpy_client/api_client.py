...
from slurpy_client.exceptions import ApiTypeError, ApiValueError, ApiException
from slurpy_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EmailApi()
        api_instance.get_email  # this is an instance of the class Endpoint
        api_instance.get_email()  # this invokes api_instance.get_email.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_email.callable or self.callable in this class
