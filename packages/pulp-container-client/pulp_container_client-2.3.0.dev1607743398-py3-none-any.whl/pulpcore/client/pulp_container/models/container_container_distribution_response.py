...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, content_guard=None, base_path=None, repository_version=None, name=None, pulp_created=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
