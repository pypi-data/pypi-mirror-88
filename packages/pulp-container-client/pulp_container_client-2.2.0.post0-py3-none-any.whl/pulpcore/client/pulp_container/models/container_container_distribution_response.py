...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, repository_version=None, pulp_href=None, pulp_created=None, name=None, content_guard=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
