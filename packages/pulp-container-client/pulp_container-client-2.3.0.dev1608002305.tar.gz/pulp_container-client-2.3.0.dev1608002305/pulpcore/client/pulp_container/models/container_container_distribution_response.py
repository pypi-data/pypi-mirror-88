...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_href=None, content_guard=None, pulp_created=None, repository=None, base_path=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
