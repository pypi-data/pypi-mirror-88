...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, pulp_href=None, pulp_created=None, repository_version=None, content_guard=None, base_path=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
