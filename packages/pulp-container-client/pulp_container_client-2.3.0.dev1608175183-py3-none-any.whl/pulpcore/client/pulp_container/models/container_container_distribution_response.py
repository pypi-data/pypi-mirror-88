...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_href=None, name=None, base_path=None, content_guard=None, pulp_created=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
